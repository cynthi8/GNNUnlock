...
module c5315_AntiSAT_8_0_top ( N1, N4, N11, N14, N17, N20, N23, N24, N25, N26, 
  ...
  wire   N6925, N4275, N1137, N2527, N2309, N6924, N6641, N816, N6643, N709,
         ...
         \main/n4 , \main/n3 , \main/n2 , \main/n1 , \flip/n10 , \flip/n9 ,
  ...
  XOR2X1 \flip/U13  ( .IN1(keyinput5), .IN2(N619), .Q(\flip/n1 ) );
  XOR2X1 \flip/U12  ( .IN1(keyinput4), .IN2(N613), .Q(\flip/n5 ) );
  XNOR2X1 \flip/U11  ( .IN1(N613), .IN2(keyinput0), .Q(\flip/n7 ) );
  XOR2X1 \flip/U10  ( .IN1(keyinput1), .IN2(N619), .Q(\flip/n8 ) );
  XOR2X1 \flip/U9  ( .IN1(keyinput3), .IN2(N596), .Q(\flip/n9 ) );
  XOR2X1 \flip/U8  ( .IN1(keyinput2), .IN2(N400), .Q(\flip/n10 ) );
  NAND4X0 \flip/U7  ( .IN1(\flip/n7 ), .IN2(\flip/n8 ), .IN3(\flip/n9 ), .IN4(
        \flip/n10 ), .QN(\flip/n6 ) );
  NAND2X0 \flip/U6  ( .IN1(\flip/n5 ), .IN2(\flip/n6 ), .QN(\flip/n2 ) );
  XOR2X1 \flip/U5  ( .IN1(keyinput6), .IN2(N400), .Q(\flip/n3 ) );
  XOR2X1 \flip/U4  ( .IN1(keyinput7), .IN2(N596), .Q(\flip/n4 ) );
