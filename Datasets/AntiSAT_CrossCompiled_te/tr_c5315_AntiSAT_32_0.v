...
module c5315_AntiSAT_32_0_top ( N1, N4, N11, N14, N17, N20, N23, N24, N25, N26, 
  ...
  wire   N6925, N4275, N1137, N2527, N2309, N6924, N6641, N816, N6643, N709,
         N2387, N1066, N2139, N1141, flip_signal, \main/n424 , \main/n423 ,
  ...
  XNOR2X1 \main/U476  ( .IN1(flip_signal), .IN2(\main/n344 ), .Q(N7736) );
  ...
  OA221X1 \flip/U41  ( .IN1(N217), .IN2(keyinput26), .IN3(N435), .IN4(
        keyinput18), .IN5(\flip/n32 ), .Q(\flip/n33 ) );
  AOI22X1 \flip/U40  ( .IN1(N217), .IN2(keyinput26), .IN3(N435), .IN4(
        keyinput18), .QN(\flip/n32 ) );
  OA221X1 \flip/U39  ( .IN1(N446), .IN2(keyinput17), .IN3(N234), .IN4(
        keyinput24), .IN5(\flip/n31 ), .Q(\flip/n34 ) );
  AOI22X1 \flip/U38  ( .IN1(N446), .IN2(keyinput17), .IN3(N234), .IN4(
        keyinput24), .QN(\flip/n31 ) );
  OA221X1 \flip/U37  ( .IN1(N115), .IN2(keyinput16), .IN3(N351), .IN4(
        keyinput27), .IN5(\flip/n30 ), .Q(\flip/n35 ) );
  AOI22X1 \flip/U36  ( .IN1(N115), .IN2(keyinput16), .IN3(N351), .IN4(
        keyinput27), .QN(\flip/n30 ) );
  OA221X1 \flip/U35  ( .IN1(N366), .IN2(keyinput31), .IN3(N468), .IN4(
        keyinput28), .IN5(\flip/n29 ), .Q(\flip/n36 ) );
  AOI22X1 \flip/U34  ( .IN1(N366), .IN2(keyinput31), .IN3(N468), .IN4(
        keyinput28), .QN(\flip/n29 ) );
  NAND4X0 \flip/U33  ( .IN1(\flip/n28 ), .IN2(\flip/n27 ), .IN3(\flip/n26 ), 
        .IN4(\flip/n25 ), .QN(\flip/n38 ) );
  XNOR2X1 \flip/U32  ( .IN1(N335), .IN2(keyinput30), .Q(\flip/n25 ) );
  XNOR2X1 \flip/U31  ( .IN1(N242), .IN2(keyinput29), .Q(\flip/n26 ) );
  XNOR2X1 \flip/U30  ( .IN1(N218), .IN2(keyinput25), .Q(\flip/n27 ) );
  XNOR2X1 \flip/U29  ( .IN1(N374), .IN2(keyinput23), .Q(\flip/n28 ) );
  NAND4X0 \flip/U28  ( .IN1(\flip/n24 ), .IN2(\flip/n23 ), .IN3(\flip/n22 ), 
        .IN4(\flip/n21 ), .QN(\flip/n39 ) );
  XNOR2X1 \flip/U27  ( .IN1(N302), .IN2(keyinput22), .Q(\flip/n21 ) );
  XNOR2X1 \flip/U26  ( .IN1(N607), .IN2(keyinput21), .Q(\flip/n22 ) );
  XNOR2X1 \flip/U25  ( .IN1(N272), .IN2(keyinput20), .Q(\flip/n23 ) );
  XNOR2X1 \flip/U24  ( .IN1(N307), .IN2(keyinput19), .Q(\flip/n24 ) );
  ...
  OA221X1 \flip/U21  ( .IN1(N607), .IN2(keyinput5), .IN3(N302), .IN4(keyinput6), .IN5(\flip/n12 ), .Q(\flip/n13 ) );
  AOI22X1 \flip/U20  ( .IN1(N607), .IN2(keyinput5), .IN3(N302), .IN4(keyinput6), .QN(\flip/n12 ) );
  OA221X1 \flip/U19  ( .IN1(\flip/n11 ), .IN2(keyinput14), .IN3(\flip/n10 ), 
        .IN4(keyinput15), .IN5(\flip/n9 ), .Q(\flip/n14 ) );
  AOI22X1 \flip/U18  ( .IN1(\flip/n11 ), .IN2(keyinput14), .IN3(\flip/n10 ), 
        .IN4(keyinput15), .QN(\flip/n9 ) );
  INVX0 \flip/U17  ( .INP(N366), .ZN(\flip/n10 ) );
  INVX0 \flip/U16  ( .INP(N335), .ZN(\flip/n11 ) );
  OA221X1 \flip/U15  ( .IN1(N217), .IN2(keyinput10), .IN3(N374), .IN4(
        keyinput7), .IN5(\flip/n8 ), .Q(\flip/n15 ) );
  AOI22X1 \flip/U14  ( .IN1(N217), .IN2(keyinput10), .IN3(N374), .IN4(
        keyinput7), .QN(\flip/n8 ) );
  OA221X1 \flip/U13  ( .IN1(N218), .IN2(keyinput9), .IN3(N272), .IN4(keyinput4), .IN5(\flip/n7 ), .Q(\flip/n16 ) );
  AOI22X1 \flip/U12  ( .IN1(N218), .IN2(keyinput9), .IN3(N272), .IN4(keyinput4), .QN(\flip/n7 ) );
  NAND4X0 \flip/U11  ( .IN1(\flip/n6 ), .IN2(\flip/n5 ), .IN3(\flip/n4 ), 
        .IN4(\flip/n3 ), .QN(\flip/n18 ) );
  XNOR2X1 \flip/U10  ( .IN1(N307), .IN2(keyinput3), .Q(\flip/n3 ) );
  XNOR2X1 \flip/U9  ( .IN1(N435), .IN2(keyinput2), .Q(\flip/n4 ) );
  XNOR2X1 \flip/U8  ( .IN1(N234), .IN2(keyinput8), .Q(\flip/n5 ) );
  XNOR2X1 \flip/U7  ( .IN1(N468), .IN2(keyinput12), .Q(\flip/n6 ) );
  AO221X1 \flip/U6  ( .IN1(N242), .IN2(keyinput13), .IN3(keyinput0), .IN4(N115), .IN5(\flip/n2 ), .Q(\flip/n19 ) );
  OAI22X1 \flip/U5  ( .IN1(N242), .IN2(keyinput13), .IN3(N115), .IN4(keyinput0), .QN(\flip/n2 ) );
  AO221X1 \flip/U4  ( .IN1(N446), .IN2(keyinput1), .IN3(keyinput11), .IN4(N351), .IN5(\flip/n1 ), .Q(\flip/n20 ) );
  OAI22X1 \flip/U3  ( .IN1(N446), .IN2(keyinput1), .IN3(N351), .IN4(keyinput11), .QN(\flip/n1 ) );
endmodule
