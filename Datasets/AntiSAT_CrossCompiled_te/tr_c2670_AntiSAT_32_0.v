...
module c2670_AntiSAT_32_0_top ( N145, N153, N162, N168, N172, N210, N190, N212, 
  ...
  wire   N3803, N214_BUFF, N217_BUFF, N160_BUFF, N173_BUFF, N213_BUFF,
         ...
         N168_BUFF, N216_BUFF, N175_BUFF, N181_BUFF, flip_signal, \main/n219 ,
  ...
  XNOR2X1 \main/U147  ( .IN1(flip_signal), .IN2(\main/n93 ), .Q(N3851) );
  AO22X1 \main/U146  ( .IN1(\main/n92 ), .IN2(\main/n91 ), .IN3(\main/n90 ), 
        .IN4(\main/n89 ), .Q(\main/n93 ) );
  NAND3X0 \main/U145  ( .IN1(\main/n196 ), .IN2(\main/n92 ), .IN3(\main/n195 ), 
        .QN(\main/n89 ) );
  OA22X1 \main/U144  ( .IN1(\main/n88 ), .IN2(\main/n87 ), .IN3(\main/n86 ), 
        .IN4(\main/n85 ), .Q(\main/n90 ) );
  OA21X1 \main/U143  ( .IN1(\main/n88 ), .IN2(\main/n204 ), .IN3(\main/n205 ), 
        .Q(\main/n86 ) );
  OR2X1 \main/U142  ( .IN1(\main/n100 ), .IN2(N287), .Q(\main/n205 ) );
  OR2X1 \main/U141  ( .IN1(\main/n99 ), .IN2(N284), .Q(\main/n204 ) );
  OAI22X1 \main/U140  ( .IN1(\main/n84 ), .IN2(\main/n83 ), .IN3(\main/n85 ), 
        .IN4(\main/n206 ), .QN(\main/n87 ) );
  NAND4X0 \main/U139  ( .IN1(\main/n82 ), .IN2(\main/n81 ), .IN3(\main/n80 ), 
        .IN4(\main/n79 ), .QN(\main/n99 ) );
  OA22X1 \main/U138  ( .IN1(\main/n78 ), .IN2(\main/n77 ), .IN3(\main/n175 ), 
        .IN4(\main/n76 ), .Q(\main/n83 ) );
  INVX0 \main/U137  ( .INP(N281), .ZN(\main/n175 ) );
  OA222X1 \main/U136  ( .IN1(\main/n75 ), .IN2(\main/n74 ), .IN3(\main/n75 ), 
        .IN4(\main/n167 ), .IN5(\main/n73 ), .IN6(\main/n169 ), .Q(\main/n77 )
         );
  NOR2X0 \main/U135  ( .IN1(N275), .IN2(N2018), .QN(\main/n167 ) );
  OA221X1 \main/U134  ( .IN1(\main/n72 ), .IN2(\main/n71 ), .IN3(\main/n72 ), 
        .IN4(\main/n70 ), .IN5(\main/n69 ), .Q(\main/n75 ) );
  NAND3X0 \main/U133  ( .IN1(N275), .IN2(\main/n74 ), .IN3(N2018), .QN(
        \main/n69 ) );
  INVX0 \main/U132  ( .INP(\main/n73 ), .ZN(\main/n74 ) );
  NOR3X0 \main/U131  ( .IN1(\main/n67 ), .IN2(\main/n66 ), .IN3(\main/n65 ), 
        .QN(\main/n71 ) );
  AO222X1 \main/U130  ( .IN1(\main/n64 ), .IN2(\main/n63 ), .IN3(\main/n64 ), 
        .IN4(N2010), .IN5(\main/n63 ), .IN6(N2010), .Q(\main/n65 ) );
  AO222X1 \main/U129  ( .IN1(\main/n62 ), .IN2(\main/n61 ), .IN3(\main/n62 ), 
        .IN4(\main/n158 ), .IN5(\main/n61 ), .IN6(\main/n158 ), .Q(\main/n63 )
         );
  NAND4X0 \main/U128  ( .IN1(\main/n60 ), .IN2(\main/n59 ), .IN3(\main/n58 ), 
        .IN4(\main/n57 ), .QN(\main/n158 ) );
  AO221X1 \main/U127  ( .IN1(\main/n56 ), .IN2(N287), .IN3(\main/n55 ), .IN4(
        N256), .IN5(\main/n156 ), .Q(\main/n61 ) );
  MUX21X1 \main/U126  ( .IN1(N294), .IN2(N259), .S(\main/n55 ), .Q(\main/n62 )
         );
  MUX21X1 \main/U125  ( .IN1(N297), .IN2(N263), .S(\main/n55 ), .Q(\main/n64 )
         );
  AND3X1 \main/U124  ( .IN1(N8), .IN2(\main/n54 ), .IN3(N2014), .Q(\main/n66 )
         );
  AND3X1 \main/U123  ( .IN1(\main/n53 ), .IN2(N8), .IN3(N2016), .Q(\main/n67 )
         );
  AO222X1 \main/U122  ( .IN1(\main/n52 ), .IN2(\main/n51 ), .IN3(\main/n52 ), 
        .IN4(\main/n50 ), .IN5(\main/n51 ), .IN6(\main/n50 ), .Q(\main/n72 )
         );
  AO222X1 \main/U121  ( .IN1(\main/n49 ), .IN2(\main/n48 ), .IN3(\main/n49 ), 
        .IN4(\main/n47 ), .IN5(\main/n48 ), .IN6(\main/n47 ), .Q(\main/n50 )
         );
  INVX0 \main/U120  ( .INP(\main/n54 ), .ZN(\main/n48 ) );
  OA22X1 \main/U119  ( .IN1(N305), .IN2(\main/n46 ), .IN3(N269), .IN4(
        \main/n73 ), .Q(\main/n54 ) );
  NOR2X0 \main/U118  ( .IN1(N2012), .IN2(\main/n68 ), .QN(\main/n49 ) );
  MUX21X1 \main/U117  ( .IN1(N301), .IN2(N266), .S(\main/n55 ), .Q(\main/n68 )
         );
  INVX0 \main/U116  ( .INP(\main/n53 ), .ZN(\main/n52 ) );
  OA22X1 \main/U115  ( .IN1(N309), .IN2(\main/n46 ), .IN3(N272), .IN4(
        \main/n73 ), .Q(\main/n53 ) );
  INVX0 \main/U114  ( .INP(\main/n55 ), .ZN(\main/n56 ) );
  NOR3X0 \main/U113  ( .IN1(N278), .IN2(N2020), .IN3(\main/n73 ), .QN(
        \main/n78 ) );
  NAND2X0 \main/U112  ( .IN1(N8), .IN2(\main/n55 ), .QN(\main/n73 ) );
  NAND3X0 \main/U111  ( .IN1(\main/n45 ), .IN2(N1816), .IN3(N40), .QN(
        \main/n55 ) );
  NOR3X0 \main/U110  ( .IN1(N281), .IN2(\main/n85 ), .IN3(N2022), .QN(
        \main/n84 ) );
  NOR2X0 \main/U109  ( .IN1(\main/n85 ), .IN2(\main/n207 ), .QN(\main/n88 ) );
  NAND4X0 \main/U108  ( .IN1(\main/n44 ), .IN2(\main/n43 ), .IN3(\main/n42 ), 
        .IN4(\main/n41 ), .QN(\main/n100 ) );
  INVX0 \main/U107  ( .INP(\main/n92 ), .ZN(\main/n85 ) );
  NOR2X0 \main/U106  ( .IN1(\main/n196 ), .IN2(\main/n195 ), .QN(\main/n91 )
         );
  NOR2X0 \main/U105  ( .IN1(\main/n40 ), .IN2(\main/n39 ), .QN(\main/n195 ) );
  AO22X1 \main/U104  ( .IN1(\main/n103 ), .IN2(N140), .IN3(\main/n104 ), .IN4(
        N128), .Q(\main/n39 ) );
  AO22X1 \main/U103  ( .IN1(\main/n105 ), .IN2(N104), .IN3(\main/n106 ), .IN4(
        N116), .Q(\main/n40 ) );
  INVX0 \main/U102  ( .INP(N294), .ZN(\main/n196 ) );
  NOR2X0 \main/U101  ( .IN1(\main/n45 ), .IN2(\main/n38 ), .QN(\main/n92 ) );
  NOR2X0 \main/U100  ( .IN1(N1818), .IN2(N262), .QN(\main/n45 ) );
  NAND4X0 \main/U99  ( .IN1(\main/n37 ), .IN2(\main/n36 ), .IN3(\main/n35 ), 
        .IN4(\main/n34 ), .QN(N2010) );
  NAND3X0 \main/U98  ( .IN1(N237), .IN2(N15), .IN3(N2), .QN(N799) );
  AOI22X1 \main/U97  ( .IN1(N231), .IN2(\main/n151 ), .IN3(N325), .IN4(
        \main/n152 ), .QN(N1726) );
  NAND4X0 \main/U96  ( .IN1(N44), .IN2(N82), .IN3(N96), .IN4(N132), .QN(
        \main/n152 ) );
  NAND4X0 \main/U95  ( .IN1(N57), .IN2(N69), .IN3(N108), .IN4(N120), .QN(
        \main/n151 ) );
  ...
  NAND2X0 \main/U44  ( .IN1(N287), .IN2(\main/n100 ), .QN(\main/n207 ) );
  NAND2X0 \main/U43  ( .IN1(N284), .IN2(\main/n99 ), .QN(\main/n206 ) );
  NAND2X0 \main/U42  ( .IN1(\main/n92 ), .IN2(N2022), .QN(\main/n76 ) );
  NAND2X0 \main/U41  ( .IN1(\main/n106 ), .IN2(N107), .QN(\main/n79 ) );
  NAND2X0 \main/U40  ( .IN1(N2012), .IN2(\main/n68 ), .QN(\main/n70 ) );
  NAND2X0 \main/U39  ( .IN1(N8), .IN2(N2016), .QN(\main/n51 ) );
  NAND2X0 \main/U38  ( .IN1(N8), .IN2(N2014), .QN(\main/n47 ) );
  NAND2X0 \main/U37  ( .IN1(\main/n56 ), .IN2(N8), .QN(\main/n46 ) );
  NAND2X0 \main/U36  ( .IN1(\main/n113 ), .IN2(N88), .QN(\main/n13 ) );
  NAND2X0 \main/U35  ( .IN1(\main/n114 ), .IN2(N75), .QN(\main/n12 ) );
  NAND2X0 \main/U34  ( .IN1(\main/n116 ), .IN2(N50), .QN(\main/n10 ) );
  NAND2X0 \main/U33  ( .IN1(\main/n115 ), .IN2(N60), .QN(\main/n3 ) );
  NAND2X0 \main/U32  ( .IN1(\main/n113 ), .IN2(N85), .QN(\main/n5 ) );
  NAND2X0 \main/U31  ( .IN1(\main/n114 ), .IN2(N72), .QN(\main/n4 ) );
  NAND2X0 \main/U30  ( .IN1(\main/n115 ), .IN2(N63), .QN(\main/n7 ) );
  NAND2X0 \main/U29  ( .IN1(\main/n113 ), .IN2(N89), .QN(\main/n9 ) );
  NAND2X0 \main/U28  ( .IN1(\main/n114 ), .IN2(N76), .QN(\main/n8 ) );
  NAND2X0 \main/U27  ( .IN1(\main/n115 ), .IN2(N65), .QN(\main/n35 ) );
  NAND2X0 \main/U26  ( .IN1(\main/n113 ), .IN2(N91), .QN(\main/n37 ) );
  NAND2X0 \main/U25  ( .IN1(\main/n114 ), .IN2(N78), .QN(\main/n36 ) );
  NAND2X0 \main/U24  ( .IN1(\main/n115 ), .IN2(N61), .QN(\main/n15 ) );
  NAND2X0 \main/U23  ( .IN1(\main/n113 ), .IN2(N86), .QN(\main/n17 ) );
  NAND2X0 \main/U22  ( .IN1(\main/n114 ), .IN2(N73), .QN(\main/n16 ) );
  NAND2X0 \main/U21  ( .IN1(\main/n115 ), .IN2(N62), .QN(\main/n11 ) );
  NAND2X0 \main/U20  ( .IN1(\main/n113 ), .IN2(N93), .QN(\main/n120 ) );
  NAND2X0 \main/U19  ( .IN1(\main/n114 ), .IN2(N80), .QN(\main/n119 ) );
  NAND2X0 \main/U18  ( .IN1(\main/n116 ), .IN2(N55), .QN(\main/n117 ) );
  NAND2X0 \main/U17  ( .IN1(\main/n115 ), .IN2(N66), .QN(\main/n58 ) );
  NAND2X0 \main/U16  ( .IN1(\main/n113 ), .IN2(N92), .QN(\main/n60 ) );
  NAND2X0 \main/U15  ( .IN1(\main/n115 ), .IN2(N56), .QN(\main/n28 ) );
  NAND2X0 \main/U14  ( .IN1(\main/n113 ), .IN2(N81), .QN(\main/n30 ) );
  NAND2X0 \main/U13  ( .IN1(\main/n114 ), .IN2(N68), .QN(\main/n29 ) );
  NAND2X0 \main/U12  ( .IN1(N278), .IN2(N2020), .QN(\main/n169 ) );
  NAND2X0 \main/U11  ( .IN1(\main/n103 ), .IN2(N135), .QN(\main/n110 ) );
  NAND2X0 \main/U10  ( .IN1(\main/n105 ), .IN2(N99), .QN(\main/n108 ) );
  NAND2X0 \main/U9  ( .IN1(\main/n115 ), .IN2(N67), .QN(\main/n118 ) );
  NAND2X0 \main/U8  ( .IN1(\main/n104 ), .IN2(N123), .QN(\main/n109 ) );
  NAND2X0 \main/U7  ( .IN1(\main/n103 ), .IN2(N141), .QN(\main/n44 ) );
  NAND2X0 \main/U6  ( .IN1(\main/n105 ), .IN2(N105), .QN(\main/n42 ) );
  NAND2X0 \main/U5  ( .IN1(\main/n106 ), .IN2(N117), .QN(\main/n41 ) );
  NAND2X0 \main/U4  ( .IN1(\main/n103 ), .IN2(N131), .QN(\main/n82 ) );
  NAND2X0 \main/U3  ( .IN1(\main/n105 ), .IN2(N95), .QN(\main/n80 ) );
  NAND2X0 \main/U2  ( .IN1(\main/n104 ), .IN2(N129), .QN(\main/n43 ) );
  NAND2X0 \main/U1  ( .IN1(\main/n104 ), .IN2(N119), .QN(\main/n81 ) );
  ...
  OA221X1 \flip/U41  ( .IN1(N263), .IN2(keyinput21), .IN3(N53), .IN4(
        keyinput26), .IN5(\flip/n32 ), .Q(\flip/n33 ) );
  AOI22X1 \flip/U40  ( .IN1(N263), .IN2(keyinput21), .IN3(N53), .IN4(
        keyinput26), .QN(\flip/n32 ) );
  OA221X1 \flip/U39  ( .IN1(N54), .IN2(keyinput20), .IN3(N297), .IN4(
        keyinput22), .IN5(\flip/n31 ), .Q(\flip/n34 ) );
  AOI22X1 \flip/U38  ( .IN1(N54), .IN2(keyinput20), .IN3(N297), .IN4(
        keyinput22), .QN(\flip/n31 ) );
  OA221X1 \flip/U37  ( .IN1(N63), .IN2(keyinput16), .IN3(keyinput27), .IN4(
        N128), .IN5(\flip/n30 ), .Q(\flip/n35 ) );
  AOI22X1 \flip/U36  ( .IN1(N63), .IN2(keyinput16), .IN3(keyinput27), .IN4(
        N128), .QN(\flip/n30 ) );
  OA221X1 \flip/U35  ( .IN1(N61), .IN2(keyinput30), .IN3(N259), .IN4(
        keyinput29), .IN5(\flip/n29 ), .Q(\flip/n36 ) );
  AOI22X1 \flip/U34  ( .IN1(N61), .IN2(keyinput30), .IN3(N259), .IN4(
        keyinput29), .QN(\flip/n29 ) );
  NAND4X0 \flip/U33  ( .IN1(\flip/n28 ), .IN2(\flip/n27 ), .IN3(\flip/n26 ), 
        .IN4(\flip/n25 ), .QN(\flip/n38 ) );
  XNOR2X1 \flip/U32  ( .IN1(N95), .IN2(keyinput31), .Q(\flip/n25 ) );
  XNOR2X1 \flip/U31  ( .IN1(N66), .IN2(keyinput28), .Q(\flip/n26 ) );
  XNOR2X1 \flip/U30  ( .IN1(N141), .IN2(keyinput25), .Q(\flip/n27 ) );
  XNOR2X1 \flip/U29  ( .IN1(N89), .IN2(keyinput24), .Q(\flip/n28 ) );
  NAND4X0 \flip/U28  ( .IN1(\flip/n24 ), .IN2(\flip/n23 ), .IN3(\flip/n22 ), 
        .IN4(\flip/n21 ), .QN(\flip/n39 ) );
  XNOR2X1 \flip/U27  ( .IN1(N107), .IN2(keyinput23), .Q(\flip/n21 ) );
  XNOR2X1 \flip/U26  ( .IN1(N50), .IN2(keyinput19), .Q(\flip/n22 ) );
  XNOR2X1 \flip/U25  ( .IN1(N272), .IN2(keyinput18), .Q(\flip/n23 ) );
  XNOR2X1 \flip/U24  ( .IN1(N85), .IN2(keyinput17), .Q(\flip/n24 ) );
  NOR4X0 \flip/U23  ( .IN1(\flip/n20 ), .IN2(\flip/n19 ), .IN3(\flip/n18 ), 
        .IN4(\flip/n17 ), .QN(\flip/n40 ) );
  NAND4X0 \flip/U22  ( .IN1(\flip/n16 ), .IN2(\flip/n15 ), .IN3(\flip/n14 ), 
        .IN4(\flip/n13 ), .QN(\flip/n17 ) );
  OA221X1 \flip/U21  ( .IN1(N50), .IN2(keyinput3), .IN3(N107), .IN4(keyinput7), 
        .IN5(\flip/n12 ), .Q(\flip/n13 ) );
  AOI22X1 \flip/U20  ( .IN1(N50), .IN2(keyinput3), .IN3(N107), .IN4(keyinput7), 
        .QN(\flip/n12 ) );
  OA221X1 \flip/U19  ( .IN1(\flip/n11 ), .IN2(keyinput13), .IN3(\flip/n10 ), 
        .IN4(keyinput15), .IN5(\flip/n9 ), .Q(\flip/n14 ) );
  AOI22X1 \flip/U18  ( .IN1(\flip/n11 ), .IN2(keyinput13), .IN3(\flip/n10 ), 
        .IN4(keyinput15), .QN(\flip/n9 ) );
  INVX0 \flip/U17  ( .INP(N95), .ZN(\flip/n10 ) );
  INVX0 \flip/U16  ( .INP(N259), .ZN(\flip/n11 ) );
  OA221X1 \flip/U15  ( .IN1(N53), .IN2(keyinput10), .IN3(N89), .IN4(keyinput8), 
        .IN5(\flip/n8 ), .Q(\flip/n15 ) );
  AOI22X1 \flip/U14  ( .IN1(N53), .IN2(keyinput10), .IN3(N89), .IN4(keyinput8), 
        .QN(\flip/n8 ) );
  OA221X1 \flip/U13  ( .IN1(N66), .IN2(keyinput12), .IN3(N85), .IN4(keyinput1), 
        .IN5(\flip/n7 ), .Q(\flip/n16 ) );
  AOI22X1 \flip/U12  ( .IN1(N66), .IN2(keyinput12), .IN3(N85), .IN4(keyinput1), 
        .QN(\flip/n7 ) );
  NAND4X0 \flip/U11  ( .IN1(\flip/n6 ), .IN2(\flip/n5 ), .IN3(\flip/n4 ), 
        .IN4(\flip/n3 ), .QN(\flip/n18 ) );
  XNOR2X1 \flip/U10  ( .IN1(N272), .IN2(keyinput2), .Q(\flip/n3 ) );
  XNOR2X1 \flip/U9  ( .IN1(N141), .IN2(keyinput9), .Q(\flip/n4 ) );
  XNOR2X1 \flip/U8  ( .IN1(N297), .IN2(keyinput6), .Q(\flip/n5 ) );
  XNOR2X1 \flip/U7  ( .IN1(N128), .IN2(keyinput11), .Q(\flip/n6 ) );
  AO221X1 \flip/U6  ( .IN1(N61), .IN2(keyinput14), .IN3(keyinput0), .IN4(N63), 
        .IN5(\flip/n2 ), .Q(\flip/n19 ) );
  OAI22X1 \flip/U5  ( .IN1(N61), .IN2(keyinput14), .IN3(N63), .IN4(keyinput0), 
        .QN(\flip/n2 ) );
  AO221X1 \flip/U4  ( .IN1(N263), .IN2(keyinput5), .IN3(keyinput4), .IN4(N54), 
        .IN5(\flip/n1 ), .Q(\flip/n20 ) );
  OAI22X1 \flip/U3  ( .IN1(N263), .IN2(keyinput5), .IN3(N54), .IN4(keyinput4), 
        .QN(\flip/n1 ) );
endmodule
