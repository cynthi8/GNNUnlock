...
module c2670_AntiSAT_8_0_top ( N145, N153, N162, N168, N172, N210, N190, N212, 
  ...
  NOR2X0 \main/U227  ( .IN1(\main/n186 ), .IN2(N227), .QN(\main/n96 ) );
  INVX0 \main/U226  ( .INP(N227), .ZN(\main/n180 ) );
  NOR2X0 \main/U225  ( .IN1(\main/n180 ), .IN2(N234), .QN(\main/n97 ) );
  NOR2X0 \main/U224  ( .IN1(\main/n186 ), .IN2(\main/n180 ), .QN(\main/n99 )
         );
  NOR2X0 \main/U223  ( .IN1(N227), .IN2(N234), .QN(\main/n100 ) );
  AO22X1 \main/U222  ( .IN1(N78), .IN2(\main/n99 ), .IN3(N91), .IN4(
        \main/n100 ), .Q(\main/n185 ) );
  AO221X1 \main/U221  ( .IN1(N65), .IN2(\main/n96 ), .IN3(N53), .IN4(
        \main/n97 ), .IN5(\main/n185 ), .Q(N2010) );
  AO22X1 \main/U220  ( .IN1(N77), .IN2(\main/n99 ), .IN3(N90), .IN4(
        \main/n100 ), .Q(\main/n184 ) );
  AO221X1 \main/U219  ( .IN1(N64), .IN2(\main/n96 ), .IN3(N52), .IN4(
        \main/n97 ), .IN5(\main/n184 ), .Q(N2012) );
  AO22X1 \main/U218  ( .IN1(N76), .IN2(\main/n99 ), .IN3(N89), .IN4(
        \main/n100 ), .Q(\main/n183 ) );
  AO221X1 \main/U217  ( .IN1(N63), .IN2(\main/n96 ), .IN3(N51), .IN4(
        \main/n97 ), .IN5(\main/n183 ), .Q(N2014) );
  AO22X1 \main/U216  ( .IN1(N75), .IN2(\main/n99 ), .IN3(N88), .IN4(
        \main/n100 ), .Q(\main/n182 ) );
  AO221X1 \main/U215  ( .IN1(N62), .IN2(\main/n96 ), .IN3(N50), .IN4(
        \main/n97 ), .IN5(\main/n182 ), .Q(N2016) );
  AO21X1 \main/U214  ( .IN1(N49), .IN2(\main/n97 ), .IN3(\main/n96 ), .Q(
        \main/n181 ) );
  AO221X1 \main/U213  ( .IN1(N87), .IN2(\main/n180 ), .IN3(N74), .IN4(N234), 
        .IN5(\main/n181 ), .Q(N2018) );
  AO22X1 \main/U212  ( .IN1(N73), .IN2(\main/n99 ), .IN3(N86), .IN4(
        \main/n100 ), .Q(\main/n179 ) );
  AO221X1 \main/U211  ( .IN1(N61), .IN2(\main/n96 ), .IN3(N48), .IN4(
        \main/n97 ), .IN5(\main/n179 ), .Q(N2020) );
  AO22X1 \main/U210  ( .IN1(N72), .IN2(\main/n99 ), .IN3(N85), .IN4(
        \main/n100 ), .Q(\main/n178 ) );
  AO221X1 \main/U209  ( .IN1(N60), .IN2(\main/n96 ), .IN3(N47), .IN4(
        \main/n97 ), .IN5(\main/n178 ), .Q(N2022) );
  AO22X1 \main/U208  ( .IN1(N325), .IN2(\main/n176 ), .IN3(N231), .IN4(
        \main/n177 ), .Q(\main/n5 ) );
  XNOR2X1 \main/U207  ( .IN1(flip_signal), .IN2(\main/n5 ), .Q(N1726) );
  INVX0 \main/U206  ( .INP(N322), .ZN(\main/n175 ) );
  INVX0 \main/U205  ( .INP(N319), .ZN(\main/n174 ) );
  NOR2X0 \main/U204  ( .IN1(\main/n175 ), .IN2(\main/n174 ), .QN(\main/n90 )
         );
  NOR2X0 \main/U203  ( .IN1(\main/n175 ), .IN2(N319), .QN(\main/n91 ) );
  NOR2X0 \main/U202  ( .IN1(\main/n174 ), .IN2(N322), .QN(\main/n93 ) );
  NOR2X0 \main/U201  ( .IN1(N319), .IN2(N322), .QN(\main/n94 ) );
  AO22X1 \main/U200  ( .IN1(N101), .IN2(\main/n93 ), .IN3(N137), .IN4(
        \main/n94 ), .Q(\main/n173 ) );
  AOI221X1 \main/U199  ( .IN1(N113), .IN2(\main/n90 ), .IN3(N125), .IN4(
        \main/n91 ), .IN5(\main/n173 ), .QN(N1816) );
  AO22X1 \main/U198  ( .IN1(N100), .IN2(\main/n93 ), .IN3(N136), .IN4(
        \main/n94 ), .Q(\main/n172 ) );
  AOI221X1 \main/U197  ( .IN1(N112), .IN2(\main/n90 ), .IN3(N124), .IN4(
        \main/n91 ), .IN5(\main/n172 ), .QN(N1817) );
  AO22X1 \main/U196  ( .IN1(N102), .IN2(\main/n93 ), .IN3(N138), .IN4(
        \main/n94 ), .Q(\main/n171 ) );
  AO221X1 \main/U195  ( .IN1(N114), .IN2(\main/n90 ), .IN3(N126), .IN4(
        \main/n91 ), .IN5(\main/n171 ), .Q(\main/n56 ) );
  ...
  AO22X1 \main/U190  ( .IN1(N68), .IN2(\main/n99 ), .IN3(N81), .IN4(
        \main/n100 ), .Q(\main/n170 ) );
  AO221X1 \main/U189  ( .IN1(N56), .IN2(\main/n96 ), .IN3(N43), .IN4(
        \main/n97 ), .IN5(\main/n170 ), .Q(\main/n55 ) );
  INVX0 \main/U188  ( .INP(\main/n55 ), .ZN(\main/n139 ) );
  NAND2X0 \main/U187  ( .IN1(N241), .IN2(\main/n139 ), .QN(N1969) );
  INVX0 \main/U186  ( .INP(\main/n5 ), .ZN(\main/n169 ) );
  NAND3X0 \main/U185  ( .IN1(\main/n169 ), .IN2(N237), .IN3(N224), .QN(
        \main/n167 ) );
  ...
  XNOR2X1 \flip/U13  ( .IN1(N96), .IN2(keyinput4), .Q(\flip/n1 ) );
  XOR2X1 \flip/U12  ( .IN1(keyinput6), .IN2(N82), .Q(\flip/n5 ) );
  XNOR2X1 \flip/U11  ( .IN1(N96), .IN2(keyinput0), .Q(\flip/n7 ) );
  XNOR2X1 \flip/U10  ( .IN1(N120), .IN2(keyinput3), .Q(\flip/n8 ) );
  XOR2X1 \flip/U9  ( .IN1(keyinput2), .IN2(N82), .Q(\flip/n9 ) );
  XOR2X1 \flip/U8  ( .IN1(keyinput1), .IN2(N231), .Q(\flip/n10 ) );
  NAND4X0 \flip/U7  ( .IN1(\flip/n7 ), .IN2(\flip/n8 ), .IN3(\flip/n9 ), .IN4(
        \flip/n10 ), .QN(\flip/n6 ) );
  NAND2X0 \flip/U6  ( .IN1(\flip/n5 ), .IN2(\flip/n6 ), .QN(\flip/n2 ) );
  XNOR2X1 \flip/U5  ( .IN1(N120), .IN2(keyinput7), .Q(\flip/n3 ) );
  XOR2X1 \flip/U4  ( .IN1(keyinput5), .IN2(N231), .Q(\flip/n4 ) );
