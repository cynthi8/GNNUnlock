...
module c3540_SFLL_HD_2_32_1_top ( N1, N13, N20, N33, N41, N45, N50, N58, N68, 
  ...
  NAND2X0 \main/U75  ( .IN1(\main/n52 ), .IN2(\main/n55 ), .QN(\main/n69 ) );
  NAND2X0 \main/U74  ( .IN1(\main/n153 ), .IN2(\main/n155 ), .QN(\main/n157 )
         );
  NAND2X0 \main/U73  ( .IN1(N87), .IN2(\main/n347 ), .QN(\main/n278 ) );
  NAND2X0 \main/U72  ( .IN1(\main/n395 ), .IN2(N159), .QN(\main/n113 ) );
  NAND2X0 \main/U71  ( .IN1(\main/n396 ), .IN2(N97), .QN(\main/n279 ) );
  NAND2X0 \main/U70  ( .IN1(\main/n158 ), .IN2(\main/n32 ), .QN(\main/n33 ) );
  NAND2X0 \main/U69  ( .IN1(\main/n242 ), .IN2(\main/n255 ), .QN(\main/n249 )
         );
  NAND2X0 \main/U68  ( .IN1(\main/n395 ), .IN2(N132), .QN(\main/n317 ) );
  NAND2X0 \main/U67  ( .IN1(\main/n398 ), .IN2(N311), .QN(\main/n344 ) );
  NAND2X0 \main/U66  ( .IN1(\main/n172 ), .IN2(\main/n131 ), .QN(\main/n25 )
         );
  NAND2X0 \main/U65  ( .IN1(\main/n173 ), .IN2(\main/n175 ), .QN(\main/n163 )
         );
  NAND2X0 \main/U64  ( .IN1(N179), .IN2(N20), .QN(\main/n5 ) );
  NAND2X0 \main/U63  ( .IN1(\main/n394 ), .IN2(N68), .QN(\main/n277 ) );
  NAND2X0 \main/U62  ( .IN1(\main/n75 ), .IN2(\main/n74 ), .QN(\main/n79 ) );
  NAND2X0 \main/U61  ( .IN1(\main/n132 ), .IN2(\main/n131 ), .QN(\main/n175 )
         );
  NAND2X0 \main/U60  ( .IN1(N97), .IN2(\main/n397 ), .QN(\main/n220 ) );
  NAND2X0 \main/U59  ( .IN1(N77), .IN2(N68), .QN(\main/n285 ) );
  NAND2X0 \main/U58  ( .IN1(\main/n219 ), .IN2(\main/n218 ), .QN(N5121) );
  NAND2X0 \main/U57  ( .IN1(\main/n266 ), .IN2(\main/n265 ), .QN(N5120) );
  NAND2X0 \main/U56  ( .IN1(\main/n271 ), .IN2(\main/n324 ), .QN(\main/n272 )
         );
  NAND2X0 \main/U55  ( .IN1(N87), .IN2(\main/n272 ), .QN(N1947) );
  NAND2X0 \main/U54  ( .IN1(\main/n305 ), .IN2(\main/n304 ), .QN(\main/n306 )
         );
  NAND2X0 \main/U53  ( .IN1(\main/n307 ), .IN2(\main/n306 ), .QN(N5047) );
  NAND2X0 \main/U52  ( .IN1(\main/n323 ), .IN2(\main/n433 ), .QN(\main/n213 )
         );
  NAND2X0 \main/U51  ( .IN1(\main/n159 ), .IN2(\main/n243 ), .QN(\main/n160 )
         );
  NAND2X0 \main/U50  ( .IN1(\main/n384 ), .IN2(\main/n34 ), .QN(\main/n338 )
         );
  NAND2X0 \main/U49  ( .IN1(\main/n90 ), .IN2(\main/n88 ), .QN(\main/n129 ) );
  NAND2X0 \main/U48  ( .IN1(N50), .IN2(N41), .QN(\main/n235 ) );
  NAND2X0 \main/U47  ( .IN1(N50), .IN2(\main/n435 ), .QN(\main/n458 ) );
  NAND2X0 \main/U46  ( .IN1(N20), .IN2(N1), .QN(\main/n464 ) );
  NAND2X0 \main/U45  ( .IN1(\main/n198 ), .IN2(\main/n191 ), .QN(\main/n336 )
         );
  NAND2X0 \main/U44  ( .IN1(\main/n323 ), .IN2(\main/n434 ), .QN(\main/n332 )
         );
  NAND2X0 \main/U43  ( .IN1(\main/n394 ), .IN2(N97), .QN(\main/n328 ) );
  NAND2X0 \main/U42  ( .IN1(\main/n359 ), .IN2(N50), .QN(\main/n360 ) );
  ...
  NAND2X0 \main/U23  ( .IN1(N200), .IN2(\main/n3 ), .QN(\main/n4 ) );
  NAND2X0 \main/U22  ( .IN1(N50), .IN2(\main/n395 ), .QN(\main/n276 ) );
  ...
  NAND2X0 \main/U7  ( .IN1(\main/n359 ), .IN2(N77), .QN(\main/n281 ) );
  NAND2X0 \main/U6  ( .IN1(N87), .IN2(\main/n394 ), .QN(\main/n222 ) );
  ...
  FADDX1 \perturb/U50  ( .A(N294), .B(\perturb/n46 ), .CI(\perturb/n45 ), .CO(
        \perturb/n52 ), .S(\perturb/n33 ) );
  ...
  FADDX1 \perturb/U40  ( .A(N303), .B(N13), .CI(\perturb/n24 ), .CO(
        \perturb/n51 ), .S(\perturb/n31 ) );
  FADDX1 \perturb/U39  ( .A(N107), .B(N200), .CI(\perturb/n23 ), .CO(
        \perturb/n42 ), .S(\perturb/n32 ) );
  INVX0 \perturb/U38  ( .INP(N343), .ZN(\perturb/n45 ) );
  INVX0 \perturb/U37  ( .INP(N77), .ZN(\perturb/n46 ) );
  NAND4X0 \perturb/U36  ( .IN1(\perturb/n22 ), .IN2(\perturb/n21 ), .IN3(
        \perturb/n20 ), .IN4(\perturb/n19 ), .QN(\perturb/n72 ) );
  NAND2X0 \perturb/U35  ( .IN1(\perturb/n60 ), .IN2(\perturb/n59 ), .QN(
        \perturb/n17 ) );
  INVX0 \perturb/U34  ( .INP(\perturb/n61 ), .ZN(\perturb/n18 ) );
  NOR2X0 \perturb/U33  ( .IN1(\perturb/n58 ), .IN2(\perturb/n57 ), .QN(
        \perturb/n61 ) );
  OR2X1 \perturb/U32  ( .IN1(\perturb/n16 ), .IN2(\perturb/n15 ), .Q(
        \perturb/n57 ) );
  AND2X1 \perturb/U31  ( .IN1(N50), .IN2(N283), .Q(\perturb/n15 ) );
  NAND4X0 \perturb/U30  ( .IN1(\perturb/n44 ), .IN2(\perturb/n42 ), .IN3(
        \perturb/n41 ), .IN4(\perturb/n40 ), .QN(\perturb/n58 ) );
  FADDX1 \perturb/U29  ( .A(\perturb/n14 ), .B(\perturb/n13 ), .CI(
        \perturb/n12 ), .CO(\perturb/n44 ), .S(\perturb/n28 ) );
  OA22X1 \perturb/U28  ( .IN1(\perturb/n11 ), .IN2(\perturb/n40 ), .IN3(
        \perturb/n55 ), .IN4(\perturb/n10 ), .Q(\perturb/n20 ) );
  AND2X1 \perturb/U27  ( .IN1(\perturb/n54 ), .IN2(\perturb/n53 ), .Q(
        \perturb/n10 ) );
  FADDX1 \perturb/U26  ( .A(N213), .B(N1), .CI(\perturb/n9 ), .CO(
        \perturb/n55 ), .S(\perturb/n25 ) );
  FADDX1 \perturb/U25  ( .A(N116), .B(N244), .CI(\perturb/n8 ), .CO(
        \perturb/n40 ), .S(\perturb/n29 ) );
  AND2X1 \perturb/U24  ( .IN1(\perturb/n42 ), .IN2(\perturb/n41 ), .Q(
        \perturb/n11 ) );
  FADDX1 \perturb/U23  ( .A(N264), .B(N45), .CI(\perturb/n7 ), .CO(
        \perturb/n41 ), .S(\perturb/n27 ) );
  INVX0 \perturb/U22  ( .INP(N169), .ZN(\perturb/n23 ) );
  OA21X1 \perturb/U21  ( .IN1(\perturb/n54 ), .IN2(\perturb/n53 ), .IN3(
        \perturb/n6 ), .Q(\perturb/n21 ) );
  NAND2X0 \perturb/U20  ( .IN1(N50), .IN2(\perturb/n16 ), .QN(\perturb/n6 ) );
  FADDX1 \perturb/U19  ( .A(N159), .B(N238), .CI(N143), .CO(\perturb/n16 ), 
        .S(\perturb/n2 ) );
  FADDX1 \perturb/U18  ( .A(N58), .B(\perturb/n5 ), .CI(\perturb/n4 ), .CO(
        \perturb/n53 ), .S(\perturb/n30 ) );
  FADDX1 \perturb/U17  ( .A(N87), .B(N190), .CI(N330), .CO(\perturb/n54 ), .S(
        \perturb/n26 ) );
  OA22X1 \perturb/U16  ( .IN1(\perturb/n60 ), .IN2(\perturb/n59 ), .IN3(
        \perturb/n51 ), .IN4(\perturb/n50 ), .Q(\perturb/n22 ) );
  FADDX1 \perturb/U15  ( .A(N270), .B(N68), .CI(\perturb/n3 ), .CO(
        \perturb/n50 ), .S(\perturb/n13 ) );
  INVX0 \perturb/U14  ( .INP(N274), .ZN(\perturb/n24 ) );
  INVX0 \perturb/U13  ( .INP(N20), .ZN(\perturb/n9 ) );
  INVX0 \perturb/U12  ( .INP(N322), .ZN(\perturb/n7 ) );
  INVX0 \perturb/U11  ( .INP(\perturb/n2 ), .ZN(\perturb/n12 ) );
  INVX0 \perturb/U10  ( .INP(N349), .ZN(\perturb/n3 ) );
  MUX21X1 \perturb/U9  ( .IN1(\perturb/n1 ), .IN2(N50), .S(N283), .Q(
        \perturb/n14 ) );
  INVX0 \perturb/U8  ( .INP(N50), .ZN(\perturb/n1 ) );
  INVX0 \perturb/U7  ( .INP(N41), .ZN(\perturb/n8 ) );
  INVX0 \perturb/U6  ( .INP(N257), .ZN(\perturb/n4 ) );
  INVX0 \perturb/U5  ( .INP(N311), .ZN(\perturb/n5 ) );
  ...
  XNOR2X1 \restore/U58  ( .IN1(keyinput3), .IN2(N343), .Q(\restore/n64 ) );
  XNOR2X1 \restore/U57  ( .IN1(keyinput5), .IN2(N77), .Q(\restore/n65 ) );
  XNOR2X1 \restore/U56  ( .IN1(keyinput7), .IN2(N294), .Q(\restore/n66 ) );
  ...
  XNOR2X1 \restore/U38  ( .IN1(keyinput27), .IN2(N169), .Q(\restore/n36 ) );
  XNOR2X1 \restore/U37  ( .IN1(keyinput25), .IN2(N107), .Q(\restore/n37 ) );
  XNOR2X1 \restore/U36  ( .IN1(keyinput29), .IN2(N200), .Q(\restore/n38 ) );
  ...
  XNOR2X1 \restore/U33  ( .IN1(keyinput21), .IN2(N13), .Q(\restore/n39 ) );
  XNOR2X1 \restore/U32  ( .IN1(keyinput19), .IN2(N303), .Q(\restore/n40 ) );
  XNOR2X1 \restore/U31  ( .IN1(keyinput23), .IN2(N274), .Q(\restore/n41 ) );
  XNOR2X1 \restore/U30  ( .IN1(keyinput18), .IN2(N190), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U29  ( .IN1(keyinput20), .IN2(N330), .Q(\restore/n8 ) );
  XNOR2X1 \restore/U28  ( .IN1(keyinput16), .IN2(N87), .Q(\restore/n9 ) );
  XNOR2X1 \restore/U27  ( .IN1(keyinput24), .IN2(N264), .Q(\restore/n4 ) );
  XNOR2X1 \restore/U26  ( .IN1(keyinput26), .IN2(N45), .Q(\restore/n5 ) );
  XNOR2X1 \restore/U25  ( .IN1(keyinput22), .IN2(N322), .Q(\restore/n6 ) );
  XNOR2X1 \restore/U24  ( .IN1(keyinput30), .IN2(N213), .Q(\restore/n16 ) );
  XNOR2X1 \restore/U23  ( .IN1(keyinput31), .IN2(N1), .Q(\restore/n17 ) );
  XNOR2X1 \restore/U22  ( .IN1(keyinput28), .IN2(N20), .Q(\restore/n18 ) );
  XNOR2X1 \restore/U21  ( .IN1(keyinput6), .IN2(N244), .Q(\restore/n13 ) );
  XNOR2X1 \restore/U20  ( .IN1(keyinput8), .IN2(N41), .Q(\restore/n14 ) );
  XNOR2X1 \restore/U19  ( .IN1(keyinput0), .IN2(N116), .Q(\restore/n15 ) );
  XNOR2X1 \restore/U18  ( .IN1(keyinput1), .IN2(N238), .Q(\restore/n24 ) );
  XNOR2X1 \restore/U17  ( .IN1(keyinput9), .IN2(N159), .Q(\restore/n25 ) );
  XNOR2X1 \restore/U16  ( .IN1(keyinput11), .IN2(N143), .Q(\restore/n26 ) );
  XNOR2X1 \restore/U15  ( .IN1(keyinput15), .IN2(N68), .Q(\restore/n1 ) );
  XNOR2X1 \restore/U14  ( .IN1(keyinput13), .IN2(N270), .Q(\restore/n2 ) );
  XNOR2X1 \restore/U13  ( .IN1(keyinput17), .IN2(N349), .Q(\restore/n3 ) );
  MUX21X1 \restore/U12  ( .IN1(\restore/n62 ), .IN2(\restore/n28 ), .S(
        \restore/n27 ), .Q(\restore/n23 ) );
  XOR2X1 \restore/U11  ( .IN1(keyinput2), .IN2(N50), .Q(\restore/n27 ) );
  INVX0 \restore/U10  ( .INP(\restore/n62 ), .ZN(\restore/n28 ) );
  XNOR2X1 \restore/U9  ( .IN1(keyinput4), .IN2(N283), .Q(\restore/n62 ) );
  XNOR2X1 \restore/U8  ( .IN1(keyinput12), .IN2(N311), .Q(\restore/n10 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput14), .IN2(N58), .Q(\restore/n11 ) );
  XNOR2X1 \restore/U6  ( .IN1(keyinput10), .IN2(N257), .Q(\restore/n12 ) );
