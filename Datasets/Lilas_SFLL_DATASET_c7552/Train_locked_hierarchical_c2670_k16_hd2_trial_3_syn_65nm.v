...
module c2670 ( N1, N2, N3, N4, N5, N6, N7, N8, N11, N14, N15, N16, N19, N20, 
  ...
  wire   N292, N293, N219, N253, N290, N143_I, N144_I, N145_I, N146_I, N147_I,
         ...
         n430, n431, n432, n433, n434, n435, n436, n437, n438, \perturbb/n36 ,
  ...
  AOI221_X0P5M_A9TH U269 ( .A0(n406), .A1(N309), .B0(n401), .B1(N272), .C0(
        n413), .Y(n416) );
  AOI22_X0P5M_A9TH U270 ( .A0(n406), .A1(n403), .B0(n402), .B1(n401), .Y(n404)
         );
  ...
  NAND2_X0P5M_A9TH U302 ( .A(n298), .B(n297), .Y(n328) );
  NAND2_X0P5M_A9TH U303 ( .A(n290), .B(n289), .Y(n387) );
  NAND2_X0P5M_A9TH U304 ( .A(n292), .B(n291), .Y(n344) );
  NAND2_X0P7M_A9TH U305 ( .A(n264), .B(n263), .Y(n330) );
  AOI22_X0P5M_A9TH U306 ( .A0(n349), .A1(N63), .B0(n348), .B1(N51), .Y(n262)
         );
  AOI22_X0P5M_A9TH U307 ( .A0(n351), .A1(N79), .B0(n350), .B1(N92), .Y(n273)
         );
  NOR3_X0P5A_A9TH U308 ( .A(n270), .B(n269), .C(n268), .Y(n271) );
  OAI211_X0P5M_A9TH U309 ( .A0(N278), .A1(N6), .B0(n316), .C0(n315), .Y(n317)
         );
  AOI22_X0P5M_A9TH U310 ( .A0(n351), .A1(N75), .B0(n350), .B1(N88), .Y(n259)
         );
  AOI22_X0P5M_A9TH U311 ( .A0(n349), .A1(N62), .B0(n348), .B1(N50), .Y(n260)
         );
  AOI22_X0P5M_A9TH U312 ( .A0(n351), .A1(N78), .B0(n350), .B1(N91), .Y(n253)
         );
  AOI22_X0P5M_A9TH U313 ( .A0(n349), .A1(N65), .B0(n348), .B1(N53), .Y(n254)
         );
  AOI22_X0P5M_A9TH U314 ( .A0(n335), .A1(N105), .B0(n334), .B1(N141), .Y(n291)
         );
  AOI22_X0P5M_A9TH U315 ( .A0(n337), .A1(N117), .B0(n336), .B1(N129), .Y(n292)
         );
  AOI22_X0P5M_A9TH U316 ( .A0(n351), .A1(N80), .B0(n350), .B1(N93), .Y(n352)
         );
  AOI22_X0P5M_A9TH U317 ( .A0(n349), .A1(N67), .B0(n348), .B1(N55), .Y(n353)
         );
  AOI22_X0P5M_A9TH U318 ( .A0(n351), .A1(N76), .B0(n350), .B1(N89), .Y(n261)
         );
  AOI22_X0P5M_A9TH U319 ( .A0(n349), .A1(N56), .B0(n348), .B1(N43), .Y(n279)
         );
  AOI22_X0P5M_A9TH U320 ( .A0(N234), .A1(N74), .B0(n348), .B1(N49), .Y(n255)
         );
  AOI22_X0P5M_A9TH U321 ( .A0(n351), .A1(N77), .B0(n350), .B1(N90), .Y(n251)
         );
  AOI22_X0P5M_A9TH U322 ( .A0(n351), .A1(N73), .B0(n350), .B1(N86), .Y(n257)
         );
  AOI22_X0P5M_A9TH U323 ( .A0(n349), .A1(N66), .B0(n348), .B1(N54), .Y(n274)
         );
  AOI22_X0P5M_A9TH U324 ( .A0(n351), .A1(N68), .B0(n350), .B1(N81), .Y(n278)
         );
  AOI22_X0P5M_A9TH U325 ( .A0(n349), .A1(N61), .B0(n348), .B1(N48), .Y(n258)
         );
  AOI22_X0P5M_A9TH U326 ( .A0(n337), .A1(N116), .B0(n336), .B1(N128), .Y(n290)
         );
  AOI22_X0P5M_A9TH U327 ( .A0(n335), .A1(N101), .B0(n334), .B1(N137), .Y(n301)
         );
  AOI22_X0P5M_A9TH U328 ( .A0(n351), .A1(N72), .B0(n350), .B1(N85), .Y(n249)
         );
  AOI22_X0P5M_A9TH U329 ( .A0(n337), .A1(N111), .B0(n336), .B1(N123), .Y(n305)
         );
  AOI22_X0P5M_A9TH U330 ( .A0(n335), .A1(N104), .B0(n334), .B1(N140), .Y(n289)
         );
  AOI22_X0P5M_A9TH U331 ( .A0(n337), .A1(N112), .B0(n336), .B1(N124), .Y(n240)
         );
  AOI22_X0P5M_A9TH U332 ( .A0(n335), .A1(N102), .B0(n334), .B1(N138), .Y(n263)
         );
  AOI22_X0P5M_A9TH U333 ( .A0(n335), .A1(N100), .B0(n334), .B1(N136), .Y(n239)
         );
  AOI22_X0P5M_A9TH U334 ( .A0(n335), .A1(N99), .B0(n334), .B1(N135), .Y(n304)
         );
  AOI22_X0P5M_A9TH U335 ( .A0(n349), .A1(N60), .B0(n348), .B1(N47), .Y(n250)
         );
  AOI22_X0P5M_A9TH U336 ( .A0(n349), .A1(N64), .B0(n348), .B1(N52), .Y(n252)
         );
  AOI22_X0P5M_A9TH U337 ( .A0(n337), .A1(N114), .B0(n336), .B1(N126), .Y(n264)
         );
  AOI22_X0P5M_A9TH U338 ( .A0(n337), .A1(N113), .B0(n336), .B1(N125), .Y(n302)
         );
  OAI221_X0P5M_A9TH U339 ( .A0(N305), .A1(N34), .B0(N301), .B1(N27), .C0(n266), 
        .Y(n269) );
  AOI221_X0P5M_A9TH U340 ( .A0(N269), .A1(N21), .B0(N24), .B1(N281), .C0(n314), 
        .Y(n315) );
  AOI221_X0P5M_A9TH U341 ( .A0(N275), .A1(N23), .B0(N4), .B1(N259), .C0(n311), 
        .Y(n320) );
  OAI221_X0P5M_A9TH U342 ( .A0(N284), .A1(N25), .B0(N297), .B1(N33), .C0(n267), 
        .Y(n268) );
  NOR2_X0P5M_A9TH U343 ( .A(n326), .B(n327), .Y(N1034) );
  AOI221_X0P5M_A9TH U344 ( .A0(N266), .A1(N5), .B0(N256), .B1(N19), .C0(n312), 
        .Y(n319) );
  AOI22_X0P5M_A9TH U345 ( .A0(N266), .A1(N263), .B0(n276), .B1(n402), .Y(n236)
         );
  AOI22_X0P5M_A9TH U346 ( .A0(N294), .A1(N297), .B0(n241), .B1(n391), .Y(n246)
         );
  OAI221_X0P5M_A9TH U347 ( .A0(N287), .A1(N32), .B0(N309), .B1(N35), .C0(n265), 
        .Y(n270) );
  AOI221_X0P5M_A9TH U348 ( .A0(N272), .A1(N22), .B0(N20), .B1(N263), .C0(n313), 
        .Y(n316) );
  AOI22_X0P5M_A9TH U349 ( .A0(N269), .A1(N281), .B0(n275), .B1(n231), .Y(n232)
         );
  AOI22_X0P5M_A9TH U350 ( .A0(N259), .A1(n394), .B0(N256), .B1(n390), .Y(n362)
         );
  AOI22_X0P5M_A9TH U351 ( .A0(N278), .A1(N284), .B0(n230), .B1(n284), .Y(n235)
         );
  AOI22_X0P5M_A9TH U352 ( .A0(N309), .A1(N305), .B0(n242), .B1(n296), .Y(n245)
         );
  AOI22_X0P5M_A9TH U353 ( .A0(N231), .A1(n327), .B0(N325), .B1(n326), .Y(N1591) );
  NOR2_X0P5M_A9TH U354 ( .A(N234), .B(N87), .Y(n256) );
  INV_X0P7M_A9TH U355 ( .A(N227), .Y(n247) );
  INV_X0P6M_A9TH U356 ( .A(N319), .Y(n238) );
  INV_X0P6M_A9TH U357 ( .A(N322), .Y(n237) );
  AOI22_X0P5M_A9TH U358 ( .A0(N284), .A1(N25), .B0(N297), .B1(N33), .Y(n267)
         );
  OAI22_X0P5M_A9TH U359 ( .A0(N275), .A1(N23), .B0(N259), .B1(N4), .Y(n311) );
  AOI22_X0P5M_A9TH U360 ( .A0(N305), .A1(N34), .B0(N301), .B1(N27), .Y(n266)
         );
  OAI22_X0P5M_A9TH U361 ( .A0(N266), .A1(N5), .B0(N19), .B1(N256), .Y(n312) );
  AOI22_X0P5M_A9TH U362 ( .A0(N287), .A1(N32), .B0(N309), .B1(N35), .Y(n265)
         );
  NAND2_X0P5M_A9TH U363 ( .A(N237), .B(N7), .Y(N1028) );
  OAI22_X0P5M_A9TH U364 ( .A0(N272), .A1(N22), .B0(N263), .B1(N20), .Y(n313)
         );
  OAI22_X0P5M_A9TH U365 ( .A0(N269), .A1(N21), .B0(N281), .B1(N24), .Y(n314)
         );
  INV_X0P7M_A9TH U366 ( .A(N234), .Y(n248) );
  ...
  NAND4B_X0P7M_A9TH U377 ( .AN(n288), .B(n287), .C(n286), .D(n420), .Y(n323)
         );
  AOI22_X0P5M_A9TH U378 ( .A0(n406), .A1(N297), .B0(N263), .B1(n401), .Y(n398)
         );
  OAI221_X0P5M_A9TH U379 ( .A0(n406), .A1(n394), .B0(n401), .B1(n393), .C0(
        n392), .Y(n396) );
  ...
  OAI22_X0P5M_A9TH U397 ( .A0(n296), .A1(N1817), .B0(n332), .B1(N297), .Y(n295) );
  INV_X0P6M_A9TH U398 ( .A(N1619), .Y(N1820) );
  INV_X0P6M_A9TH U399 ( .A(n395), .Y(n438) );
  ...
  AOI22_X0P5M_A9TH U409 ( .A0(n337), .A1(N115), .B0(n336), .B1(N127), .Y(n294)
         );
  ...
  XOR2_X0P5M_A9TH \perturbb/U29  ( .A(\perturbb/n13 ), .B(\perturbb/n12 ), .Y(
        \perturbb/n26 ) );
  NOR2_X0P5M_A9TH \perturbb/U28  ( .A(\perturbb/n28 ), .B(\perturbb/n27 ), .Y(
        \perturbb/n31 ) );
  NAND2_X0P5M_A9TH \perturbb/U27  ( .A(\perturbb/n13 ), .B(\perturbb/n12 ), 
        .Y(\perturbb/n28 ) );
  ADDF_X1M_A9TH \perturbb/U26  ( .A(N209_I), .B(N203_I), .CI(\perturbb/n9 ), 
        .CO(\perturbb/n22 ), .S(\perturbb/n12 ) );
  ADDF_X1M_A9TH \perturbb/U25  ( .A(N206_I), .B(N204_I), .CI(\perturbb/n8 ), 
        .CO(\perturbb/n19 ), .S(\perturbb/n13 ) );
  AND3_X0P5M_A9TH \perturbb/U24  ( .A(\perturbb/n22 ), .B(\perturbb/n18 ), .C(
        \perturbb/n17 ), .Y(\perturbb/n32 ) );
  INV_X0P5B_A9TH \perturbb/U23  ( .A(N211_I), .Y(\perturbb/n9 ) );
  OAI22_X0P5M_A9TH \perturbb/U22  ( .A0(\perturbb/n18 ), .A1(\perturbb/n17 ), 
        .B0(N205_I), .B1(\perturbb/n11 ), .Y(\perturbb/n34 ) );
  ADDF_X1M_A9TH \perturbb/U21  ( .A(N213_I), .B(\perturbb/n7 ), .CI(
        \perturbb/n6 ), .CO(\perturbb/n17 ), .S(\perturbb/n15 ) );
  ADDF_X1M_A9TH \perturbb/U20  ( .A(N210_I), .B(\perturbb/n5 ), .CI(
        \perturbb/n4 ), .CO(\perturbb/n18 ), .S(\perturbb/n16 ) );
  NAND2_X0P5M_A9TH \perturbb/U19  ( .A(\perturbb/n20 ), .B(\perturbb/n19 ), 
        .Y(\perturbb/n35 ) );
  ADDF_X1M_A9TH \perturbb/U18  ( .A(N218_I), .B(\perturbb/n2 ), .CI(
        \perturbb/n1 ), .CO(\perturbb/n11 ), .S(\perturbb/n14 ) );
  INV_X0P5B_A9TH \perturbb/U17  ( .A(N215_I), .Y(\perturbb/n6 ) );
  INV_X0P5B_A9TH \perturbb/U16  ( .A(N217_I), .Y(\perturbb/n7 ) );
  INV_X0P5B_A9TH \perturbb/U15  ( .A(N212_I), .Y(\perturbb/n4 ) );
  INV_X0P5B_A9TH \perturbb/U14  ( .A(N208_I), .Y(\perturbb/n5 ) );
  NAND2_X0P5M_A9TH \perturbb/U13  ( .A(\perturbb/n11 ), .B(\perturbb/n10 ), 
        .Y(\perturbb/n36 ) );
  INV_X0P5B_A9TH \perturbb/U12  ( .A(N205_I), .Y(\perturbb/n3 ) );
  INV_X0P5B_A9TH \perturbb/U11  ( .A(N216_I), .Y(\perturbb/n1 ) );
  INV_X0P5B_A9TH \perturbb/U10  ( .A(N214_I), .Y(\perturbb/n2 ) );
  AOI22_X0P5M_A9TH \perturbb/U9  ( .A0(\perturbb/n28 ), .A1(\perturbb/n27 ), 
        .B0(\perturbb/n32 ), .B1(\perturbb/n31 ), .Y(\perturbb/n29 ) );
  NAND2_X0P5M_A9TH \perturbb/U8  ( .A(N207_I), .B(\perturbb/n3 ), .Y(
        \perturbb/n10 ) );
  OAI21_X0P5M_A9TH \perturbb/U7  ( .A0(N207_I), .A1(\perturbb/n3 ), .B0(
        \perturbb/n10 ), .Y(\perturbb/n8 ) );
  NAND4_X0P5M_A9TH \perturbb/U6  ( .A(\perturbb/n11 ), .B(\perturbb/n20 ), .C(
        \perturbb/n19 ), .D(\perturbb/n10 ), .Y(\perturbb/n27 ) );
  AOI211_X0P5M_A9TH \perturbb/U5  ( .A0(\perturbb/n26 ), .A1(\perturbb/n25 ), 
  ...
  NAND2_X0P5M_A9TH \restore/U10  ( .A(\restore/n19 ), .B(\restore/n18 ), .Y(
        \restore/n44 ) );
  NAND3_X0P5A_A9TH \restore/U9  ( .A(\restore/n34 ), .B(\restore/n33 ), .C(
        \restore/n32 ), .Y(\restore/n38 ) );
  NAND2_X0P5M_A9TH \restore/U8  ( .A(\restore/n36 ), .B(\restore/n35 ), .Y(
        \restore/n37 ) );
