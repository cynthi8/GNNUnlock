...
module c2670_AntiSAT_8_1_top ( N145, N153, N162, N168, N172, N210, N190, N212, 
  ...
  MUX21X1 \main/U164  ( .IN1(\main/n101 ), .IN2(\main/n100 ), .S(\main/n99 ), 
        .Q(N3546) );
  NOR2X0 \main/U163  ( .IN1(N241), .IN2(\main/n98 ), .QN(\main/n99 ) );
  MUX21X1 \main/U162  ( .IN1(\main/n154 ), .IN2(\main/n153 ), .S(\main/n97 ), 
        .Q(\main/n98 ) );
  INVX0 \main/U161  ( .INP(\main/n157 ), .ZN(\main/n156 ) );
  INVX0 \main/U160  ( .INP(\main/n101 ), .ZN(\main/n100 ) );
  XOR2X1 \main/U159  ( .IN1(flip_signal), .IN2(\main/n96 ), .Q(N2971) );
  MUX21X1 \main/U158  ( .IN1(\main/n157 ), .IN2(N2012), .S(N246), .Q(N2387) );
  MUX21X1 \main/U157  ( .IN1(\main/n101 ), .IN2(\main/n95 ), .S(N246), .Q(
        N3803) );
  MUX21X1 \main/U156  ( .IN1(\main/n94 ), .IN2(\main/n93 ), .S(\main/n92 ), 
        .Q(\main/n95 ) );
  NAND3X0 \main/U155  ( .IN1(N1726), .IN2(\main/n91 ), .IN3(\main/n150 ), .QN(
        N3882) );
  ...
  XNOR3X1 \main/U152  ( .IN1(N349), .IN2(N346), .IN3(\main/n87 ), .Q(
        \main/n88 ) );
  MUX21X1 \main/U151  ( .IN1(N259), .IN2(\main/n155 ), .S(\main/n86 ), .Q(
        \main/n87 ) );
  XOR3X1 \main/U150  ( .IN1(N256), .IN2(N331), .IN3(N328), .Q(\main/n86 ) );
  INVX0 \main/U149  ( .INP(N259), .ZN(\main/n155 ) );
  NOR4X0 \main/U148  ( .IN1(N3671), .IN2(N3809), .IN3(N2970), .IN4(\main/n96 ), 
        .QN(\main/n91 ) );
  XOR3X1 \main/U147  ( .IN1(\main/n173 ), .IN2(N266), .IN3(\main/n85 ), .Q(
        \main/n96 ) );
  XOR3X1 \main/U146  ( .IN1(\main/n152 ), .IN2(N284), .IN3(\main/n84 ), .Q(
        \main/n85 ) );
  XNOR3X1 \main/U145  ( .IN1(N278), .IN2(\main/n83 ), .IN3(\main/n82 ), .Q(
        \main/n84 ) );
  XOR3X1 \main/U144  ( .IN1(N272), .IN2(N269), .IN3(N275), .Q(\main/n82 ) );
  MUX21X1 \main/U143  ( .IN1(N287), .IN2(\main/n181 ), .S(N352), .Q(\main/n83 ) );
  INVX0 \main/U142  ( .INP(N287), .ZN(\main/n181 ) );
  INVX0 \main/U141  ( .INP(N263), .ZN(\main/n152 ) );
  INVX0 \main/U140  ( .INP(N281), .ZN(\main/n173 ) );
  NOR2X0 \main/U139  ( .IN1(\main/n81 ), .IN2(N37), .QN(N3809) );
  XOR3X1 \main/U138  ( .IN1(\main/n92 ), .IN2(N1820), .IN3(N1821), .Q(
        \main/n81 ) );
  XNOR3X1 \main/U137  ( .IN1(N2020), .IN2(N2018), .IN3(\main/n80 ), .Q(
        \main/n92 ) );
  XOR3X1 \main/U136  ( .IN1(\main/n157 ), .IN2(\main/n154 ), .IN3(\main/n79 ), 
        .Q(\main/n80 ) );
  XOR3X1 \main/U135  ( .IN1(N2016), .IN2(\main/n78 ), .IN3(N2022), .Q(
        \main/n79 ) );
  MUX21X1 \main/U134  ( .IN1(N2010), .IN2(\main/n151 ), .S(\main/n101 ), .Q(
        \main/n78 ) );
  NAND4X0 \main/U133  ( .IN1(\main/n77 ), .IN2(\main/n76 ), .IN3(\main/n75 ), 
        .IN4(\main/n74 ), .QN(\main/n101 ) );
  INVX0 \main/U132  ( .INP(N2010), .ZN(\main/n151 ) );
  NOR2X0 \main/U131  ( .IN1(\main/n69 ), .IN2(N37), .QN(N3671) );
  XOR3X1 \main/U130  ( .IN1(\main/n68 ), .IN2(\main/n147 ), .IN3(\main/n190 ), 
        .Q(\main/n69 ) );
  NOR2X0 \main/U129  ( .IN1(\main/n67 ), .IN2(\main/n66 ), .QN(\main/n190 ) );
  AO22X1 \main/U128  ( .IN1(\main/n65 ), .IN2(N140), .IN3(\main/n64 ), .IN4(
        N128), .Q(\main/n66 ) );
  AO22X1 \main/U127  ( .IN1(\main/n63 ), .IN2(N104), .IN3(\main/n62 ), .IN4(
        N116), .Q(\main/n67 ) );
  INVX0 \main/U126  ( .INP(\main/n198 ), .ZN(\main/n147 ) );
  NAND4X0 \main/U125  ( .IN1(\main/n61 ), .IN2(\main/n60 ), .IN3(\main/n59 ), 
        .IN4(\main/n58 ), .QN(\main/n198 ) );
  XNOR3X1 \main/U124  ( .IN1(\main/n192 ), .IN2(N1817), .IN3(\main/n57 ), .Q(
        \main/n68 ) );
  XNOR3X1 \main/U123  ( .IN1(N1818), .IN2(N1816), .IN3(\main/n56 ), .Q(
        \main/n57 ) );
  XNOR3X1 \main/U122  ( .IN1(\main/n104 ), .IN2(\main/n55 ), .IN3(\main/n135 ), 
        .Q(\main/n56 ) );
  NAND4X0 \main/U121  ( .IN1(\main/n54 ), .IN2(\main/n53 ), .IN3(\main/n52 ), 
        .IN4(\main/n51 ), .QN(\main/n135 ) );
  NOR2X0 \main/U120  ( .IN1(\main/n50 ), .IN2(\main/n49 ), .QN(\main/n55 ) );
  AO22X1 \main/U119  ( .IN1(\main/n65 ), .IN2(N142), .IN3(\main/n64 ), .IN4(
        N130), .Q(\main/n49 ) );
  AO22X1 \main/U118  ( .IN1(\main/n63 ), .IN2(N106), .IN3(\main/n62 ), .IN4(
        N118), .Q(\main/n50 ) );
  NOR2X0 \main/U117  ( .IN1(\main/n48 ), .IN2(\main/n47 ), .QN(\main/n104 ) );
  AO22X1 \main/U116  ( .IN1(\main/n65 ), .IN2(N141), .IN3(\main/n64 ), .IN4(
        N129), .Q(\main/n47 ) );
  AO22X1 \main/U115  ( .IN1(\main/n63 ), .IN2(N105), .IN3(\main/n62 ), .IN4(
        N117), .Q(\main/n48 ) );
  NOR2X0 \main/U114  ( .IN1(\main/n46 ), .IN2(\main/n45 ), .QN(\main/n192 ) );
  AO22X1 \main/U113  ( .IN1(\main/n65 ), .IN2(N139), .IN3(\main/n64 ), .IN4(
        N127), .Q(\main/n45 ) );
  AO22X1 \main/U112  ( .IN1(\main/n63 ), .IN2(N103), .IN3(\main/n62 ), .IN4(
        N115), .Q(\main/n46 ) );
  INVX0 \main/U111  ( .INP(N2014), .ZN(N1820) );
  INVX0 \main/U110  ( .INP(N2016), .ZN(N1819) );
  MUX21X1 \main/U109  ( .IN1(\main/n153 ), .IN2(\main/n94 ), .S(N246), .Q(
        N2643) );
  INVX0 \main/U108  ( .INP(\main/n93 ), .ZN(\main/n94 ) );
  NOR2X0 \main/U107  ( .IN1(N230), .IN2(\main/n157 ), .QN(\main/n93 ) );
  NAND4X0 \main/U106  ( .IN1(\main/n44 ), .IN2(\main/n43 ), .IN3(\main/n42 ), 
        .IN4(\main/n41 ), .QN(\main/n157 ) );
  MUX21X1 \main/U105  ( .IN1(N2010), .IN2(N2014), .S(N246), .Q(N2389) );
  NAND4X0 \main/U104  ( .IN1(\main/n40 ), .IN2(\main/n39 ), .IN3(\main/n38 ), 
        .IN4(\main/n37 ), .QN(N2010) );
  AND2X1 \main/U103  ( .IN1(N398), .IN2(N94), .Q(N1026) );
  NAND3X0 \main/U102  ( .IN1(N237), .IN2(N15), .IN3(N2), .QN(N799) );
  AOI22X1 \main/U101  ( .IN1(N231), .IN2(\main/n148 ), .IN3(N325), .IN4(
        \main/n149 ), .QN(N1726) );
  NAND4X0 \main/U100  ( .IN1(N44), .IN2(N82), .IN3(N96), .IN4(N132), .QN(
        \main/n149 ) );
  NAND4X0 \main/U99  ( .IN1(N57), .IN2(N69), .IN3(N108), .IN4(N120), .QN(
        \main/n148 ) );
  XOR3X1 \main/U98  ( .IN1(\main/n191 ), .IN2(N297), .IN3(\main/n36 ), .Q(
        N2970) );
  XOR3X1 \main/U97  ( .IN1(\main/n194 ), .IN2(N301), .IN3(\main/n35 ), .Q(
        \main/n36 ) );
  XOR3X1 \main/U96  ( .IN1(\main/n34 ), .IN2(N316), .IN3(\main/n146 ), .Q(
        \main/n35 ) );
  INVX0 \main/U95  ( .INP(N313), .ZN(\main/n146 ) );
  MUX21X1 \main/U94  ( .IN1(N305), .IN2(\main/n201 ), .S(N355), .Q(\main/n34 )
         );
  INVX0 \main/U93  ( .INP(N305), .ZN(\main/n201 ) );
  INVX0 \main/U92  ( .INP(N309), .ZN(\main/n194 ) );
  INVX0 \main/U91  ( .INP(N294), .ZN(\main/n191 ) );
  AO21X1 \main/U90  ( .IN1(\main/n73 ), .IN2(N49), .IN3(\main/n33 ), .Q(N2018)
         );
  ...
  AO22X1 \main/U83  ( .IN1(\main/n65 ), .IN2(N136), .IN3(\main/n64 ), .IN4(
        N124), .Q(\main/n25 ) );
  AO22X1 \main/U82  ( .IN1(\main/n63 ), .IN2(N100), .IN3(\main/n62 ), .IN4(
        N112), .Q(\main/n26 ) );
  NOR2X0 \main/U81  ( .IN1(\main/n24 ), .IN2(\main/n23 ), .QN(N1818) );
  AO22X1 \main/U80  ( .IN1(\main/n65 ), .IN2(N138), .IN3(\main/n64 ), .IN4(
        N126), .Q(\main/n23 ) );
  AO22X1 \main/U79  ( .IN1(\main/n63 ), .IN2(N102), .IN3(\main/n62 ), .IN4(
        N114), .Q(\main/n24 ) );
  NOR2X0 \main/U78  ( .IN1(\main/n22 ), .IN2(\main/n21 ), .QN(N1816) );
  AO22X1 \main/U77  ( .IN1(\main/n65 ), .IN2(N137), .IN3(\main/n64 ), .IN4(
        N125), .Q(\main/n21 ) );
  NOR2X0 \main/U76  ( .IN1(N319), .IN2(\main/n20 ), .QN(\main/n64 ) );
  NOR2X0 \main/U75  ( .IN1(N319), .IN2(N322), .QN(\main/n65 ) );
  AO22X1 \main/U74  ( .IN1(\main/n63 ), .IN2(N101), .IN3(\main/n62 ), .IN4(
        N113), .Q(\main/n22 ) );
  AND2X1 \main/U73  ( .IN1(N319), .IN2(N322), .Q(\main/n62 ) );
  AND2X1 \main/U72  ( .IN1(\main/n20 ), .IN2(N319), .Q(\main/n63 ) );
  INVX0 \main/U71  ( .INP(N322), .ZN(\main/n20 ) );
  INVX0 \main/U70  ( .INP(N1821), .ZN(N2012) );
  NOR2X0 \main/U69  ( .IN1(\main/n19 ), .IN2(\main/n18 ), .QN(N1821) );
  AO22X1 \main/U68  ( .IN1(\main/n70 ), .IN2(N90), .IN3(\main/n71 ), .IN4(N77), 
        .Q(\main/n18 ) );
  AO22X1 \main/U67  ( .IN1(\main/n72 ), .IN2(N64), .IN3(\main/n73 ), .IN4(N52), 
        .Q(\main/n19 ) );
  ...
  NOR2X0 \main/U62  ( .IN1(N234), .IN2(\main/n32 ), .QN(\main/n73 ) );
  NOR2X0 \main/U61  ( .IN1(N227), .IN2(\main/n1 ), .QN(\main/n72 ) );
  NOR2X0 \main/U60  ( .IN1(\main/n32 ), .IN2(\main/n1 ), .QN(\main/n71 ) );
  INVX0 \main/U59  ( .INP(N234), .ZN(\main/n1 ) );
  INVX0 \main/U58  ( .INP(N227), .ZN(\main/n32 ) );
  NOR2X0 \main/U57  ( .IN1(N227), .IN2(N234), .QN(\main/n70 ) );
  ...
  NAND2X0 \main/U53  ( .IN1(\main/n73 ), .IN2(N47), .QN(\main/n2 ) );
  NAND2X0 \main/U52  ( .IN1(N14), .IN2(\main/n90 ), .QN(\main/n150 ) );
  NAND2X0 \main/U51  ( .IN1(\main/n73 ), .IN2(N51), .QN(\main/n6 ) );
  NAND2X0 \main/U50  ( .IN1(N11), .IN2(\main/n212 ), .QN(\main/n213 ) );
  NAND2X0 \main/U49  ( .IN1(\main/n73 ), .IN2(N53), .QN(\main/n37 ) );
  NAND2X0 \main/U48  ( .IN1(\main/n73 ), .IN2(N48), .QN(\main/n14 ) );
  NAND2X0 \main/U47  ( .IN1(\main/n71 ), .IN2(N79), .QN(\main/n43 ) );
  NAND2X0 \main/U46  ( .IN1(\main/n142 ), .IN2(\main/n209 ), .QN(\main/n138 )
         );
  NAND2X0 \main/U45  ( .IN1(\main/n73 ), .IN2(N43), .QN(\main/n27 ) );
  NAND2X0 \main/U44  ( .IN1(N275), .IN2(N2018), .QN(\main/n166 ) );
  NAND2X0 \main/U43  ( .IN1(\main/n62 ), .IN2(N111), .QN(\main/n58 ) );
  NAND2X0 \main/U42  ( .IN1(N284), .IN2(\main/n135 ), .QN(\main/n205 ) );
  NAND2X0 \main/U41  ( .IN1(\main/n156 ), .IN2(N230), .QN(\main/n97 ) );
  ...
  NAND2X0 \main/U34  ( .IN1(\main/n70 ), .IN2(N88), .QN(\main/n13 ) );
  NAND2X0 \main/U33  ( .IN1(\main/n71 ), .IN2(N75), .QN(\main/n12 ) );
  NAND2X0 \main/U32  ( .IN1(\main/n73 ), .IN2(N50), .QN(\main/n10 ) );
  NAND2X0 \main/U31  ( .IN1(\main/n72 ), .IN2(N60), .QN(\main/n3 ) );
  NAND2X0 \main/U30  ( .IN1(\main/n70 ), .IN2(N85), .QN(\main/n5 ) );
  NAND2X0 \main/U29  ( .IN1(\main/n71 ), .IN2(N72), .QN(\main/n4 ) );
  NAND2X0 \main/U28  ( .IN1(\main/n72 ), .IN2(N63), .QN(\main/n7 ) );
  NAND2X0 \main/U27  ( .IN1(\main/n70 ), .IN2(N89), .QN(\main/n9 ) );
  NAND2X0 \main/U26  ( .IN1(\main/n71 ), .IN2(N76), .QN(\main/n8 ) );
  NAND2X0 \main/U25  ( .IN1(\main/n72 ), .IN2(N65), .QN(\main/n38 ) );
  NAND2X0 \main/U24  ( .IN1(\main/n70 ), .IN2(N91), .QN(\main/n40 ) );
  NAND2X0 \main/U23  ( .IN1(\main/n71 ), .IN2(N78), .QN(\main/n39 ) );
  NAND2X0 \main/U22  ( .IN1(\main/n72 ), .IN2(N61), .QN(\main/n15 ) );
  NAND2X0 \main/U21  ( .IN1(\main/n70 ), .IN2(N86), .QN(\main/n17 ) );
  NAND2X0 \main/U20  ( .IN1(\main/n71 ), .IN2(N73), .QN(\main/n16 ) );
  NAND2X0 \main/U19  ( .IN1(\main/n72 ), .IN2(N62), .QN(\main/n11 ) );
  NAND2X0 \main/U18  ( .IN1(\main/n70 ), .IN2(N93), .QN(\main/n77 ) );
  NAND2X0 \main/U17  ( .IN1(\main/n71 ), .IN2(N80), .QN(\main/n76 ) );
  NAND2X0 \main/U16  ( .IN1(\main/n73 ), .IN2(N55), .QN(\main/n74 ) );
  NAND2X0 \main/U15  ( .IN1(\main/n72 ), .IN2(N66), .QN(\main/n42 ) );
  NAND2X0 \main/U14  ( .IN1(\main/n70 ), .IN2(N92), .QN(\main/n44 ) );
  NAND2X0 \main/U13  ( .IN1(\main/n73 ), .IN2(N54), .QN(\main/n41 ) );
  NAND2X0 \main/U12  ( .IN1(\main/n72 ), .IN2(N56), .QN(\main/n28 ) );
  NAND2X0 \main/U11  ( .IN1(\main/n70 ), .IN2(N81), .QN(\main/n30 ) );
  NAND2X0 \main/U10  ( .IN1(\main/n71 ), .IN2(N68), .QN(\main/n29 ) );
  NAND2X0 \main/U9  ( .IN1(N278), .IN2(N2020), .QN(\main/n167 ) );
  NAND2X0 \main/U8  ( .IN1(\main/n65 ), .IN2(N135), .QN(\main/n61 ) );
  NAND2X0 \main/U7  ( .IN1(\main/n63 ), .IN2(N99), .QN(\main/n59 ) );
  NAND2X0 \main/U6  ( .IN1(\main/n72 ), .IN2(N67), .QN(\main/n75 ) );
  NAND2X0 \main/U5  ( .IN1(\main/n64 ), .IN2(N123), .QN(\main/n60 ) );
  NAND2X0 \main/U4  ( .IN1(\main/n65 ), .IN2(N131), .QN(\main/n54 ) );
  NAND2X0 \main/U3  ( .IN1(\main/n63 ), .IN2(N95), .QN(\main/n52 ) );
  NAND2X0 \main/U2  ( .IN1(\main/n62 ), .IN2(N107), .QN(\main/n51 ) );
  NAND2X0 \main/U1  ( .IN1(\main/n64 ), .IN2(N119), .QN(\main/n53 ) );
  NOR4X0 \flip/U13  ( .IN1(\flip/n10 ), .IN2(\flip/n9 ), .IN3(\flip/n8 ), 
        .IN4(\flip/n7 ), .QN(flip_signal) );
  AO221X1 \flip/U12  ( .IN1(keyinput6), .IN2(N281), .IN3(keyinput5), .IN4(N352), .IN5(\flip/n6 ), .Q(\flip/n7 ) );
  OAI22X1 \flip/U11  ( .IN1(keyinput6), .IN2(N281), .IN3(N352), .IN4(keyinput5), .QN(\flip/n6 ) );
  XOR2X1 \flip/U10  ( .IN1(N284), .IN2(keyinput7), .Q(\flip/n8 ) );
  XOR2X1 \flip/U9  ( .IN1(N272), .IN2(keyinput4), .Q(\flip/n9 ) );
  NOR2X0 \flip/U8  ( .IN1(\flip/n5 ), .IN2(\flip/n4 ), .QN(\flip/n10 ) );
  AO221X1 \flip/U7  ( .IN1(N284), .IN2(keyinput3), .IN3(keyinput2), .IN4(N281), 
        .IN5(\flip/n3 ), .Q(\flip/n4 ) );
  OAI22X1 \flip/U6  ( .IN1(N284), .IN2(keyinput3), .IN3(N281), .IN4(keyinput2), 
        .QN(\flip/n3 ) );
  AO221X1 \flip/U5  ( .IN1(N272), .IN2(keyinput0), .IN3(keyinput1), .IN4(
        \flip/n2 ), .IN5(\flip/n1 ), .Q(\flip/n5 ) );
  OAI22X1 \flip/U4  ( .IN1(N272), .IN2(keyinput0), .IN3(\flip/n2 ), .IN4(
        keyinput1), .QN(\flip/n1 ) );
  INVX0 \flip/U3  ( .INP(N352), .ZN(\flip/n2 ) );
endmodule
