...
module c2670_SFLL_HD_0_32_0_top ( N145, N153, N162, N168, N172, N210, N190, 
  ...
  NAND2X0 \main/U43  ( .IN1(\main/n81 ), .IN2(N99), .QN(\main/n77 ) );
  NAND2X0 \main/U42  ( .IN1(\main/n80 ), .IN2(N111), .QN(\main/n76 ) );
  ...
  NAND2X0 \main/U38  ( .IN1(N8), .IN2(\main/n114 ), .QN(\main/n128 ) );
  NAND2X0 \main/U37  ( .IN1(N2012), .IN2(\main/n123 ), .QN(\main/n125 ) );
  NAND2X0 \main/U36  ( .IN1(N8), .IN2(N2016), .QN(\main/n110 ) );
  NAND2X0 \main/U35  ( .IN1(N8), .IN2(N2014), .QN(\main/n106 ) );
  NAND2X0 \main/U34  ( .IN1(\main/n115 ), .IN2(N8), .QN(\main/n105 ) );
  NAND2X0 \main/U33  ( .IN1(\main/n43 ), .IN2(N75), .QN(\main/n12 ) );
  NAND2X0 \main/U32  ( .IN1(\main/n42 ), .IN2(N88), .QN(\main/n13 ) );
  NAND2X0 \main/U31  ( .IN1(\main/n45 ), .IN2(N50), .QN(\main/n10 ) );
  NAND2X0 \main/U30  ( .IN1(\main/n44 ), .IN2(N60), .QN(\main/n3 ) );
  NAND2X0 \main/U29  ( .IN1(\main/n43 ), .IN2(N72), .QN(\main/n4 ) );
  NAND2X0 \main/U28  ( .IN1(\main/n42 ), .IN2(N85), .QN(\main/n5 ) );
  NAND2X0 \main/U27  ( .IN1(\main/n44 ), .IN2(N63), .QN(\main/n7 ) );
  NAND2X0 \main/U26  ( .IN1(\main/n43 ), .IN2(N76), .QN(\main/n8 ) );
  NAND2X0 \main/U25  ( .IN1(\main/n42 ), .IN2(N89), .QN(\main/n9 ) );
  NAND2X0 \main/U24  ( .IN1(\main/n44 ), .IN2(N65), .QN(\main/n35 ) );
  NAND2X0 \main/U23  ( .IN1(\main/n43 ), .IN2(N78), .QN(\main/n36 ) );
  NAND2X0 \main/U22  ( .IN1(\main/n45 ), .IN2(N53), .QN(\main/n34 ) );
  NAND2X0 \main/U21  ( .IN1(\main/n44 ), .IN2(N61), .QN(\main/n15 ) );
  NAND2X0 \main/U20  ( .IN1(\main/n43 ), .IN2(N73), .QN(\main/n16 ) );
  NAND2X0 \main/U19  ( .IN1(\main/n42 ), .IN2(N86), .QN(\main/n17 ) );
  NAND2X0 \main/U18  ( .IN1(\main/n44 ), .IN2(N62), .QN(\main/n11 ) );
  NAND2X0 \main/U17  ( .IN1(\main/n43 ), .IN2(N80), .QN(\main/n40 ) );
  NAND2X0 \main/U16  ( .IN1(\main/n42 ), .IN2(N93), .QN(\main/n41 ) );
  NAND2X0 \main/U15  ( .IN1(\main/n45 ), .IN2(N55), .QN(\main/n38 ) );
  NAND2X0 \main/U14  ( .IN1(\main/n44 ), .IN2(N66), .QN(\main/n47 ) );
  NAND2X0 \main/U13  ( .IN1(\main/n42 ), .IN2(N92), .QN(\main/n49 ) );
  NAND2X0 \main/U12  ( .IN1(\main/n45 ), .IN2(N54), .QN(\main/n46 ) );
  NAND2X0 \main/U11  ( .IN1(\main/n44 ), .IN2(N56), .QN(\main/n28 ) );
  NAND2X0 \main/U10  ( .IN1(\main/n43 ), .IN2(N68), .QN(\main/n29 ) );
  NAND2X0 \main/U9  ( .IN1(\main/n42 ), .IN2(N81), .QN(\main/n30 ) );
  NAND2X0 \main/U8  ( .IN1(N278), .IN2(N2020), .QN(\main/n166 ) );
  NAND2X0 \main/U7  ( .IN1(\main/n83 ), .IN2(N135), .QN(\main/n79 ) );
  ...
  NAND2X0 \main/U3  ( .IN1(\main/n80 ), .IN2(N107), .QN(\main/n69 ) );
  NAND2X0 \main/U2  ( .IN1(\main/n81 ), .IN2(N95), .QN(\main/n70 ) );
  ...
  NOR2X0 \perturb/U12  ( .IN1(N87), .IN2(\perturb/n3 ), .QN(\perturb/n4 ) );
  NAND3X0 \perturb/U11  ( .IN1(N80), .IN2(N75), .IN3(N246), .QN(\perturb/n3 )
         );
  AND4X1 \perturb/U10  ( .IN1(N47), .IN2(N56), .IN3(N50), .IN4(N48), .Q(
        \perturb/n5 ) );
  NOR4X0 \perturb/U9  ( .IN1(N53), .IN2(N65), .IN3(N91), .IN4(N79), .QN(
        \perturb/n6 ) );
  NOR4X0 \perturb/U8  ( .IN1(N93), .IN2(N234), .IN3(N61), .IN4(N88), .QN(
        \perturb/n7 ) );
  NAND4X0 \perturb/U7  ( .IN1(N230), .IN2(N81), .IN3(N227), .IN4(N43), .QN(
        \perturb/n9 ) );
  NAND4X0 \perturb/U6  ( .IN1(N67), .IN2(N86), .IN3(N60), .IN4(N78), .QN(
        \perturb/n10 ) );
  NOR4X0 \perturb/U5  ( .IN1(N55), .IN2(N92), .IN3(N54), .IN4(N68), .QN(
        \perturb/n1 ) );
  NOR4X0 \perturb/U4  ( .IN1(N62), .IN2(N73), .IN3(N74), .IN4(N49), .QN(
        \perturb/n2 ) );
  ...
  XNOR2X1 \restore/U41  ( .IN1(keyinput30), .IN2(N86), .Q(\restore/n31 ) );
  XNOR2X1 \restore/U40  ( .IN1(keyinput28), .IN2(N60), .Q(\restore/n32 ) );
  XNOR2X1 \restore/U39  ( .IN1(keyinput26), .IN2(N62), .Q(\restore/n33 ) );
  XNOR2X1 \restore/U38  ( .IN1(keyinput24), .IN2(N67), .Q(\restore/n34 ) );
  NAND4X0 \restore/U37  ( .IN1(\restore/n30 ), .IN2(\restore/n29 ), .IN3(
        \restore/n28 ), .IN4(\restore/n27 ), .QN(\restore/n36 ) );
  XNOR2X1 \restore/U36  ( .IN1(keyinput20), .IN2(N54), .Q(\restore/n27 ) );
  XNOR2X1 \restore/U35  ( .IN1(keyinput18), .IN2(N68), .Q(\restore/n28 ) );
  XNOR2X1 \restore/U34  ( .IN1(keyinput16), .IN2(N48), .Q(\restore/n29 ) );
  XNOR2X1 \restore/U33  ( .IN1(keyinput31), .IN2(N78), .Q(\restore/n30 ) );
  ...
  XNOR2X1 \restore/U30  ( .IN1(keyinput8), .IN2(N50), .Q(\restore/n24 ) );
  XNOR2X1 \restore/U29  ( .IN1(keyinput14), .IN2(N230), .Q(\restore/n25 ) );
  XNOR2X1 \restore/U28  ( .IN1(keyinput12), .IN2(N92), .Q(\restore/n26 ) );
  NAND4X0 \restore/U27  ( .IN1(\restore/n22 ), .IN2(\restore/n21 ), .IN3(
        \restore/n20 ), .IN4(\restore/n19 ), .QN(\restore/n38 ) );
  XNOR2X1 \restore/U26  ( .IN1(keyinput22), .IN2(N73), .Q(\restore/n19 ) );
  XNOR2X1 \restore/U25  ( .IN1(keyinput0), .IN2(N55), .Q(\restore/n20 ) );
  XNOR2X1 \restore/U24  ( .IN1(keyinput4), .IN2(N246), .Q(\restore/n21 ) );
  XNOR2X1 \restore/U23  ( .IN1(keyinput2), .IN2(N75), .Q(\restore/n22 ) );
  NAND4X0 \restore/U22  ( .IN1(\restore/n18 ), .IN2(\restore/n17 ), .IN3(
        \restore/n16 ), .IN4(\restore/n15 ), .QN(\restore/n40 ) );
  XNOR2X1 \restore/U21  ( .IN1(keyinput29), .IN2(N49), .Q(\restore/n15 ) );
  XNOR2X1 \restore/U20  ( .IN1(keyinput9), .IN2(N93), .Q(\restore/n16 ) );
  NOR4X0 \restore/U19  ( .IN1(\restore/n14 ), .IN2(\restore/n13 ), .IN3(
        \restore/n12 ), .IN4(\restore/n11 ), .QN(\restore/n17 ) );
  XOR2X1 \restore/U18  ( .IN1(keyinput10), .IN2(N56), .Q(\restore/n11 ) );
  XOR2X1 \restore/U17  ( .IN1(keyinput19), .IN2(N81), .Q(\restore/n12 ) );
  XOR2X1 \restore/U16  ( .IN1(keyinput21), .IN2(N53), .Q(\restore/n13 ) );
  XOR2X1 \restore/U15  ( .IN1(keyinput23), .IN2(N65), .Q(\restore/n14 ) );
  NOR2X0 \restore/U14  ( .IN1(\restore/n10 ), .IN2(\restore/n9 ), .QN(
        \restore/n18 ) );
  XOR2X1 \restore/U13  ( .IN1(keyinput27), .IN2(N74), .Q(\restore/n9 ) );
  XOR2X1 \restore/U12  ( .IN1(keyinput25), .IN2(N43), .Q(\restore/n10 ) );
  NAND4X0 \restore/U11  ( .IN1(\restore/n8 ), .IN2(\restore/n7 ), .IN3(
        \restore/n6 ), .IN4(\restore/n5 ), .QN(\restore/n41 ) );
  XNOR2X1 \restore/U10  ( .IN1(keyinput17), .IN2(N227), .Q(\restore/n5 ) );
  XNOR2X1 \restore/U9  ( .IN1(keyinput5), .IN2(N88), .Q(\restore/n6 ) );
  XNOR2X1 \restore/U8  ( .IN1(keyinput3), .IN2(N87), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput7), .IN2(N80), .Q(\restore/n8 ) );
  NAND4X0 \restore/U6  ( .IN1(\restore/n4 ), .IN2(\restore/n3 ), .IN3(
        \restore/n2 ), .IN4(\restore/n1 ), .QN(\restore/n42 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput1), .IN2(N234), .Q(\restore/n1 ) );
  XNOR2X1 \restore/U4  ( .IN1(keyinput11), .IN2(N61), .Q(\restore/n2 ) );
  XNOR2X1 \restore/U3  ( .IN1(keyinput13), .IN2(N91), .Q(\restore/n3 ) );
