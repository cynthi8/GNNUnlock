...
module c3540_SFLL_HD_0_32_0_top ( N1, N13, N20, N33, N41, N45, N50, N58, N68, 
  ...
  NAND2X0 \main/U60  ( .IN1(\main/n305 ), .IN2(\main/n466 ), .QN(\main/n159 )
         );
  ...
  NAND2X0 \main/U52  ( .IN1(\main/n396 ), .IN2(N159), .QN(\main/n68 ) );
  ...
  NAND2X0 \main/U28  ( .IN1(\main/n392 ), .IN2(N132), .QN(\main/n346 ) );
  NAND2X0 \main/U27  ( .IN1(N1), .IN2(N13), .QN(\main/n443 ) );
  NAND2X0 \main/U26  ( .IN1(\main/n374 ), .IN2(\main/n80 ), .QN(\main/n88 ) );
  NAND2X0 \main/U25  ( .IN1(\main/n316 ), .IN2(\main/n226 ), .QN(\main/n62 )
         );
  NAND2X0 \main/U24  ( .IN1(N87), .IN2(\main/n397 ), .QN(\main/n252 ) );
  NAND2X0 \main/U23  ( .IN1(\main/n311 ), .IN2(\main/n374 ), .QN(\main/n312 )
         );
  NAND2X0 \main/U22  ( .IN1(\main/n329 ), .IN2(\main/n406 ), .QN(\main/n313 )
         );
  NAND2X0 \main/U21  ( .IN1(\main/n397 ), .IN2(N97), .QN(\main/n385 ) );
  NAND2X0 \main/U20  ( .IN1(\main/n373 ), .IN2(\main/n79 ), .QN(\main/n389 )
         );
  NAND2X0 \main/U19  ( .IN1(\main/n395 ), .IN2(N97), .QN(\main/n290 ) );
  NAND2X0 \main/U18  ( .IN1(\main/n395 ), .IN2(N68), .QN(\main/n344 ) );
  NAND2X0 \main/U17  ( .IN1(\main/n306 ), .IN2(\main/n38 ), .QN(\main/n304 )
         );
  NAND2X0 \main/U16  ( .IN1(\main/n27 ), .IN2(\main/n54 ), .QN(\main/n326 ) );
  NAND2X0 \main/U15  ( .IN1(N87), .IN2(\main/n395 ), .QN(\main/n358 ) );
  NAND2X0 \main/U14  ( .IN1(\main/n398 ), .IN2(N150), .QN(\main/n342 ) );
  NAND2X0 \main/U13  ( .IN1(\main/n394 ), .IN2(N137), .QN(\main/n343 ) );
  NAND2X0 \main/U12  ( .IN1(\main/n211 ), .IN2(N330), .QN(\main/n152 ) );
  NAND2X0 \main/U11  ( .IN1(\main/n394 ), .IN2(N150), .QN(\main/n74 ) );
  ...
  NOR4X0 \perturb/U11  ( .IN1(N159), .IN2(N137), .IN3(N283), .IN4(N45), .QN(
        \perturb/n5 ) );
  NOR4X0 \perturb/U10  ( .IN1(N349), .IN2(N330), .IN3(N250), .IN4(N264), .QN(
        \perturb/n6 ) );
  NOR4X0 \perturb/U9  ( .IN1(N33), .IN2(N270), .IN3(N311), .IN4(N50), .QN(
        \perturb/n7 ) );
  NOR4X0 \perturb/U8  ( .IN1(N200), .IN2(N244), .IN3(N13), .IN4(N257), .QN(
        \perturb/n8 ) );
  OR4X1 \perturb/U7  ( .IN1(\perturb/n4 ), .IN2(\perturb/n3 ), .IN3(
        \perturb/n2 ), .IN4(\perturb/n1 ), .Q(\perturb/n10 ) );
  NAND4X0 \perturb/U6  ( .IN1(N179), .IN2(N274), .IN3(N190), .IN4(N213), .QN(
        \perturb/n1 ) );
  NAND4X0 \perturb/U5  ( .IN1(N150), .IN2(N317), .IN3(N116), .IN4(N41), .QN(
        \perturb/n2 ) );
  OR4X1 \perturb/U4  ( .IN1(N87), .IN2(N58), .IN3(N343), .IN4(N20), .Q(
        \perturb/n3 ) );
  NAND4X0 \perturb/U3  ( .IN1(N1), .IN2(N97), .IN3(N238), .IN4(N303), .QN(
        \perturb/n4 ) );
  ...
  XNOR2X1 \restore/U41  ( .IN1(keyinput30), .IN2(N283), .Q(\restore/n31 ) );
  XNOR2X1 \restore/U40  ( .IN1(keyinput28), .IN2(N45), .Q(\restore/n32 ) );
  XNOR2X1 \restore/U39  ( .IN1(keyinput26), .IN2(N41), .Q(\restore/n33 ) );
  XNOR2X1 \restore/U38  ( .IN1(keyinput24), .IN2(N159), .Q(\restore/n34 ) );
  NAND4X0 \restore/U37  ( .IN1(\restore/n30 ), .IN2(\restore/n29 ), .IN3(
        \restore/n28 ), .IN4(\restore/n27 ), .QN(\restore/n36 ) );
  XNOR2X1 \restore/U36  ( .IN1(keyinput20), .IN2(N257), .Q(\restore/n27 ) );
  XNOR2X1 \restore/U35  ( .IN1(keyinput18), .IN2(N213), .Q(\restore/n28 ) );
  XNOR2X1 \restore/U34  ( .IN1(keyinput16), .IN2(N274), .Q(\restore/n29 ) );
  XNOR2X1 \restore/U33  ( .IN1(keyinput31), .IN2(N137), .Q(\restore/n30 ) );
  NAND4X0 \restore/U32  ( .IN1(\restore/n26 ), .IN2(\restore/n25 ), .IN3(
        \restore/n24 ), .IN4(\restore/n23 ), .QN(\restore/n37 ) );
  XNOR2X1 \restore/U31  ( .IN1(keyinput6), .IN2(N1), .Q(\restore/n23 ) );
  XNOR2X1 \restore/U30  ( .IN1(keyinput8), .IN2(N311), .Q(\restore/n24 ) );
  XNOR2X1 \restore/U29  ( .IN1(keyinput14), .IN2(N200), .Q(\restore/n25 ) );
  XNOR2X1 \restore/U28  ( .IN1(keyinput12), .IN2(N244), .Q(\restore/n26 ) );
  NAND4X0 \restore/U27  ( .IN1(\restore/n22 ), .IN2(\restore/n21 ), .IN3(
        \restore/n20 ), .IN4(\restore/n19 ), .QN(\restore/n38 ) );
  XNOR2X1 \restore/U26  ( .IN1(keyinput22), .IN2(N190), .Q(\restore/n19 ) );
  XNOR2X1 \restore/U25  ( .IN1(keyinput0), .IN2(N50), .Q(\restore/n20 ) );
  XNOR2X1 \restore/U24  ( .IN1(keyinput4), .IN2(N33), .Q(\restore/n21 ) );
  XNOR2X1 \restore/U23  ( .IN1(keyinput2), .IN2(N270), .Q(\restore/n22 ) );
  NAND4X0 \restore/U22  ( .IN1(\restore/n18 ), .IN2(\restore/n17 ), .IN3(
        \restore/n16 ), .IN4(\restore/n15 ), .QN(\restore/n40 ) );
  XNOR2X1 \restore/U21  ( .IN1(keyinput29), .IN2(N116), .Q(\restore/n15 ) );
  XNOR2X1 \restore/U20  ( .IN1(keyinput9), .IN2(N58), .Q(\restore/n16 ) );
  NOR4X0 \restore/U19  ( .IN1(\restore/n14 ), .IN2(\restore/n13 ), .IN3(
        \restore/n12 ), .IN4(\restore/n11 ), .QN(\restore/n17 ) );
  XOR2X1 \restore/U18  ( .IN1(keyinput10), .IN2(N13), .Q(\restore/n11 ) );
  XOR2X1 \restore/U17  ( .IN1(keyinput19), .IN2(N330), .Q(\restore/n12 ) );
  XOR2X1 \restore/U16  ( .IN1(keyinput21), .IN2(N250), .Q(\restore/n13 ) );
  XOR2X1 \restore/U15  ( .IN1(keyinput23), .IN2(N317), .Q(\restore/n14 ) );
  NOR2X0 \restore/U14  ( .IN1(\restore/n10 ), .IN2(\restore/n9 ), .QN(
        \restore/n18 ) );
  XOR2X1 \restore/U13  ( .IN1(keyinput27), .IN2(N349), .Q(\restore/n9 ) );
  XOR2X1 \restore/U12  ( .IN1(keyinput25), .IN2(N150), .Q(\restore/n10 ) );
  NAND4X0 \restore/U11  ( .IN1(\restore/n8 ), .IN2(\restore/n7 ), .IN3(
        \restore/n6 ), .IN4(\restore/n5 ), .QN(\restore/n41 ) );
  XNOR2X1 \restore/U10  ( .IN1(keyinput17), .IN2(N179), .Q(\restore/n5 ) );
  XNOR2X1 \restore/U9  ( .IN1(keyinput5), .IN2(N343), .Q(\restore/n6 ) );
  XNOR2X1 \restore/U8  ( .IN1(keyinput3), .IN2(N20), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput7), .IN2(N303), .Q(\restore/n8 ) );
  NAND4X0 \restore/U6  ( .IN1(\restore/n4 ), .IN2(\restore/n3 ), .IN3(
        \restore/n2 ), .IN4(\restore/n1 ), .QN(\restore/n42 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput1), .IN2(N97), .Q(\restore/n1 ) );
  XNOR2X1 \restore/U4  ( .IN1(keyinput11), .IN2(N238), .Q(\restore/n2 ) );
  XNOR2X1 \restore/U3  ( .IN1(keyinput13), .IN2(N264), .Q(\restore/n3 ) );
