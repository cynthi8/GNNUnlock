...
module c2670_AntiSAT_16_0_top ( N145, N153, N162, N168, N172, N210, N190, N212, 
  ...
  wire   N214_BUFF, N217_BUFF, N160_BUFF, N173_BUFF, N213_BUFF, N190_BUFF,
         ...
         N168_BUFF, N216_BUFF, N175_BUFF, N181_BUFF, flip_signal, \main/n216 ,
  ...
  XOR2X1 \main/U158  ( .IN1(flip_signal), .IN2(N3803), .Q(N3804) );
  ...
  NOR4X0 \flip/U24  ( .IN1(\flip/n21 ), .IN2(\flip/n20 ), .IN3(\flip/n19 ), 
        .IN4(\flip/n18 ), .QN(flip_signal) );
  NAND4X0 \flip/U23  ( .IN1(\flip/n17 ), .IN2(\flip/n16 ), .IN3(\flip/n15 ), 
        .IN4(\flip/n14 ), .QN(\flip/n18 ) );
  XNOR2X1 \flip/U22  ( .IN1(N87), .IN2(keyinput14), .Q(\flip/n14 ) );
  XNOR2X1 \flip/U21  ( .IN1(N81), .IN2(keyinput11), .Q(\flip/n15 ) );
  OA221X1 \flip/U20  ( .IN1(\flip/n13 ), .IN2(keyinput13), .IN3(keyinput15), 
        .IN4(N73), .IN5(\flip/n12 ), .Q(\flip/n16 ) );
  AOI22X1 \flip/U19  ( .IN1(\flip/n13 ), .IN2(keyinput13), .IN3(keyinput15), 
        .IN4(N73), .QN(\flip/n12 ) );
  INVX0 \flip/U18  ( .INP(N55), .ZN(\flip/n13 ) );
  OA221X1 \flip/U17  ( .IN1(N53), .IN2(keyinput9), .IN3(N85), .IN4(keyinput8), 
        .IN5(\flip/n11 ), .Q(\flip/n17 ) );
  AOI22X1 \flip/U16  ( .IN1(N53), .IN2(keyinput9), .IN3(N85), .IN4(keyinput8), 
        .QN(\flip/n11 ) );
  XOR2X1 \flip/U15  ( .IN1(N50), .IN2(keyinput10), .Q(\flip/n19 ) );
  XOR2X1 \flip/U14  ( .IN1(N86), .IN2(keyinput12), .Q(\flip/n20 ) );
  NOR4X0 \flip/U13  ( .IN1(\flip/n10 ), .IN2(\flip/n9 ), .IN3(\flip/n8 ), 
        .IN4(\flip/n7 ), .QN(\flip/n21 ) );
  AO221X1 \flip/U12  ( .IN1(\flip/n6 ), .IN2(keyinput0), .IN3(keyinput3), 
        .IN4(\flip/n5 ), .IN5(\flip/n4 ), .Q(\flip/n7 ) );
  OAI22X1 \flip/U11  ( .IN1(\flip/n6 ), .IN2(keyinput0), .IN3(\flip/n5 ), 
        .IN4(keyinput3), .QN(\flip/n4 ) );
  INVX0 \flip/U10  ( .INP(N81), .ZN(\flip/n5 ) );
  INVX0 \flip/U9  ( .INP(N85), .ZN(\flip/n6 ) );
  AO221X1 \flip/U8  ( .IN1(N73), .IN2(keyinput7), .IN3(keyinput6), .IN4(N87), 
        .IN5(\flip/n3 ), .Q(\flip/n8 ) );
  OAI22X1 \flip/U7  ( .IN1(N73), .IN2(keyinput7), .IN3(N87), .IN4(keyinput6), 
        .QN(\flip/n3 ) );
  AO221X1 \flip/U6  ( .IN1(N55), .IN2(keyinput5), .IN3(keyinput4), .IN4(N86), 
        .IN5(\flip/n2 ), .Q(\flip/n9 ) );
  OAI22X1 \flip/U5  ( .IN1(N55), .IN2(keyinput5), .IN3(N86), .IN4(keyinput4), 
        .QN(\flip/n2 ) );
  AO221X1 \flip/U4  ( .IN1(N53), .IN2(keyinput1), .IN3(keyinput2), .IN4(N50), 
        .IN5(\flip/n1 ), .Q(\flip/n10 ) );
  OAI22X1 \flip/U3  ( .IN1(N53), .IN2(keyinput1), .IN3(N50), .IN4(keyinput2), 
        .QN(\flip/n1 ) );
endmodule
