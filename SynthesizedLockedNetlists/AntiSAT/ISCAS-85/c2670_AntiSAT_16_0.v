...
// Date      : Thu Apr  8 03:26:07 2021
/////////////////////////////////////////////////////////////


module c2670_AntiSAT_16_0_top ( N145, N153, N162, N168, N172, N210, N190, N212, 
  ...
  INVX0 \main/U235  ( .INP(N1028), .ZN(\main/n186 ) );
  NAND2X0 \main/U234  ( .IN1(N231), .IN2(\main/n186 ), .QN(N1029) );
  NAND4X0 \main/U233  ( .IN1(N44), .IN2(N132), .IN3(N82), .IN4(N96), .QN(
        \main/n175 ) );
  NAND4X0 \main/U232  ( .IN1(N69), .IN2(N120), .IN3(N57), .IN4(N108), .QN(
        \main/n176 ) );
  NOR2X0 \main/U231  ( .IN1(\main/n175 ), .IN2(\main/n176 ), .QN(N1277) );
  NAND2X0 \main/U230  ( .IN1(N325), .IN2(\main/n186 ), .QN(N1269) );
  INVX0 \main/U229  ( .INP(N1277), .ZN(N1448) );
  INVX0 \main/U228  ( .INP(N234), .ZN(\main/n185 ) );
  NOR2X0 \main/U227  ( .IN1(\main/n185 ), .IN2(N227), .QN(\main/n97 ) );
  INVX0 \main/U226  ( .INP(N227), .ZN(\main/n179 ) );
  NOR2X0 \main/U225  ( .IN1(\main/n179 ), .IN2(N234), .QN(\main/n98 ) );
  NOR2X0 \main/U224  ( .IN1(\main/n185 ), .IN2(\main/n179 ), .QN(\main/n100 )
         );
  NOR2X0 \main/U223  ( .IN1(N227), .IN2(N234), .QN(\main/n101 ) );
  AO22X1 \main/U222  ( .IN1(N78), .IN2(\main/n100 ), .IN3(N91), .IN4(
        \main/n101 ), .Q(\main/n184 ) );
  AO221X1 \main/U221  ( .IN1(N65), .IN2(\main/n97 ), .IN3(N53), .IN4(
        \main/n98 ), .IN5(\main/n184 ), .Q(N2010) );
  AO22X1 \main/U220  ( .IN1(N77), .IN2(\main/n100 ), .IN3(N90), .IN4(
        \main/n101 ), .Q(\main/n183 ) );
  AO221X1 \main/U219  ( .IN1(N64), .IN2(\main/n97 ), .IN3(N52), .IN4(
        \main/n98 ), .IN5(\main/n183 ), .Q(N2012) );
  AO22X1 \main/U218  ( .IN1(N76), .IN2(\main/n100 ), .IN3(N89), .IN4(
        \main/n101 ), .Q(\main/n182 ) );
  AO221X1 \main/U217  ( .IN1(N63), .IN2(\main/n97 ), .IN3(N51), .IN4(
        \main/n98 ), .IN5(\main/n182 ), .Q(N2014) );
  AO22X1 \main/U216  ( .IN1(N75), .IN2(\main/n100 ), .IN3(N88), .IN4(
        \main/n101 ), .Q(\main/n181 ) );
  AO221X1 \main/U215  ( .IN1(N62), .IN2(\main/n97 ), .IN3(N50), .IN4(
        \main/n98 ), .IN5(\main/n181 ), .Q(N2016) );
  AO21X1 \main/U214  ( .IN1(N49), .IN2(\main/n98 ), .IN3(\main/n97 ), .Q(
        \main/n180 ) );
  AO221X1 \main/U213  ( .IN1(N87), .IN2(\main/n179 ), .IN3(N74), .IN4(N234), 
        .IN5(\main/n180 ), .Q(N2018) );
  AO22X1 \main/U212  ( .IN1(N73), .IN2(\main/n100 ), .IN3(N86), .IN4(
        \main/n101 ), .Q(\main/n178 ) );
  AO221X1 \main/U211  ( .IN1(N61), .IN2(\main/n97 ), .IN3(N48), .IN4(
        \main/n98 ), .IN5(\main/n178 ), .Q(N2020) );
  AO22X1 \main/U210  ( .IN1(N72), .IN2(\main/n100 ), .IN3(N85), .IN4(
        \main/n101 ), .Q(\main/n177 ) );
  AO221X1 \main/U209  ( .IN1(N60), .IN2(\main/n97 ), .IN3(N47), .IN4(
        \main/n98 ), .IN5(\main/n177 ), .Q(N2022) );
  AO22X1 \main/U208  ( .IN1(N325), .IN2(\main/n175 ), .IN3(N231), .IN4(
        \main/n176 ), .Q(\main/n5 ) );
  INVX0 \main/U207  ( .INP(\main/n5 ), .ZN(N1726) );
  INVX0 \main/U206  ( .INP(N322), .ZN(\main/n174 ) );
  INVX0 \main/U205  ( .INP(N319), .ZN(\main/n173 ) );
  NOR2X0 \main/U204  ( .IN1(\main/n174 ), .IN2(\main/n173 ), .QN(\main/n91 )
         );
  NOR2X0 \main/U203  ( .IN1(\main/n174 ), .IN2(N319), .QN(\main/n92 ) );
  NOR2X0 \main/U202  ( .IN1(\main/n173 ), .IN2(N322), .QN(\main/n94 ) );
  NOR2X0 \main/U201  ( .IN1(N319), .IN2(N322), .QN(\main/n95 ) );
  AO22X1 \main/U200  ( .IN1(N101), .IN2(\main/n94 ), .IN3(N137), .IN4(
        \main/n95 ), .Q(\main/n172 ) );
  AOI221X1 \main/U199  ( .IN1(N113), .IN2(\main/n91 ), .IN3(N125), .IN4(
        \main/n92 ), .IN5(\main/n172 ), .QN(N1816) );
  AO22X1 \main/U198  ( .IN1(N100), .IN2(\main/n94 ), .IN3(N136), .IN4(
        \main/n95 ), .Q(\main/n171 ) );
  AOI221X1 \main/U197  ( .IN1(N112), .IN2(\main/n91 ), .IN3(N124), .IN4(
        \main/n92 ), .IN5(\main/n171 ), .QN(N1817) );
  AO22X1 \main/U196  ( .IN1(N102), .IN2(\main/n94 ), .IN3(N138), .IN4(
        \main/n95 ), .Q(\main/n170 ) );
  AO221X1 \main/U195  ( .IN1(N114), .IN2(\main/n91 ), .IN3(N126), .IN4(
        \main/n92 ), .IN5(\main/n170 ), .Q(\main/n56 ) );
  INVX0 \main/U194  ( .INP(\main/n56 ), .ZN(N1818) );
  INVX0 \main/U193  ( .INP(N2016), .ZN(N1819) );
  INVX0 \main/U192  ( .INP(N2014), .ZN(N1820) );
  INVX0 \main/U191  ( .INP(N2012), .ZN(N1821) );
  AO22X1 \main/U190  ( .IN1(N68), .IN2(\main/n100 ), .IN3(N81), .IN4(
        \main/n101 ), .Q(\main/n169 ) );
  AO221X1 \main/U189  ( .IN1(N56), .IN2(\main/n97 ), .IN3(N43), .IN4(
        \main/n98 ), .IN5(\main/n169 ), .Q(\main/n55 ) );
  INVX0 \main/U188  ( .INP(\main/n55 ), .ZN(\main/n81 ) );
  NAND2X0 \main/U187  ( .IN1(N241), .IN2(\main/n81 ), .QN(N1969) );
  NAND3X0 \main/U186  ( .IN1(N1726), .IN2(N237), .IN3(N224), .QN(\main/n167 )
         );
  INVX0 \main/U185  ( .INP(\main/n167 ), .ZN(\main/n168 ) );
  NAND2X0 \main/U184  ( .IN1(N36), .IN2(\main/n168 ), .QN(N1970) );
  AO21X1 \main/U183  ( .IN1(N3), .IN2(N1), .IN3(\main/n167 ), .Q(N1971) );
  AO22X1 \main/U182  ( .IN1(N79), .IN2(\main/n100 ), .IN3(N92), .IN4(
        \main/n101 ), .Q(\main/n166 ) );
  AO221X1 \main/U181  ( .IN1(N66), .IN2(\main/n97 ), .IN3(N54), .IN4(
        \main/n98 ), .IN5(\main/n166 ), .Q(\main/n52 ) );
  MUX21X1 \main/U180  ( .IN1(\main/n52 ), .IN2(N2012), .S(N246), .Q(N2387) );
  MUX21X1 \main/U179  ( .IN1(N2010), .IN2(N2014), .S(N246), .Q(N2389) );
  NOR2X0 \main/U178  ( .IN1(N230), .IN2(\main/n52 ), .QN(\main/n105 ) );
  INVX0 \main/U177  ( .INP(\main/n105 ), .ZN(\main/n79 ) );
  INVX0 \main/U176  ( .INP(N241), .ZN(\main/n103 ) );
  AO21X1 \main/U175  ( .IN1(\main/n79 ), .IN2(\main/n103 ), .IN3(\main/n52 ), 
        .Q(N2496) );
  MUX21X1 \main/U174  ( .IN1(\main/n55 ), .IN2(\main/n79 ), .S(N246), .Q(N2643) );
  AO22X1 \main/U173  ( .IN1(N99), .IN2(\main/n94 ), .IN3(N135), .IN4(
        \main/n95 ), .Q(\main/n165 ) );
  AO221X1 \main/U172  ( .IN1(N111), .IN2(\main/n91 ), .IN3(N123), .IN4(
        \main/n92 ), .IN5(\main/n165 ), .Q(\main/n88 ) );
  XOR2X1 \main/U171  ( .IN1(\main/n88 ), .IN2(N313), .Q(\main/n163 ) );
  ...
  INVX0 \main/U160  ( .INP(N278), .ZN(\main/n47 ) );
  XNOR2X1 \main/U159  ( .IN1(N6), .IN2(\main/n47 ), .Q(\main/n152 ) );
  ...
  INVX0 \main/U152  ( .INP(N269), .ZN(\main/n42 ) );
  XNOR2X1 \main/U151  ( .IN1(\main/n42 ), .IN2(N21), .Q(\main/n150 ) );
  ...
  NOR4X0 \main/U146  ( .IN1(\main/n145 ), .IN2(\main/n146 ), .IN3(\main/n147 ), 
        .IN4(\main/n148 ), .QN(\main/n132 ) );
  XOR2X1 \main/U145  ( .IN1(N2022), .IN2(N281), .Q(\main/n141 ) );
  XNOR2X1 \main/U144  ( .IN1(N2020), .IN2(\main/n47 ), .Q(\main/n142 ) );
  INVX0 \main/U143  ( .INP(N2018), .ZN(\main/n30 ) );
  XNOR2X1 \main/U142  ( .IN1(\main/n30 ), .IN2(N275), .Q(\main/n143 ) );
  XNOR2X1 \main/U141  ( .IN1(N1819), .IN2(N272), .Q(\main/n144 ) );
  NAND4X0 \main/U140  ( .IN1(\main/n141 ), .IN2(\main/n142 ), .IN3(\main/n143 ), .IN4(\main/n144 ), .QN(\main/n134 ) );
  XOR2X1 \main/U139  ( .IN1(\main/n52 ), .IN2(N259), .Q(\main/n138 ) );
  XOR2X1 \main/U138  ( .IN1(N2010), .IN2(N263), .Q(\main/n139 ) );
  XNOR2X1 \main/U137  ( .IN1(\main/n81 ), .IN2(N256), .Q(\main/n140 ) );
  NAND3X0 \main/U136  ( .IN1(\main/n138 ), .IN2(\main/n139 ), .IN3(\main/n140 ), .QN(\main/n135 ) );
  XNOR2X1 \main/U135  ( .IN1(N266), .IN2(N2012), .Q(\main/n136 ) );
  XNOR2X1 \main/U134  ( .IN1(N269), .IN2(N2014), .Q(\main/n137 ) );
  NOR4X0 \main/U133  ( .IN1(\main/n134 ), .IN2(\main/n135 ), .IN3(\main/n136 ), 
        .IN4(\main/n137 ), .QN(\main/n133 ) );
  MUX21X1 \main/U132  ( .IN1(\main/n132 ), .IN2(\main/n133 ), .S(N16), .Q(
        \main/n106 ) );
  INVX0 \main/U131  ( .INP(N287), .ZN(\main/n61 ) );
  XNOR2X1 \main/U130  ( .IN1(N32), .IN2(\main/n61 ), .Q(\main/n128 ) );
  XOR2X1 \main/U129  ( .IN1(N301), .IN2(N27), .Q(\main/n129 ) );
  XOR2X1 \main/U128  ( .IN1(N294), .IN2(N26), .Q(\main/n130 ) );
  XOR2X1 \main/U127  ( .IN1(N284), .IN2(N25), .Q(\main/n131 ) );
  NAND4X0 \main/U126  ( .IN1(\main/n128 ), .IN2(\main/n129 ), .IN3(\main/n130 ), .IN4(\main/n131 ), .QN(\main/n123 ) );
  XOR2X1 \main/U125  ( .IN1(N35), .IN2(N309), .Q(\main/n125 ) );
  XOR2X1 \main/U124  ( .IN1(N34), .IN2(N305), .Q(\main/n126 ) );
  XOR2X1 \main/U123  ( .IN1(N33), .IN2(N297), .Q(\main/n127 ) );
  NAND4X0 \main/U122  ( .IN1(N28), .IN2(\main/n125 ), .IN3(\main/n126 ), .IN4(
        \main/n127 ), .QN(\main/n124 ) );
  NOR2X0 \main/U121  ( .IN1(\main/n123 ), .IN2(\main/n124 ), .QN(\main/n108 )
         );
  AO22X1 \main/U120  ( .IN1(N103), .IN2(\main/n94 ), .IN3(N139), .IN4(
        \main/n95 ), .Q(\main/n122 ) );
  AO221X1 \main/U119  ( .IN1(N115), .IN2(\main/n91 ), .IN3(N127), .IN4(
        \main/n92 ), .IN5(\main/n122 ), .Q(\main/n86 ) );
  XOR2X1 \main/U118  ( .IN1(\main/n86 ), .IN2(N297), .Q(\main/n117 ) );
  AO22X1 \main/U117  ( .IN1(N104), .IN2(\main/n94 ), .IN3(N140), .IN4(
        \main/n95 ), .Q(\main/n121 ) );
  AO221X1 \main/U116  ( .IN1(N116), .IN2(\main/n91 ), .IN3(N128), .IN4(
        \main/n92 ), .IN5(\main/n121 ), .Q(\main/n59 ) );
  XOR2X1 \main/U115  ( .IN1(\main/n59 ), .IN2(N294), .Q(\main/n118 ) );
  AO22X1 \main/U114  ( .IN1(N105), .IN2(\main/n94 ), .IN3(N141), .IN4(
        \main/n95 ), .Q(\main/n120 ) );
  AO221X1 \main/U113  ( .IN1(N117), .IN2(\main/n91 ), .IN3(N129), .IN4(
        \main/n92 ), .IN5(\main/n120 ), .Q(\main/n58 ) );
  INVX0 \main/U112  ( .INP(\main/n58 ), .ZN(\main/n62 ) );
  XNOR2X1 \main/U111  ( .IN1(\main/n62 ), .IN2(N287), .Q(\main/n119 ) );
  NAND4X0 \main/U110  ( .IN1(\main/n117 ), .IN2(\main/n118 ), .IN3(\main/n119 ), .IN4(\main/n88 ), .QN(\main/n110 ) );
  XNOR2X1 \main/U109  ( .IN1(N1816), .IN2(N305), .Q(\main/n112 ) );
  XNOR2X1 \main/U108  ( .IN1(N1817), .IN2(N309), .Q(\main/n113 ) );
  XNOR2X1 \main/U107  ( .IN1(N1818), .IN2(N301), .Q(\main/n114 ) );
  AO22X1 \main/U106  ( .IN1(N95), .IN2(\main/n94 ), .IN3(N131), .IN4(
        \main/n95 ), .Q(\main/n116 ) );
  AO221X1 \main/U105  ( .IN1(N107), .IN2(\main/n91 ), .IN3(N119), .IN4(
        \main/n92 ), .IN5(\main/n116 ), .Q(\main/n13 ) );
  XOR2X1 \main/U104  ( .IN1(\main/n13 ), .IN2(N284), .Q(\main/n115 ) );
  NAND4X0 \main/U103  ( .IN1(\main/n112 ), .IN2(\main/n113 ), .IN3(\main/n114 ), .IN4(\main/n115 ), .QN(\main/n111 ) );
  NOR2X0 \main/U102  ( .IN1(\main/n110 ), .IN2(\main/n111 ), .QN(\main/n109 )
         );
  MUX21X1 \main/U101  ( .IN1(\main/n108 ), .IN2(\main/n109 ), .S(N29), .Q(
        \main/n107 ) );
  NAND3X0 \main/U100  ( .IN1(\main/n106 ), .IN2(N11), .IN3(\main/n107 ), .QN(
        N3079) );
  INVX0 \main/U99  ( .INP(N3079), .ZN(N3038) );
  NOR2X0 \main/U98  ( .IN1(\main/n105 ), .IN2(\main/n52 ), .QN(\main/n104 ) );
  XNOR2X1 \main/U97  ( .IN1(\main/n55 ), .IN2(\main/n104 ), .Q(\main/n102 ) );
  NAND2X0 \main/U96  ( .IN1(\main/n102 ), .IN2(\main/n103 ), .QN(\main/n96 )
         );
  AO22X1 \main/U95  ( .IN1(N80), .IN2(\main/n100 ), .IN3(N93), .IN4(
        \main/n101 ), .Q(\main/n99 ) );
  AO221X1 \main/U94  ( .IN1(N67), .IN2(\main/n97 ), .IN3(N55), .IN4(\main/n98 ), .IN5(\main/n99 ), .Q(\main/n77 ) );
  XNOR2X1 \main/U93  ( .IN1(\main/n96 ), .IN2(\main/n77 ), .Q(N3546) );
  AO22X1 \main/U92  ( .IN1(N106), .IN2(\main/n94 ), .IN3(N142), .IN4(
        \main/n95 ), .Q(\main/n93 ) );
  AO221X1 \main/U91  ( .IN1(N118), .IN2(\main/n91 ), .IN3(N130), .IN4(
        \main/n92 ), .IN5(\main/n93 ), .Q(\main/n90 ) );
  XNOR2X1 \main/U90  ( .IN1(\main/n90 ), .IN2(\main/n13 ), .Q(\main/n89 ) );
  XNOR3X1 \main/U89  ( .IN1(N1817), .IN2(\main/n88 ), .IN3(\main/n89 ), .Q(
        \main/n84 ) );
  XNOR2X1 \main/U88  ( .IN1(\main/n58 ), .IN2(\main/n59 ), .Q(\main/n87 ) );
  XNOR3X1 \main/U87  ( .IN1(N1818), .IN2(\main/n86 ), .IN3(\main/n87 ), .Q(
        \main/n85 ) );
  XNOR3X1 \main/U86  ( .IN1(\main/n84 ), .IN2(\main/n85 ), .IN3(N1816), .Q(
        \main/n83 ) );
  INVX0 \main/U85  ( .INP(N37), .ZN(\main/n69 ) );
  NAND2X0 \main/U84  ( .IN1(\main/n83 ), .IN2(\main/n69 ), .QN(\main/n1 ) );
  INVX0 \main/U83  ( .INP(\main/n1 ), .ZN(N3671) );
  XNOR2X1 \main/U82  ( .IN1(\main/n52 ), .IN2(N2010), .Q(\main/n82 ) );
  XOR3X1 \main/U81  ( .IN1(\main/n81 ), .IN2(\main/n77 ), .IN3(\main/n82 ), 
        .Q(\main/n72 ) );
  XNOR2X1 \main/U80  ( .IN1(N1819), .IN2(\main/n30 ), .Q(\main/n80 ) );
  XOR3X1 \main/U79  ( .IN1(N2022), .IN2(N2020), .IN3(\main/n80 ), .Q(
        \main/n71 ) );
  XNOR3X1 \main/U78  ( .IN1(\main/n72 ), .IN2(\main/n79 ), .IN3(\main/n71 ), 
        .Q(\main/n78 ) );
  MUX21X1 \main/U77  ( .IN1(\main/n77 ), .IN2(\main/n78 ), .S(N246), .Q(N3803)
         );
  XNOR2X1 \main/U76  ( .IN1(N352), .IN2(\main/n61 ), .Q(\main/n76 ) );
  XNOR3X1 \main/U75  ( .IN1(N284), .IN2(\main/n47 ), .IN3(\main/n76 ), .Q(
        \main/n74 ) );
  INVX0 \main/U74  ( .INP(N275), .ZN(\main/n31 ) );
  XNOR3X1 \main/U73  ( .IN1(\main/n31 ), .IN2(N272), .IN3(N263), .Q(\main/n75 ) );
  XNOR3X1 \main/U72  ( .IN1(\main/n74 ), .IN2(\main/n75 ), .IN3(N266), .Q(
        \main/n73 ) );
  XNOR3X1 \main/U71  ( .IN1(N281), .IN2(\main/n42 ), .IN3(\main/n73 ), .Q(
        N2971) );
  XOR2X1 \main/U70  ( .IN1(flip_signal), .IN2(N3803), .Q(N3804) );
  XOR2X1 \main/U69  ( .IN1(\main/n71 ), .IN2(\main/n72 ), .Q(\main/n70 ) );
  ...
  XNOR2X1 \flip/U24  ( .IN1(N50), .IN2(keyinput10), .Q(\flip/n7 ) );
  XOR2X1 \flip/U23  ( .IN1(keyinput8), .IN2(N85), .Q(\flip/n8 ) );
  XOR2X1 \flip/U22  ( .IN1(keyinput4), .IN2(N86), .Q(\flip/n18 ) );
  XOR2X1 \flip/U21  ( .IN1(keyinput5), .IN2(N55), .Q(\flip/n19 ) );
  XOR2X1 \flip/U20  ( .IN1(keyinput1), .IN2(N53), .Q(\flip/n20 ) );
  XOR2X1 \flip/U19  ( .IN1(keyinput2), .IN2(N50), .Q(\flip/n21 ) );
  NAND4X0 \flip/U18  ( .IN1(\flip/n18 ), .IN2(\flip/n19 ), .IN3(\flip/n20 ), 
        .IN4(\flip/n21 ), .QN(\flip/n11 ) );
  XNOR2X1 \flip/U17  ( .IN1(N85), .IN2(keyinput0), .Q(\flip/n14 ) );
  XNOR2X1 \flip/U16  ( .IN1(N81), .IN2(keyinput3), .Q(\flip/n15 ) );
  XOR2X1 \flip/U15  ( .IN1(keyinput6), .IN2(N87), .Q(\flip/n16 ) );
  XOR2X1 \flip/U14  ( .IN1(keyinput7), .IN2(N73), .Q(\flip/n17 ) );
  NAND4X0 \flip/U13  ( .IN1(\flip/n14 ), .IN2(\flip/n15 ), .IN3(\flip/n16 ), 
        .IN4(\flip/n17 ), .QN(\flip/n12 ) );
  XOR2X1 \flip/U12  ( .IN1(keyinput15), .IN2(N73), .Q(\flip/n13 ) );
  OA21X1 \flip/U11  ( .IN1(\flip/n11 ), .IN2(\flip/n12 ), .IN3(\flip/n13 ), 
        .Q(\flip/n9 ) );
  XOR2X1 \flip/U10  ( .IN1(keyinput9), .IN2(N53), .Q(\flip/n10 ) );
  NAND4X0 \flip/U9  ( .IN1(\flip/n7 ), .IN2(\flip/n8 ), .IN3(\flip/n9 ), .IN4(
        \flip/n10 ), .QN(\flip/n1 ) );
  XNOR2X1 \flip/U8  ( .IN1(N87), .IN2(keyinput14), .Q(\flip/n3 ) );
  XNOR2X1 \flip/U7  ( .IN1(N86), .IN2(keyinput12), .Q(\flip/n4 ) );
  XNOR2X1 \flip/U6  ( .IN1(N81), .IN2(keyinput11), .Q(\flip/n5 ) );
  XNOR2X1 \flip/U5  ( .IN1(N55), .IN2(keyinput13), .Q(\flip/n6 ) );
