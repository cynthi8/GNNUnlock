...
module c2670_AntiSAT_32_1_top ( N145, N153, N162, N168, N172, N210, N190, N212, 
  ...
  OA221X1 \flip/U44  ( .IN1(N319), .IN2(keyinput21), .IN3(N22), .IN4(
        keyinput19), .IN5(\flip/n35 ), .Q(\flip/n36 ) );
  AOI22X1 \flip/U43  ( .IN1(N319), .IN2(keyinput21), .IN3(N22), .IN4(
        keyinput19), .QN(\flip/n35 ) );
  OA221X1 \flip/U42  ( .IN1(N129), .IN2(keyinput20), .IN3(N63), .IN4(
        keyinput17), .IN5(\flip/n34 ), .Q(\flip/n37 ) );
  AOI22X1 \flip/U41  ( .IN1(N129), .IN2(keyinput20), .IN3(N63), .IN4(
        keyinput17), .QN(\flip/n34 ) );
  OA221X1 \flip/U40  ( .IN1(N266), .IN2(keyinput31), .IN3(keyinput23), .IN4(
        N113), .IN5(\flip/n33 ), .Q(\flip/n38 ) );
  AOI22X1 \flip/U39  ( .IN1(N266), .IN2(keyinput31), .IN3(keyinput23), .IN4(
        N113), .QN(\flip/n33 ) );
  OA221X1 \flip/U38  ( .IN1(N322), .IN2(keyinput25), .IN3(N91), .IN4(
        keyinput26), .IN5(\flip/n32 ), .Q(\flip/n39 ) );
  AOI22X1 \flip/U37  ( .IN1(N322), .IN2(keyinput25), .IN3(N91), .IN4(
        keyinput26), .QN(\flip/n32 ) );
  NAND4X0 \flip/U36  ( .IN1(\flip/n31 ), .IN2(\flip/n30 ), .IN3(\flip/n29 ), 
        .IN4(\flip/n28 ), .QN(\flip/n41 ) );
  XNOR2X1 \flip/U35  ( .IN1(N123), .IN2(keyinput16), .Q(\flip/n28 ) );
  XNOR2X1 \flip/U34  ( .IN1(N305), .IN2(keyinput30), .Q(\flip/n29 ) );
  XNOR2X1 \flip/U33  ( .IN1(N111), .IN2(keyinput29), .Q(\flip/n30 ) );
  XNOR2X1 \flip/U32  ( .IN1(N33), .IN2(keyinput28), .Q(\flip/n31 ) );
  NAND4X0 \flip/U31  ( .IN1(\flip/n27 ), .IN2(\flip/n26 ), .IN3(\flip/n25 ), 
        .IN4(\flip/n24 ), .QN(\flip/n42 ) );
  XNOR2X1 \flip/U30  ( .IN1(N275), .IN2(keyinput27), .Q(\flip/n24 ) );
  XNOR2X1 \flip/U29  ( .IN1(N246), .IN2(keyinput24), .Q(\flip/n25 ) );
  XNOR2X1 \flip/U28  ( .IN1(N105), .IN2(keyinput22), .Q(\flip/n26 ) );
  XNOR2X1 \flip/U27  ( .IN1(N23), .IN2(keyinput18), .Q(\flip/n27 ) );
  NOR4X0 \flip/U26  ( .IN1(\flip/n23 ), .IN2(\flip/n22 ), .IN3(\flip/n21 ), 
        .IN4(\flip/n20 ), .QN(\flip/n43 ) );
  NAND4X0 \flip/U25  ( .IN1(\flip/n19 ), .IN2(\flip/n18 ), .IN3(\flip/n17 ), 
        .IN4(\flip/n16 ), .QN(\flip/n20 ) );
  OA221X1 \flip/U24  ( .IN1(\flip/n15 ), .IN2(keyinput1), .IN3(\flip/n14 ), 
        .IN4(keyinput5), .IN5(\flip/n13 ), .Q(\flip/n16 ) );
  AOI22X1 \flip/U23  ( .IN1(\flip/n15 ), .IN2(keyinput1), .IN3(\flip/n14 ), 
        .IN4(keyinput5), .QN(\flip/n13 ) );
  INVX0 \flip/U22  ( .INP(N319), .ZN(\flip/n14 ) );
  INVX0 \flip/U21  ( .INP(N63), .ZN(\flip/n15 ) );
  OA221X1 \flip/U20  ( .IN1(\flip/n12 ), .IN2(keyinput3), .IN3(\flip/n11 ), 
        .IN4(keyinput2), .IN5(\flip/n10 ), .Q(\flip/n17 ) );
  AOI22X1 \flip/U19  ( .IN1(\flip/n12 ), .IN2(keyinput3), .IN3(\flip/n11 ), 
        .IN4(keyinput2), .QN(\flip/n10 ) );
  INVX0 \flip/U18  ( .INP(N23), .ZN(\flip/n11 ) );
  INVX0 \flip/U17  ( .INP(N22), .ZN(\flip/n12 ) );
  OA221X1 \flip/U16  ( .IN1(N129), .IN2(keyinput4), .IN3(N105), .IN4(keyinput6), .IN5(\flip/n9 ), .Q(\flip/n18 ) );
  AOI22X1 \flip/U15  ( .IN1(N129), .IN2(keyinput4), .IN3(N105), .IN4(keyinput6), .QN(\flip/n9 ) );
  OA221X1 \flip/U14  ( .IN1(\flip/n8 ), .IN2(keyinput0), .IN3(N275), .IN4(
        keyinput11), .IN5(\flip/n7 ), .Q(\flip/n19 ) );
  AOI22X1 \flip/U13  ( .IN1(\flip/n8 ), .IN2(keyinput0), .IN3(N275), .IN4(
        keyinput11), .QN(\flip/n7 ) );
  INVX0 \flip/U12  ( .INP(N123), .ZN(\flip/n8 ) );
  NAND4X0 \flip/U11  ( .IN1(\flip/n6 ), .IN2(\flip/n5 ), .IN3(\flip/n4 ), 
        .IN4(\flip/n3 ), .QN(\flip/n21 ) );
  XNOR2X1 \flip/U10  ( .IN1(N246), .IN2(keyinput8), .Q(\flip/n3 ) );
  XNOR2X1 \flip/U9  ( .IN1(N91), .IN2(keyinput10), .Q(\flip/n4 ) );
  XNOR2X1 \flip/U8  ( .IN1(N113), .IN2(keyinput7), .Q(\flip/n5 ) );
  XNOR2X1 \flip/U7  ( .IN1(N266), .IN2(keyinput15), .Q(\flip/n6 ) );
  AO221X1 \flip/U6  ( .IN1(N33), .IN2(keyinput12), .IN3(keyinput14), .IN4(N305), .IN5(\flip/n2 ), .Q(\flip/n22 ) );
  OAI22X1 \flip/U5  ( .IN1(N33), .IN2(keyinput12), .IN3(N305), .IN4(keyinput14), .QN(\flip/n2 ) );
  AO221X1 \flip/U4  ( .IN1(N322), .IN2(keyinput9), .IN3(keyinput13), .IN4(N111), .IN5(\flip/n1 ), .Q(\flip/n23 ) );
  OAI22X1 \flip/U3  ( .IN1(N322), .IN2(keyinput9), .IN3(N111), .IN4(keyinput13), .QN(\flip/n1 ) );
endmodule
