...
module c5315_AntiSAT_32_1_top ( N1, N4, N11, N14, N17, N20, N23, N24, N25, N26, 
  ...
  NAND2X0 \main/U490  ( .IN1(N552), .IN2(N562), .QN(\main/n201 ) );
  INVX0 \main/U489  ( .INP(\main/n201 ), .ZN(N1140) );
  ...
  OR3X1 \main/U434  ( .IN1(\main/n193 ), .IN2(\main/n82 ), .IN3(\main/n190 ), 
        .Q(\main/n379 ) );
  ...
  NOR4X0 \main/U431  ( .IN1(\main/n378 ), .IN2(\main/n379 ), .IN3(\main/n188 ), 
  ...
  NOR2X0 \main/U325  ( .IN1(\main/n23 ), .IN2(N619), .QN(\main/n186 ) );
  ...
  AO222X1 \main/U320  ( .IN1(N131), .IN2(\main/n186 ), .IN3(\main/n17 ), .IN4(
  ...
  AO222X1 \main/U315  ( .IN1(N129), .IN2(\main/n186 ), .IN3(\main/n17 ), .IN4(
        \main/n250 ), .IN5(\main/n349 ), .IN6(\main/n15 ), .Q(\main/n218 ) );
  INVX0 \main/U314  ( .INP(\main/n218 ), .ZN(N7363) );
  ...
  AO222X1 \main/U309  ( .IN1(N117), .IN2(\main/n186 ), .IN3(\main/n347 ), 
  ...
  AO222X1 \main/U283  ( .IN1(N52), .IN2(\main/n186 ), .IN3(\main/n17 ), .IN4(
        \main/n251 ), .IN5(\main/n333 ), .IN6(\main/n15 ), .Q(\main/n219 ) );
  INVX0 \main/U282  ( .INP(\main/n219 ), .ZN(N7465) );
  ...
  AO222X1 \main/U279  ( .IN1(\main/n245 ), .IN2(\main/n17 ), .IN3(\main/n329 ), 
        .IN4(\main/n15 ), .IN5(N130), .IN6(\main/n186 ), .Q(\main/n212 ) );
  INVX0 \main/U278  ( .INP(\main/n212 ), .ZN(N7466) );
  AOI21X1 \main/U277  ( .IN1(\main/n111 ), .IN2(N54), .IN3(\main/n108 ), .QN(
        \main/n328 ) );
  XNOR2X1 \main/U276  ( .IN1(\main/n102 ), .IN2(\main/n328 ), .Q(\main/n246 )
         );
  AO222X1 \main/U275  ( .IN1(N119), .IN2(\main/n186 ), .IN3(\main/n246 ), 
        .IN4(\main/n17 ), .IN5(\main/n327 ), .IN6(\main/n15 ), .Q(\main/n215 )
         );
  INVX0 \main/U274  ( .INP(\main/n215 ), .ZN(N7467) );
  ...
  AO222X1 \main/U260  ( .IN1(N122), .IN2(\main/n186 ), .IN3(\main/n274 ), 
        .IN4(\main/n17 ), .IN5(\main/n318 ), .IN6(\main/n15 ), .Q(\main/n221 )
         );
  INVX0 \main/U259  ( .INP(\main/n221 ), .ZN(N7470) );
  NAND2X0 \main/U258  ( .IN1(\main/n39 ), .IN2(\main/n317 ), .QN(\main/n316 )
         );
  XNOR2X1 \main/U257  ( .IN1(\main/n316 ), .IN2(\main/n30 ), .Q(\main/n277 )
         );
  AO222X1 \main/U256  ( .IN1(N128), .IN2(\main/n186 ), .IN3(\main/n277 ), 
        .IN4(\main/n17 ), .IN5(\main/n315 ), .IN6(\main/n15 ), .Q(\main/n210 )
         );
  INVX0 \main/U255  ( .INP(\main/n210 ), .ZN(N7471) );
  OA21X1 \main/U254  ( .IN1(\main/n35 ), .IN2(\main/n314 ), .IN3(\main/n36 ), 
        .Q(\main/n313 ) );
  XOR2X1 \main/U253  ( .IN1(\main/n48 ), .IN2(\main/n313 ), .Q(\main/n276 ) );
  AO222X1 \main/U252  ( .IN1(N127), .IN2(\main/n186 ), .IN3(\main/n276 ), 
        .IN4(\main/n17 ), .IN5(\main/n312 ), .IN6(\main/n15 ), .Q(\main/n213 )
         );
  INVX0 \main/U251  ( .INP(\main/n213 ), .ZN(N7472) );
  NOR2X0 \main/U250  ( .IN1(\main/n273 ), .IN2(\main/n311 ), .QN(\main/n310 )
         );
  XOR2X1 \main/U249  ( .IN1(\main/n35 ), .IN2(\main/n310 ), .Q(\main/n275 ) );
  AO222X1 \main/U248  ( .IN1(N126), .IN2(\main/n186 ), .IN3(\main/n275 ), 
        .IN4(\main/n17 ), .IN5(\main/n309 ), .IN6(\main/n15 ), .Q(\main/n216 )
         );
  INVX0 \main/U247  ( .INP(\main/n216 ), .ZN(N7473) );
  ...
  OA21X1 \main/U227  ( .IN1(\main/n271 ), .IN2(\main/n57 ), .IN3(\main/n58 ), 
        .Q(\main/n197 ) );
  INVX0 \main/U226  ( .INP(\main/n197 ), .ZN(\main/n261 ) );
  ...
  MUX21X1 \main/U223  ( .IN1(\main/n268 ), .IN2(\main/n269 ), .S(\main/n73 ), 
        .Q(\main/n266 ) );
  NAND2X0 \main/U222  ( .IN1(\main/n266 ), .IN2(\main/n267 ), .QN(\main/n191 )
         );
  NAND2X0 \main/U221  ( .IN1(\main/n264 ), .IN2(\main/n265 ), .QN(\main/n70 )
         );
  XOR2X1 \main/U220  ( .IN1(\main/n263 ), .IN2(\main/n70 ), .Q(\main/n198 ) );
  NAND3X0 \main/U219  ( .IN1(\main/n262 ), .IN2(\main/n191 ), .IN3(\main/n198 ), .QN(\main/n259 ) );
  XOR2X1 \main/U218  ( .IN1(\main/n65 ), .IN2(\main/n261 ), .Q(\main/n187 ) );
  AO21X1 \main/U217  ( .IN1(\main/n65 ), .IN2(\main/n73 ), .IN3(\main/n59 ), 
        .Q(\main/n67 ) );
  OA21X1 \main/U216  ( .IN1(\main/n59 ), .IN2(\main/n261 ), .IN3(\main/n67 ), 
        .Q(\main/n260 ) );
  XOR2X1 \main/U215  ( .IN1(\main/n72 ), .IN2(\main/n260 ), .Q(\main/n192 ) );
  NOR4X0 \main/U214  ( .IN1(\main/n258 ), .IN2(\main/n259 ), .IN3(\main/n187 ), 
  ...
  NAND2X0 \main/U210  ( .IN1(\main/n253 ), .IN2(\main/n254 ), .QN(\main/n204 )
         );
  OR4X1 \main/U209  ( .IN1(\main/n204 ), .IN2(\main/n250 ), .IN3(\main/n251 ), 
        .IN4(\main/n252 ), .Q(\main/n243 ) );
  OA21X1 \main/U208  ( .IN1(\main/n133 ), .IN2(\main/n247 ), .IN3(\main/n249 ), 
        .Q(\main/n248 ) );
  XNOR2X1 \main/U207  ( .IN1(\main/n136 ), .IN2(\main/n248 ), .Q(\main/n203 )
         );
  INVX0 \main/U206  ( .INP(N7432), .ZN(\main/n205 ) );
  XNOR2X1 \main/U205  ( .IN1(\main/n247 ), .IN2(\main/n138 ), .Q(\main/n202 )
         );
  OR3X1 \main/U204  ( .IN1(\main/n203 ), .IN2(\main/n205 ), .IN3(\main/n202 ), 
        .Q(\main/n244 ) );
  ...
  AO221X1 \main/U185  ( .IN1(\main/n11 ), .IN2(\main/n221 ), .IN3(\main/n10 ), 
        .IN4(\main/n219 ), .IN5(\main/n234 ), .Q(N7515) );
  AO22X1 \main/U184  ( .IN1(N20), .IN2(\main/n13 ), .IN3(N76), .IN4(\main/n14 ), .Q(\main/n233 ) );
  AO221X1 \main/U183  ( .IN1(\main/n11 ), .IN2(\main/n210 ), .IN3(\main/n10 ), 
        .IN4(\main/n212 ), .IN5(\main/n233 ), .Q(N7516) );
  AO22X1 \main/U182  ( .IN1(N17), .IN2(\main/n13 ), .IN3(N73), .IN4(\main/n14 ), .Q(\main/n232 ) );
  AO221X1 \main/U181  ( .IN1(\main/n11 ), .IN2(\main/n213 ), .IN3(\main/n10 ), 
        .IN4(\main/n215 ), .IN5(\main/n232 ), .Q(N7517) );
  AO22X1 \main/U180  ( .IN1(N70), .IN2(\main/n13 ), .IN3(N67), .IN4(\main/n14 ), .Q(\main/n231 ) );
  AO221X1 \main/U179  ( .IN1(\main/n11 ), .IN2(\main/n216 ), .IN3(\main/n10 ), 
        .IN4(\main/n218 ), .IN5(\main/n231 ), .Q(N7518) );
  AO22X1 \main/U178  ( .IN1(N43), .IN2(\main/n9 ), .IN3(\main/n6 ), .IN4(
        \main/n221 ), .Q(\main/n230 ) );
  AO221X1 \main/U177  ( .IN1(N37), .IN2(\main/n8 ), .IN3(\main/n5 ), .IN4(
        \main/n219 ), .IN5(\main/n230 ), .Q(N7519) );
  AO22X1 \main/U176  ( .IN1(N76), .IN2(\main/n9 ), .IN3(\main/n6 ), .IN4(
        \main/n210 ), .Q(\main/n229 ) );
  AO221X1 \main/U175  ( .IN1(N20), .IN2(\main/n8 ), .IN3(\main/n5 ), .IN4(
        \main/n212 ), .IN5(\main/n229 ), .Q(N7520) );
  AO22X1 \main/U174  ( .IN1(\main/n9 ), .IN2(N73), .IN3(\main/n8 ), .IN4(N17), 
        .Q(\main/n228 ) );
  AOI221X1 \main/U173  ( .IN1(\main/n213 ), .IN2(\main/n6 ), .IN3(\main/n215 ), 
        .IN4(\main/n5 ), .IN5(\main/n228 ), .QN(\main/n227 ) );
  XNOR2X1 \main/U172  ( .IN1(flip_signal), .IN2(\main/n227 ), .Q(N7521) );
  AO22X1 \main/U171  ( .IN1(\main/n5 ), .IN2(\main/n218 ), .IN3(N70), .IN4(
        \main/n8 ), .Q(\main/n226 ) );
  AO221X1 \main/U170  ( .IN1(\main/n6 ), .IN2(\main/n216 ), .IN3(N67), .IN4(
        \main/n9 ), .IN5(\main/n226 ), .Q(N7522) );
  AO22X1 \main/U169  ( .IN1(\main/n170 ), .IN2(\main/n221 ), .IN3(N170), .IN4(
        \main/n173 ), .Q(\main/n225 ) );
  AO221X1 \main/U168  ( .IN1(\main/n171 ), .IN2(\main/n219 ), .IN3(N200), 
        .IN4(\main/n174 ), .IN5(\main/n225 ), .Q(N7600) );
  AO22X1 \main/U167  ( .IN1(N188), .IN2(\main/n174 ), .IN3(\main/n171 ), .IN4(
        \main/n218 ), .Q(\main/n224 ) );
  AO221X1 \main/U166  ( .IN1(N158), .IN2(\main/n173 ), .IN3(\main/n170 ), 
        .IN4(\main/n216 ), .IN5(\main/n224 ), .Q(N7601) );
  AO22X1 \main/U165  ( .IN1(N155), .IN2(\main/n174 ), .IN3(\main/n171 ), .IN4(
        \main/n215 ), .Q(\main/n223 ) );
  AO221X1 \main/U164  ( .IN1(N152), .IN2(\main/n173 ), .IN3(\main/n170 ), 
        .IN4(\main/n213 ), .IN5(\main/n223 ), .Q(N7602) );
  AO22X1 \main/U163  ( .IN1(N149), .IN2(\main/n174 ), .IN3(\main/n171 ), .IN4(
        \main/n212 ), .Q(\main/n222 ) );
  AO221X1 \main/U162  ( .IN1(N146), .IN2(\main/n173 ), .IN3(\main/n170 ), 
        .IN4(\main/n210 ), .IN5(\main/n222 ), .Q(N7603) );
  AO22X1 \main/U161  ( .IN1(\main/n154 ), .IN2(\main/n221 ), .IN3(N170), .IN4(
        \main/n159 ), .Q(\main/n220 ) );
  AO221X1 \main/U160  ( .IN1(\main/n156 ), .IN2(\main/n219 ), .IN3(N200), 
        .IN4(\main/n160 ), .IN5(\main/n220 ), .Q(N7604) );
  AO22X1 \main/U159  ( .IN1(N188), .IN2(\main/n160 ), .IN3(\main/n156 ), .IN4(
        \main/n218 ), .Q(\main/n217 ) );
  AO221X1 \main/U158  ( .IN1(N158), .IN2(\main/n159 ), .IN3(\main/n154 ), 
        .IN4(\main/n216 ), .IN5(\main/n217 ), .Q(N7605) );
  AO22X1 \main/U157  ( .IN1(N155), .IN2(\main/n160 ), .IN3(\main/n156 ), .IN4(
        \main/n215 ), .Q(\main/n214 ) );
  AO221X1 \main/U156  ( .IN1(N152), .IN2(\main/n159 ), .IN3(\main/n154 ), 
        .IN4(\main/n213 ), .IN5(\main/n214 ), .Q(N7606) );
  AO22X1 \main/U155  ( .IN1(N149), .IN2(\main/n160 ), .IN3(\main/n156 ), .IN4(
        \main/n212 ), .Q(\main/n211 ) );
  AO221X1 \main/U154  ( .IN1(N146), .IN2(\main/n159 ), .IN3(\main/n154 ), 
        .IN4(\main/n210 ), .IN5(\main/n211 ), .Q(N7607) );
  ...
  XOR2X1 \flip/U45  ( .IN1(keyinput17), .IN2(N411), .Q(\flip/n17 ) );
  XOR2X1 \flip/U44  ( .IN1(keyinput16), .IN2(N361), .Q(\flip/n18 ) );
  XOR2X1 \flip/U43  ( .IN1(keyinput7), .IN2(N625), .Q(\flip/n39 ) );
  XOR2X1 \flip/U42  ( .IN1(keyinput1), .IN2(N411), .Q(\flip/n40 ) );
  XOR2X1 \flip/U41  ( .IN1(keyinput3), .IN2(N366), .Q(\flip/n41 ) );
  XOR2X1 \flip/U40  ( .IN1(keyinput0), .IN2(N361), .Q(\flip/n42 ) );
  NAND4X0 \flip/U39  ( .IN1(\flip/n39 ), .IN2(\flip/n40 ), .IN3(\flip/n41 ), 
        .IN4(\flip/n42 ), .QN(\flip/n23 ) );
  XOR2X1 \flip/U38  ( .IN1(keyinput14), .IN2(N613), .Q(\flip/n35 ) );
  XOR2X1 \flip/U37  ( .IN1(keyinput9), .IN2(N54), .Q(\flip/n36 ) );
  XOR2X1 \flip/U36  ( .IN1(keyinput13), .IN2(N281), .Q(\flip/n37 ) );
  XOR2X1 \flip/U35  ( .IN1(keyinput11), .IN2(N272), .Q(\flip/n38 ) );
  NAND4X0 \flip/U34  ( .IN1(\flip/n35 ), .IN2(\flip/n36 ), .IN3(\flip/n37 ), 
        .IN4(\flip/n38 ), .QN(\flip/n24 ) );
  XNOR2X1 \flip/U33  ( .IN1(N4), .IN2(keyinput5), .Q(\flip/n31 ) );
  XNOR2X1 \flip/U32  ( .IN1(N280), .IN2(keyinput2), .Q(\flip/n32 ) );
  XNOR2X1 \flip/U31  ( .IN1(N273), .IN2(keyinput4), .Q(\flip/n33 ) );
  XOR2X1 \flip/U30  ( .IN1(keyinput15), .IN2(N523), .Q(\flip/n34 ) );
  NAND4X0 \flip/U29  ( .IN1(\flip/n31 ), .IN2(\flip/n32 ), .IN3(\flip/n33 ), 
        .IN4(\flip/n34 ), .QN(\flip/n25 ) );
  XNOR2X1 \flip/U28  ( .IN1(N616), .IN2(keyinput8), .Q(\flip/n27 ) );
  XNOR2X1 \flip/U27  ( .IN1(N400), .IN2(keyinput12), .Q(\flip/n28 ) );
  XNOR2X1 \flip/U26  ( .IN1(N351), .IN2(keyinput10), .Q(\flip/n29 ) );
  XNOR2X1 \flip/U25  ( .IN1(N335), .IN2(keyinput6), .Q(\flip/n30 ) );
  ...
  XNOR2X1 \flip/U22  ( .IN1(N335), .IN2(keyinput22), .Q(\flip/n22 ) );
  NOR2X0 \flip/U21  ( .IN1(\flip/n21 ), .IN2(\flip/n22 ), .QN(\flip/n19 ) );
  XOR2X1 \flip/U20  ( .IN1(keyinput20), .IN2(N273), .Q(\flip/n20 ) );
  NAND4X0 \flip/U19  ( .IN1(\flip/n17 ), .IN2(\flip/n18 ), .IN3(\flip/n19 ), 
        .IN4(\flip/n20 ), .QN(\flip/n1 ) );
  XOR2X1 \flip/U18  ( .IN1(keyinput23), .IN2(N625), .Q(\flip/n13 ) );
  XOR2X1 \flip/U17  ( .IN1(keyinput24), .IN2(N616), .Q(\flip/n14 ) );
  XOR2X1 \flip/U16  ( .IN1(keyinput26), .IN2(N351), .Q(\flip/n15 ) );
  XOR2X1 \flip/U15  ( .IN1(keyinput27), .IN2(N272), .Q(\flip/n16 ) );
  NAND4X0 \flip/U14  ( .IN1(\flip/n13 ), .IN2(\flip/n14 ), .IN3(\flip/n15 ), 
        .IN4(\flip/n16 ), .QN(\flip/n2 ) );
  XNOR2X1 \flip/U13  ( .IN1(N366), .IN2(keyinput19), .Q(\flip/n9 ) );
  XNOR2X1 \flip/U12  ( .IN1(N280), .IN2(keyinput18), .Q(\flip/n10 ) );
  XOR2X1 \flip/U11  ( .IN1(keyinput30), .IN2(N613), .Q(\flip/n11 ) );
  XOR2X1 \flip/U10  ( .IN1(keyinput31), .IN2(N523), .Q(\flip/n12 ) );
  NAND4X0 \flip/U9  ( .IN1(\flip/n9 ), .IN2(\flip/n10 ), .IN3(\flip/n11 ), 
        .IN4(\flip/n12 ), .QN(\flip/n3 ) );
  XNOR2X1 \flip/U8  ( .IN1(N54), .IN2(keyinput25), .Q(\flip/n5 ) );
  XNOR2X1 \flip/U7  ( .IN1(N400), .IN2(keyinput28), .Q(\flip/n6 ) );
  XNOR2X1 \flip/U6  ( .IN1(N4), .IN2(keyinput21), .Q(\flip/n7 ) );
  XNOR2X1 \flip/U5  ( .IN1(N281), .IN2(keyinput29), .Q(\flip/n8 ) );
