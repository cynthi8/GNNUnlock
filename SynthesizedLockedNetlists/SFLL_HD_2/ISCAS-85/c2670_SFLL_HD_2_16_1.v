...
module c2670_SFLL_HD_2_16_1_top ( N145, N153, N162, N168, N172, N210, N190, 
  ...
  NOR2X0 \main/U232  ( .IN1(\main/n190 ), .IN2(N227), .QN(\main/n112 ) );
  INVX0 \main/U231  ( .INP(N227), .ZN(\main/n184 ) );
  NOR2X0 \main/U230  ( .IN1(\main/n184 ), .IN2(N234), .QN(\main/n113 ) );
  NOR2X0 \main/U229  ( .IN1(\main/n190 ), .IN2(\main/n184 ), .QN(\main/n115 )
         );
  NOR2X0 \main/U228  ( .IN1(N227), .IN2(N234), .QN(\main/n116 ) );
  AO22X1 \main/U227  ( .IN1(N78), .IN2(\main/n115 ), .IN3(N91), .IN4(
        \main/n116 ), .Q(\main/n189 ) );
  AO221X1 \main/U226  ( .IN1(N65), .IN2(\main/n112 ), .IN3(N53), .IN4(
        \main/n113 ), .IN5(\main/n189 ), .Q(N2010) );
  AO22X1 \main/U225  ( .IN1(N77), .IN2(\main/n115 ), .IN3(N90), .IN4(
        \main/n116 ), .Q(\main/n188 ) );
  AO221X1 \main/U224  ( .IN1(N64), .IN2(\main/n112 ), .IN3(N52), .IN4(
        \main/n113 ), .IN5(\main/n188 ), .Q(N2012) );
  AO22X1 \main/U223  ( .IN1(N76), .IN2(\main/n115 ), .IN3(N89), .IN4(
        \main/n116 ), .Q(\main/n187 ) );
  AO221X1 \main/U222  ( .IN1(N63), .IN2(\main/n112 ), .IN3(N51), .IN4(
        \main/n113 ), .IN5(\main/n187 ), .Q(N2014) );
  AO22X1 \main/U221  ( .IN1(N75), .IN2(\main/n115 ), .IN3(N88), .IN4(
        \main/n116 ), .Q(\main/n186 ) );
  AO221X1 \main/U220  ( .IN1(N62), .IN2(\main/n112 ), .IN3(N50), .IN4(
        \main/n113 ), .IN5(\main/n186 ), .Q(N2016) );
  AO21X1 \main/U219  ( .IN1(N49), .IN2(\main/n113 ), .IN3(\main/n112 ), .Q(
        \main/n185 ) );
  AO221X1 \main/U218  ( .IN1(N87), .IN2(\main/n184 ), .IN3(N74), .IN4(N234), 
        .IN5(\main/n185 ), .Q(N2018) );
  AO22X1 \main/U217  ( .IN1(N73), .IN2(\main/n115 ), .IN3(N86), .IN4(
        \main/n116 ), .Q(\main/n183 ) );
  AO221X1 \main/U216  ( .IN1(N61), .IN2(\main/n112 ), .IN3(N48), .IN4(
        \main/n113 ), .IN5(\main/n183 ), .Q(N2020) );
  AO22X1 \main/U215  ( .IN1(N72), .IN2(\main/n115 ), .IN3(N85), .IN4(
        \main/n116 ), .Q(\main/n182 ) );
  AO221X1 \main/U214  ( .IN1(N60), .IN2(\main/n112 ), .IN3(N47), .IN4(
        \main/n113 ), .IN5(\main/n182 ), .Q(N2022) );
  AO22X1 \main/U213  ( .IN1(N68), .IN2(\main/n115 ), .IN3(N81), .IN4(
        \main/n116 ), .Q(\main/n181 ) );
  AO221X1 \main/U212  ( .IN1(N56), .IN2(\main/n112 ), .IN3(N43), .IN4(
        \main/n113 ), .IN5(\main/n181 ), .Q(\main/n110 ) );
  INVX0 \main/U211  ( .INP(\main/n110 ), .ZN(\main/n86 ) );
  NAND2X0 \main/U210  ( .IN1(N241), .IN2(\main/n86 ), .QN(N1969) );
  ...
  AO22X1 \main/U203  ( .IN1(N79), .IN2(\main/n115 ), .IN3(N92), .IN4(
        \main/n116 ), .Q(\main/n176 ) );
  AO221X1 \main/U202  ( .IN1(N66), .IN2(\main/n112 ), .IN3(N54), .IN4(
        \main/n113 ), .IN5(\main/n176 ), .Q(\main/n105 ) );
  MUX21X1 \main/U201  ( .IN1(\main/n105 ), .IN2(N2012), .S(N246), .Q(N2387) );
  MUX21X1 \main/U200  ( .IN1(N2010), .IN2(N2014), .S(N246), .Q(N2389) );
  NOR2X0 \main/U199  ( .IN1(N230), .IN2(\main/n105 ), .QN(\main/n102 ) );
  INVX0 \main/U198  ( .INP(\main/n102 ), .ZN(\main/n175 ) );
  INVX0 \main/U197  ( .INP(N241), .ZN(\main/n109 ) );
  AO21X1 \main/U196  ( .IN1(\main/n175 ), .IN2(\main/n109 ), .IN3(\main/n105 ), 
        .Q(N2496) );
  MUX21X1 \main/U195  ( .IN1(\main/n110 ), .IN2(\main/n175 ), .S(N246), .Q(
        N2643) );
  INVX0 \main/U194  ( .INP(N322), .ZN(\main/n174 ) );
  INVX0 \main/U193  ( .INP(N319), .ZN(\main/n173 ) );
  NOR2X0 \main/U192  ( .IN1(\main/n174 ), .IN2(\main/n173 ), .QN(\main/n25 )
         );
  NOR2X0 \main/U191  ( .IN1(\main/n174 ), .IN2(N319), .QN(\main/n26 ) );
  NOR2X0 \main/U190  ( .IN1(\main/n173 ), .IN2(N322), .QN(\main/n28 ) );
  NOR2X0 \main/U189  ( .IN1(N319), .IN2(N322), .QN(\main/n29 ) );
  AO22X1 \main/U188  ( .IN1(N99), .IN2(\main/n28 ), .IN3(N135), .IN4(
        \main/n29 ), .Q(\main/n172 ) );
  AO221X1 \main/U187  ( .IN1(N111), .IN2(\main/n25 ), .IN3(N123), .IN4(
        \main/n26 ), .IN5(\main/n172 ), .Q(\main/n33 ) );
  XOR2X1 \main/U186  ( .IN1(\main/n33 ), .IN2(N313), .Q(\main/n170 ) );
  ...
  INVX0 \main/U177  ( .INP(N269), .ZN(\main/n68 ) );
  XNOR2X1 \main/U176  ( .IN1(\main/n68 ), .IN2(N21), .Q(\main/n164 ) );
  ...
  INVX0 \main/U168  ( .INP(N2018), .ZN(\main/n56 ) );
  XNOR2X1 \main/U167  ( .IN1(\main/n56 ), .IN2(N275), .Q(\main/n157 ) );
  ...
  INVX0 \main/U163  ( .INP(\main/n105 ), .ZN(\main/n82 ) );
  XNOR2X1 \main/U162  ( .IN1(\main/n82 ), .IN2(N259), .Q(\main/n152 ) );
  INVX0 \main/U161  ( .INP(N2010), .ZN(\main/n75 ) );
  XNOR2X1 \main/U160  ( .IN1(\main/n75 ), .IN2(N263), .Q(\main/n153 ) );
  XNOR2X1 \main/U159  ( .IN1(\main/n86 ), .IN2(N256), .Q(\main/n154 ) );
  ...
  AO22X1 \main/U143  ( .IN1(N102), .IN2(\main/n28 ), .IN3(N138), .IN4(
        \main/n29 ), .Q(\main/n136 ) );
  AO221X1 \main/U142  ( .IN1(N114), .IN2(\main/n25 ), .IN3(N126), .IN4(
        \main/n26 ), .IN5(\main/n136 ), .Q(\main/n24 ) );
  INVX0 \main/U141  ( .INP(\main/n24 ), .ZN(N1818) );
  XNOR2X1 \main/U140  ( .IN1(N1818), .IN2(N301), .Q(\main/n131 ) );
  AO22X1 \main/U139  ( .IN1(N104), .IN2(\main/n28 ), .IN3(N140), .IN4(
        \main/n29 ), .Q(\main/n135 ) );
  AO221X1 \main/U138  ( .IN1(N116), .IN2(\main/n25 ), .IN3(N128), .IN4(
        \main/n26 ), .IN5(\main/n135 ), .Q(\main/n23 ) );
  XOR2X1 \main/U137  ( .IN1(\main/n23 ), .IN2(N294), .Q(\main/n132 ) );
  AO22X1 \main/U136  ( .IN1(N105), .IN2(\main/n28 ), .IN3(N141), .IN4(
        \main/n29 ), .Q(\main/n134 ) );
  AO221X1 \main/U135  ( .IN1(N117), .IN2(\main/n25 ), .IN3(N129), .IN4(
        \main/n26 ), .IN5(\main/n134 ), .Q(\main/n20 ) );
  XOR2X1 \main/U134  ( .IN1(\main/n20 ), .IN2(N287), .Q(\main/n133 ) );
  NAND4X0 \main/U133  ( .IN1(\main/n131 ), .IN2(\main/n132 ), .IN3(\main/n133 ), .IN4(\main/n33 ), .QN(\main/n121 ) );
  AO22X1 \main/U132  ( .IN1(N95), .IN2(\main/n28 ), .IN3(N131), .IN4(
        \main/n29 ), .Q(\main/n130 ) );
  AO221X1 \main/U131  ( .IN1(N107), .IN2(\main/n25 ), .IN3(N119), .IN4(
        \main/n26 ), .IN5(\main/n130 ), .Q(\main/n32 ) );
  XOR2X1 \main/U130  ( .IN1(\main/n32 ), .IN2(N284), .Q(\main/n123 ) );
  AO22X1 \main/U129  ( .IN1(N103), .IN2(\main/n28 ), .IN3(N139), .IN4(
        \main/n29 ), .Q(\main/n129 ) );
  AO221X1 \main/U128  ( .IN1(N115), .IN2(\main/n25 ), .IN3(N127), .IN4(
        \main/n26 ), .IN5(\main/n129 ), .Q(\main/n30 ) );
  XOR2X1 \main/U127  ( .IN1(\main/n30 ), .IN2(N297), .Q(\main/n124 ) );
  AO22X1 \main/U126  ( .IN1(N100), .IN2(\main/n28 ), .IN3(N136), .IN4(
        \main/n29 ), .Q(\main/n128 ) );
  AOI221X1 \main/U125  ( .IN1(N112), .IN2(\main/n25 ), .IN3(N124), .IN4(
        \main/n26 ), .IN5(\main/n128 ), .QN(N1817) );
  XNOR2X1 \main/U124  ( .IN1(N1817), .IN2(N309), .Q(\main/n125 ) );
  AO22X1 \main/U123  ( .IN1(N101), .IN2(\main/n28 ), .IN3(N137), .IN4(
        \main/n29 ), .Q(\main/n127 ) );
  AOI221X1 \main/U122  ( .IN1(N113), .IN2(\main/n25 ), .IN3(N125), .IN4(
  ...
  XOR2X1 \main/U115  ( .IN1(restore_signal), .IN2(perturb_signal), .Q(
        \main/n106 ) );
  AO22X1 \main/U114  ( .IN1(N80), .IN2(\main/n115 ), .IN3(N93), .IN4(
        \main/n116 ), .Q(\main/n114 ) );
  AO221X1 \main/U113  ( .IN1(N67), .IN2(\main/n112 ), .IN3(N55), .IN4(
        \main/n113 ), .IN5(\main/n114 ), .Q(\main/n100 ) );
  NOR2X0 \main/U112  ( .IN1(\main/n102 ), .IN2(\main/n105 ), .QN(\main/n111 )
         );
  XNOR2X1 \main/U111  ( .IN1(\main/n110 ), .IN2(\main/n111 ), .Q(\main/n108 )
         );
  NAND2X0 \main/U110  ( .IN1(\main/n108 ), .IN2(\main/n109 ), .QN(\main/n107 )
         );
  XNOR3X1 \main/U109  ( .IN1(\main/n106 ), .IN2(\main/n100 ), .IN3(\main/n107 ), .Q(N3546) );
  ...
  INVX0 \perturb/U43  ( .INP(N56), .ZN(\perturb/n40 ) );
  XNOR2X1 \perturb/U42  ( .IN1(\perturb/n40 ), .IN2(N66), .Q(\perturb/n37 ) );
  OA22X1 \perturb/U41  ( .IN1(\perturb/n40 ), .IN2(N66), .IN3(\perturb/n37 ), 
        .IN4(N93), .Q(\perturb/n27 ) );
  INVX0 \perturb/U40  ( .INP(\perturb/n27 ), .ZN(\perturb/n20 ) );
  INVX0 \perturb/U39  ( .INP(N43), .ZN(\perturb/n39 ) );
  XNOR2X1 \perturb/U38  ( .IN1(N55), .IN2(N79), .Q(\perturb/n38 ) );
  OA22X1 \perturb/U37  ( .IN1(N55), .IN2(N79), .IN3(\perturb/n39 ), .IN4(
        \perturb/n38 ), .Q(\perturb/n28 ) );
  INVX0 \perturb/U36  ( .INP(\perturb/n28 ), .ZN(\perturb/n21 ) );
  XNOR2X1 \perturb/U35  ( .IN1(N43), .IN2(\perturb/n38 ), .Q(\perturb/n35 ) );
  XOR2X1 \perturb/U34  ( .IN1(N93), .IN2(\perturb/n37 ), .Q(\perturb/n34 ) );
  OR2X1 \perturb/U33  ( .IN1(\perturb/n34 ), .IN2(\perturb/n35 ), .Q(
        \perturb/n36 ) );
  AO22X1 \perturb/U32  ( .IN1(\perturb/n35 ), .IN2(\perturb/n34 ), .IN3(N92), 
        .IN4(\perturb/n36 ), .Q(\perturb/n26 ) );
  NOR3X0 \perturb/U31  ( .IN1(\perturb/n26 ), .IN2(\perturb/n21 ), .IN3(
        \perturb/n20 ), .QN(\perturb/n16 ) );
  XOR3X1 \perturb/U30  ( .IN1(\perturb/n34 ), .IN2(N92), .IN3(\perturb/n35 ), 
        .Q(\perturb/n7 ) );
  XOR3X1 \perturb/U29  ( .IN1(N67), .IN2(N54), .IN3(N234), .Q(\perturb/n5 ) );
  NAND2X0 \perturb/U28  ( .IN1(\perturb/n7 ), .IN2(\perturb/n5 ), .QN(
        \perturb/n17 ) );
  NAND2X0 \perturb/U27  ( .IN1(\perturb/n16 ), .IN2(\perturb/n17 ), .QN(
        \perturb/n22 ) );
  OR2X1 \perturb/U26  ( .IN1(N54), .IN2(N234), .Q(\perturb/n33 ) );
  AO22X1 \perturb/U25  ( .IN1(N234), .IN2(N54), .IN3(N67), .IN4(\perturb/n33 ), 
        .Q(\perturb/n15 ) );
  INVX0 \perturb/U24  ( .INP(N227), .ZN(\perturb/n29 ) );
  XNOR3X1 \perturb/U23  ( .IN1(N80), .IN2(N68), .IN3(\perturb/n29 ), .Q(
        \perturb/n18 ) );
  XNOR2X1 \perturb/U22  ( .IN1(N230), .IN2(N241), .Q(\perturb/n32 ) );
  XNOR2X1 \perturb/U21  ( .IN1(N81), .IN2(\perturb/n32 ), .Q(\perturb/n19 ) );
  NOR2X0 \perturb/U20  ( .IN1(\perturb/n18 ), .IN2(\perturb/n19 ), .QN(
        \perturb/n11 ) );
  INVX0 \perturb/U19  ( .INP(N241), .ZN(\perturb/n31 ) );
  AO22X1 \perturb/U18  ( .IN1(N230), .IN2(\perturb/n31 ), .IN3(N81), .IN4(
        \perturb/n32 ), .Q(\perturb/n10 ) );
  OR2X1 \perturb/U17  ( .IN1(\perturb/n10 ), .IN2(\perturb/n11 ), .Q(
        \perturb/n24 ) );
  OR2X1 \perturb/U16  ( .IN1(\perturb/n29 ), .IN2(N68), .Q(\perturb/n30 ) );
  AO22X1 \perturb/U15  ( .IN1(N68), .IN2(\perturb/n29 ), .IN3(N80), .IN4(
  ...
  XOR2X1 \restore/U53  ( .IN1(keyinput11), .IN2(N66), .Q(\restore/n49 ) );
  XOR2X1 \restore/U52  ( .IN1(keyinput10), .IN2(N56), .Q(\restore/n50 ) );
  XOR2X1 \restore/U51  ( .IN1(keyinput12), .IN2(N93), .Q(\restore/n45 ) );
  ...
  XOR2X1 \restore/U48  ( .IN1(keyinput14), .IN2(N79), .Q(\restore/n47 ) );
  XOR2X1 \restore/U47  ( .IN1(keyinput13), .IN2(N55), .Q(\restore/n48 ) );
  XOR2X1 \restore/U46  ( .IN1(keyinput15), .IN2(N43), .Q(\restore/n43 ) );
  ...
  XOR2X1 \restore/U43  ( .IN1(\restore/n45 ), .IN2(\restore/n46 ), .Q(
        \restore/n39 ) );
  XOR2X1 \restore/U42  ( .IN1(keyinput0), .IN2(N92), .Q(\restore/n40 ) );
  ...
  XOR2X1 \restore/U36  ( .IN1(keyinput1), .IN2(N67), .Q(\restore/n35 ) );
  XOR2X1 \restore/U35  ( .IN1(keyinput3), .IN2(N234), .Q(\restore/n36 ) );
  ...
  XOR2X1 \restore/U28  ( .IN1(keyinput9), .IN2(N81), .Q(\restore/n34 ) );
  XOR2X1 \restore/U27  ( .IN1(keyinput8), .IN2(N230), .Q(\restore/n31 ) );
  XOR2X1 \restore/U26  ( .IN1(keyinput7), .IN2(N241), .Q(\restore/n32 ) );
  XOR2X1 \restore/U25  ( .IN1(\restore/n31 ), .IN2(\restore/n32 ), .Q(
        \restore/n33 ) );
  XOR2X1 \restore/U24  ( .IN1(\restore/n34 ), .IN2(\restore/n33 ), .Q(
        \restore/n17 ) );
  XNOR2X1 \restore/U23  ( .IN1(keyinput6), .IN2(N68), .Q(\restore/n30 ) );
  INVX0 \restore/U22  ( .INP(\restore/n30 ), .ZN(\restore/n25 ) );
  XNOR2X1 \restore/U21  ( .IN1(keyinput4), .IN2(N80), .Q(\restore/n29 ) );
  XOR2X1 \restore/U20  ( .IN1(keyinput5), .IN2(N227), .Q(\restore/n27 ) );
