...
module c5315_SFLL_HD_2_8_1_top ( N1, N4, N11, N14, N17, N20, N23, N24, N25, 
  ...
  XOR2X1 \perturb/U18  ( .IN1(N4), .IN2(N625), .Q(\perturb/n15 ) );
  AOI22X1 \perturb/U17  ( .IN1(N4), .IN2(N625), .IN3(N596), .IN4(\perturb/n15 ), .QN(\perturb/n1 ) );
  XOR2X1 \perturb/U16  ( .IN1(N351), .IN2(N607), .Q(\perturb/n8 ) );
  XOR2X1 \perturb/U15  ( .IN1(N596), .IN2(\perturb/n15 ), .Q(\perturb/n7 ) );
  AOI22X1 \perturb/U14  ( .IN1(N351), .IN2(N607), .IN3(\perturb/n8 ), .IN4(
        \perturb/n7 ), .QN(\perturb/n2 ) );
  XOR2X1 \perturb/U13  ( .IN1(N225), .IN2(N595), .Q(\perturb/n14 ) );
  XOR2X1 \perturb/U12  ( .IN1(N217), .IN2(\perturb/n14 ), .Q(\perturb/n9 ) );
  INVX0 \perturb/U11  ( .INP(\perturb/n9 ), .ZN(\perturb/n12 ) );
  AOI22X1 \perturb/U10  ( .IN1(N225), .IN2(N595), .IN3(N217), .IN4(
  ...
  XOR2X1 \restore/U25  ( .IN1(keyinput6), .IN2(N351), .Q(\restore/n21 ) );
  XOR2X1 \restore/U24  ( .IN1(keyinput5), .IN2(N217), .Q(\restore/n22 ) );
  XOR2X1 \restore/U23  ( .IN1(keyinput7), .IN2(N607), .Q(\restore/n19 ) );
  ...
  XOR2X1 \restore/U18  ( .IN1(\restore/n17 ), .IN2(\restore/n18 ), .Q(
        \restore/n16 ) );
  XOR2X1 \restore/U17  ( .IN1(keyinput1), .IN2(N225), .Q(\restore/n15 ) );
  AOI22X1 \restore/U16  ( .IN1(\restore/n17 ), .IN2(\restore/n18 ), .IN3(
        \restore/n16 ), .IN4(\restore/n15 ), .QN(\restore/n2 ) );
  XNOR2X1 \restore/U15  ( .IN1(keyinput4), .IN2(N595), .Q(\restore/n12 ) );
  XNOR2X1 \restore/U14  ( .IN1(keyinput3), .IN2(N596), .Q(\restore/n14 ) );
