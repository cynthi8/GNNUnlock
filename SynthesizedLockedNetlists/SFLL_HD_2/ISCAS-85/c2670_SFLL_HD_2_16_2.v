...
module c2670_SFLL_HD_2_16_2_top ( N145, N153, N162, N168, N172, N210, N190, 
  ...
  MUX21X1 \main/U105  ( .IN1(\main/n101 ), .IN2(\main/n102 ), .S(N246), .Q(
        \main/n96 ) );
  INVX0 \main/U104  ( .INP(\main/n96 ), .ZN(N3804) );
  ...
  INVX0 \perturb/U42  ( .INP(N227), .ZN(\perturb/n39 ) );
  XOR2X1 \perturb/U41  ( .IN1(N227), .IN2(N62), .Q(\perturb/n37 ) );
  OAI22X1 \perturb/U40  ( .IN1(\perturb/n39 ), .IN2(N62), .IN3(\perturb/n37 ), 
        .IN4(N49), .QN(\perturb/n20 ) );
  XOR2X1 \perturb/U39  ( .IN1(N55), .IN2(N73), .Q(\perturb/n38 ) );
  AO22X1 \perturb/U38  ( .IN1(N55), .IN2(N73), .IN3(N85), .IN4(\perturb/n38 ), 
        .Q(\perturb/n21 ) );
  XOR2X1 \perturb/U37  ( .IN1(N85), .IN2(\perturb/n38 ), .Q(\perturb/n35 ) );
  XOR2X1 \perturb/U36  ( .IN1(N49), .IN2(\perturb/n37 ), .Q(\perturb/n34 ) );
  OR2X1 \perturb/U35  ( .IN1(\perturb/n34 ), .IN2(\perturb/n35 ), .Q(
        \perturb/n36 ) );
  AO22X1 \perturb/U34  ( .IN1(\perturb/n35 ), .IN2(\perturb/n34 ), .IN3(N66), 
        .IN4(\perturb/n36 ), .Q(\perturb/n27 ) );
  NOR3X0 \perturb/U33  ( .IN1(\perturb/n27 ), .IN2(\perturb/n21 ), .IN3(
        \perturb/n20 ), .QN(\perturb/n15 ) );
  XNOR3X1 \perturb/U32  ( .IN1(\perturb/n34 ), .IN2(N66), .IN3(\perturb/n35 ), 
        .Q(\perturb/n7 ) );
  XNOR3X1 \perturb/U31  ( .IN1(N88), .IN2(N72), .IN3(N246), .Q(\perturb/n5 )
         );
  NOR2X0 \perturb/U30  ( .IN1(\perturb/n7 ), .IN2(\perturb/n5 ), .QN(
        \perturb/n13 ) );
  INVX0 \perturb/U29  ( .INP(\perturb/n13 ), .ZN(\perturb/n17 ) );
  NAND2X0 \perturb/U28  ( .IN1(\perturb/n15 ), .IN2(\perturb/n17 ), .QN(
        \perturb/n22 ) );
  INVX0 \perturb/U27  ( .INP(N72), .ZN(\perturb/n32 ) );
  AND2X1 \perturb/U26  ( .IN1(N246), .IN2(\perturb/n32 ), .Q(\perturb/n33 ) );
  OA22X1 \perturb/U25  ( .IN1(\perturb/n32 ), .IN2(N246), .IN3(\perturb/n33 ), 
        .IN4(N88), .Q(\perturb/n16 ) );
  INVX0 \perturb/U24  ( .INP(\perturb/n16 ), .ZN(\perturb/n23 ) );
  INVX0 \perturb/U23  ( .INP(N74), .ZN(\perturb/n29 ) );
  XNOR3X1 \perturb/U22  ( .IN1(\perturb/n29 ), .IN2(N68), .IN3(N61), .Q(
        \perturb/n18 ) );
  INVX0 \perturb/U21  ( .INP(N91), .ZN(\perturb/n30 ) );
  XOR2X1 \perturb/U20  ( .IN1(N60), .IN2(\perturb/n30 ), .Q(\perturb/n31 ) );
  XNOR2X1 \perturb/U19  ( .IN1(N67), .IN2(\perturb/n31 ), .Q(\perturb/n19 ) );
  NOR2X0 \perturb/U18  ( .IN1(\perturb/n18 ), .IN2(\perturb/n19 ), .QN(
        \perturb/n11 ) );
  AO22X1 \perturb/U17  ( .IN1(N60), .IN2(\perturb/n30 ), .IN3(N67), .IN4(
        \perturb/n31 ), .Q(\perturb/n10 ) );
  OR2X1 \perturb/U16  ( .IN1(\perturb/n10 ), .IN2(\perturb/n11 ), .Q(
        \perturb/n25 ) );
  OR2X1 \perturb/U15  ( .IN1(N68), .IN2(N61), .Q(\perturb/n28 ) );
  AO22X1 \perturb/U14  ( .IN1(N68), .IN2(N61), .IN3(\perturb/n28 ), .IN4(
        \perturb/n29 ), .Q(\perturb/n12 ) );
  OR2X1 \perturb/U13  ( .IN1(\perturb/n20 ), .IN2(\perturb/n21 ), .Q(
        \perturb/n26 ) );
  AO222X1 \perturb/U12  ( .IN1(\perturb/n11 ), .IN2(\perturb/n10 ), .IN3(
        \perturb/n25 ), .IN4(\perturb/n12 ), .IN5(\perturb/n26 ), .IN6(
        \perturb/n27 ), .Q(\perturb/n24 ) );
  AO221X1 \perturb/U11  ( .IN1(\perturb/n20 ), .IN2(\perturb/n21 ), .IN3(
        \perturb/n22 ), .IN4(\perturb/n23 ), .IN5(\perturb/n24 ), .Q(
        \perturb/n1 ) );
  XOR2X1 \perturb/U10  ( .IN1(\perturb/n18 ), .IN2(\perturb/n19 ), .Q(
        \perturb/n6 ) );
  NAND3X0 \perturb/U9  ( .IN1(\perturb/n16 ), .IN2(\perturb/n17 ), .IN3(
  ...
  XOR2X1 \restore/U53  ( .IN1(keyinput11), .IN2(N62), .Q(\restore/n49 ) );
  XOR2X1 \restore/U52  ( .IN1(keyinput10), .IN2(N227), .Q(\restore/n50 ) );
  XOR2X1 \restore/U51  ( .IN1(keyinput12), .IN2(N49), .Q(\restore/n45 ) );
  ...
  XOR2X1 \restore/U48  ( .IN1(keyinput14), .IN2(N55), .Q(\restore/n47 ) );
  XOR2X1 \restore/U47  ( .IN1(keyinput13), .IN2(N73), .Q(\restore/n48 ) );
  XOR2X1 \restore/U46  ( .IN1(keyinput15), .IN2(N85), .Q(\restore/n43 ) );
  ...
  XOR2X1 \restore/U43  ( .IN1(\restore/n45 ), .IN2(\restore/n46 ), .Q(
        \restore/n39 ) );
  XOR2X1 \restore/U42  ( .IN1(keyinput0), .IN2(N66), .Q(\restore/n40 ) );
  ...
  XOR2X1 \restore/U36  ( .IN1(keyinput1), .IN2(N246), .Q(\restore/n35 ) );
  XOR2X1 \restore/U35  ( .IN1(keyinput3), .IN2(N88), .Q(\restore/n36 ) );
  XOR2X1 \restore/U34  ( .IN1(keyinput2), .IN2(N72), .Q(\restore/n37 ) );
  ...
  XOR2X1 \restore/U28  ( .IN1(keyinput9), .IN2(N67), .Q(\restore/n34 ) );
  XOR2X1 \restore/U27  ( .IN1(keyinput8), .IN2(N60), .Q(\restore/n31 ) );
  XOR2X1 \restore/U26  ( .IN1(keyinput7), .IN2(N91), .Q(\restore/n32 ) );
  ...
  XNOR2X1 \restore/U21  ( .IN1(keyinput4), .IN2(N61), .Q(\restore/n29 ) );
  XOR2X1 \restore/U20  ( .IN1(keyinput5), .IN2(N74), .Q(\restore/n27 ) );
