...
module c3540_SFLL_HD_2_16_1_top ( N1, N13, N20, N33, N41, N45, N50, N58, N68, 
  ...
  XNOR3X1 \main/U1  ( .IN1(\main/n1 ), .IN2(\main/n2 ), .IN3(\main/n3 ), .Q(
        N5360) );
  XNOR2X1 \perturb/U43  ( .IN1(N107), .IN2(N169), .Q(\perturb/n39 ) );
  OA22X1 \perturb/U42  ( .IN1(N107), .IN2(N169), .IN3(\perturb/n39 ), .IN4(N77), .Q(\perturb/n28 ) );
  INVX0 \perturb/U41  ( .INP(\perturb/n28 ), .ZN(\perturb/n20 ) );
  XNOR2X1 \perturb/U40  ( .IN1(N137), .IN2(N200), .Q(\perturb/n40 ) );
  OA22X1 \perturb/U39  ( .IN1(N137), .IN2(N200), .IN3(\perturb/n40 ), .IN4(
        N343), .Q(\perturb/n29 ) );
  INVX0 \perturb/U38  ( .INP(\perturb/n29 ), .ZN(\perturb/n21 ) );
  XOR2X1 \perturb/U37  ( .IN1(N343), .IN2(\perturb/n40 ), .Q(\perturb/n37 ) );
  XOR2X1 \perturb/U36  ( .IN1(N77), .IN2(\perturb/n39 ), .Q(\perturb/n36 ) );
  OR2X1 \perturb/U35  ( .IN1(\perturb/n36 ), .IN2(\perturb/n37 ), .Q(
        \perturb/n38 ) );
  AO22X1 \perturb/U34  ( .IN1(\perturb/n37 ), .IN2(\perturb/n36 ), .IN3(N1), 
        .IN4(\perturb/n38 ), .Q(\perturb/n27 ) );
  NOR3X0 \perturb/U33  ( .IN1(\perturb/n27 ), .IN2(\perturb/n21 ), .IN3(
        \perturb/n20 ), .QN(\perturb/n15 ) );
  XNOR3X1 \perturb/U32  ( .IN1(\perturb/n36 ), .IN2(N1), .IN3(\perturb/n37 ), 
        .Q(\perturb/n7 ) );
  INVX0 \perturb/U31  ( .INP(N250), .ZN(\perturb/n34 ) );
  XOR3X1 \perturb/U30  ( .IN1(N33), .IN2(\perturb/n34 ), .IN3(N179), .Q(
        \perturb/n5 ) );
  NOR2X0 \perturb/U29  ( .IN1(\perturb/n7 ), .IN2(\perturb/n5 ), .QN(
        \perturb/n13 ) );
  INVX0 \perturb/U28  ( .INP(\perturb/n13 ), .ZN(\perturb/n17 ) );
  NAND2X0 \perturb/U27  ( .IN1(\perturb/n15 ), .IN2(\perturb/n17 ), .QN(
        \perturb/n22 ) );
  AND2X1 \perturb/U26  ( .IN1(N179), .IN2(\perturb/n34 ), .Q(\perturb/n35 ) );
  OA22X1 \perturb/U25  ( .IN1(\perturb/n34 ), .IN2(N179), .IN3(\perturb/n35 ), 
        .IN4(N33), .Q(\perturb/n16 ) );
  INVX0 \perturb/U24  ( .INP(\perturb/n16 ), .ZN(\perturb/n23 ) );
  INVX0 \perturb/U23  ( .INP(N213), .ZN(\perturb/n30 ) );
  XNOR3X1 \perturb/U22  ( .IN1(N330), .IN2(N232), .IN3(\perturb/n30 ), .Q(
        \perturb/n18 ) );
  INVX0 \perturb/U21  ( .INP(N150), .ZN(\perturb/n32 ) );
  XOR2X1 \perturb/U20  ( .IN1(\perturb/n32 ), .IN2(N311), .Q(\perturb/n33 ) );
  XNOR2X1 \perturb/U19  ( .IN1(N294), .IN2(\perturb/n33 ), .Q(\perturb/n19 )
         );
  NOR2X0 \perturb/U18  ( .IN1(\perturb/n18 ), .IN2(\perturb/n19 ), .QN(
        \perturb/n11 ) );
  AO22X1 \perturb/U17  ( .IN1(N311), .IN2(\perturb/n32 ), .IN3(N294), .IN4(
        \perturb/n33 ), .Q(\perturb/n10 ) );
  OR2X1 \perturb/U16  ( .IN1(\perturb/n10 ), .IN2(\perturb/n11 ), .Q(
        \perturb/n25 ) );
  OR2X1 \perturb/U15  ( .IN1(\perturb/n30 ), .IN2(N232), .Q(\perturb/n31 ) );
  AO22X1 \perturb/U14  ( .IN1(N232), .IN2(\perturb/n30 ), .IN3(N330), .IN4(
        \perturb/n31 ), .Q(\perturb/n12 ) );
  ...
  XOR2X1 \restore/U53  ( .IN1(keyinput11), .IN2(N169), .Q(\restore/n49 ) );
  XOR2X1 \restore/U52  ( .IN1(keyinput10), .IN2(N107), .Q(\restore/n50 ) );
  XOR2X1 \restore/U51  ( .IN1(keyinput12), .IN2(N77), .Q(\restore/n45 ) );
  ...
  XOR2X1 \restore/U48  ( .IN1(keyinput14), .IN2(N200), .Q(\restore/n47 ) );
  XOR2X1 \restore/U47  ( .IN1(keyinput13), .IN2(N137), .Q(\restore/n48 ) );
  XOR2X1 \restore/U46  ( .IN1(keyinput15), .IN2(N343), .Q(\restore/n43 ) );
  ...
  XOR2X1 \restore/U43  ( .IN1(\restore/n45 ), .IN2(\restore/n46 ), .Q(
        \restore/n39 ) );
  XOR2X1 \restore/U42  ( .IN1(keyinput0), .IN2(N1), .Q(\restore/n40 ) );
  ...
  XOR2X1 \restore/U36  ( .IN1(keyinput1), .IN2(N250), .Q(\restore/n35 ) );
  XOR2X1 \restore/U35  ( .IN1(keyinput3), .IN2(N179), .Q(\restore/n36 ) );
  ...
  XOR2X1 \restore/U28  ( .IN1(keyinput9), .IN2(N294), .Q(\restore/n34 ) );
  XOR2X1 \restore/U27  ( .IN1(keyinput8), .IN2(N311), .Q(\restore/n31 ) );
  XOR2X1 \restore/U26  ( .IN1(keyinput7), .IN2(N150), .Q(\restore/n32 ) );
  XOR2X1 \restore/U25  ( .IN1(\restore/n31 ), .IN2(\restore/n32 ), .Q(
        \restore/n33 ) );
  XOR2X1 \restore/U24  ( .IN1(\restore/n34 ), .IN2(\restore/n33 ), .Q(
        \restore/n17 ) );
  XNOR2X1 \restore/U23  ( .IN1(keyinput6), .IN2(N232), .Q(\restore/n30 ) );
  INVX0 \restore/U22  ( .INP(\restore/n30 ), .ZN(\restore/n25 ) );
  XNOR2X1 \restore/U21  ( .IN1(keyinput4), .IN2(N213), .Q(\restore/n29 ) );
  XOR2X1 \restore/U20  ( .IN1(keyinput5), .IN2(N330), .Q(\restore/n27 ) );
