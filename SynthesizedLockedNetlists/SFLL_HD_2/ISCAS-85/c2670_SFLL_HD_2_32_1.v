...
module c2670_SFLL_HD_2_32_1_top ( N145, N153, N162, N168, N172, N210, N190, 
  ...
  wire   N3803, N214_BUFF, N217_BUFF, N160_BUFF, N173_BUFF, N213_BUFF,
         ...
         \main/n5 , \main/n4 , \main/n3 , \main/n2 , \main/n1 , \perturb/n91 ,
  ...
  INVX0 \perturb/U94  ( .INP(N112), .ZN(\perturb/n90 ) );
  OR2X1 \perturb/U93  ( .IN1(\perturb/n90 ), .IN2(N139), .Q(\perturb/n91 ) );
  AO22X1 \perturb/U92  ( .IN1(N139), .IN2(\perturb/n90 ), .IN3(N275), .IN4(
        \perturb/n91 ), .Q(\perturb/n18 ) );
  INVX0 \perturb/U91  ( .INP(\perturb/n18 ), .ZN(\perturb/n29 ) );
  XOR3X1 \perturb/U90  ( .IN1(N275), .IN2(N139), .IN3(\perturb/n90 ), .Q(
        \perturb/n86 ) );
  XOR3X1 \perturb/U89  ( .IN1(N80), .IN2(N56), .IN3(N305), .Q(\perturb/n87 )
         );
  NAND2X0 \perturb/U88  ( .IN1(\perturb/n86 ), .IN2(\perturb/n87 ), .QN(
        \perturb/n30 ) );
  INVX0 \perturb/U87  ( .INP(N305), .ZN(\perturb/n88 ) );
  AND2X1 \perturb/U86  ( .IN1(N56), .IN2(\perturb/n88 ), .Q(\perturb/n89 ) );
  OA22X1 \perturb/U85  ( .IN1(\perturb/n88 ), .IN2(N56), .IN3(\perturb/n89 ), 
        .IN4(N80), .Q(\perturb/n28 ) );
  NAND3X0 \perturb/U84  ( .IN1(\perturb/n29 ), .IN2(\perturb/n30 ), .IN3(
        \perturb/n28 ), .QN(\perturb/n12 ) );
  XOR2X1 \perturb/U83  ( .IN1(\perturb/n86 ), .IN2(\perturb/n87 ), .Q(
        \perturb/n80 ) );
  XOR3X1 \perturb/U82  ( .IN1(N78), .IN2(N47), .IN3(N227), .Q(\perturb/n83 )
         );
  XOR3X1 \perturb/U81  ( .IN1(N53), .IN2(N266), .IN3(N115), .Q(\perturb/n84 )
         );
  XOR2X1 \perturb/U80  ( .IN1(\perturb/n83 ), .IN2(\perturb/n84 ), .Q(
        \perturb/n81 ) );
  AND2X1 \perturb/U79  ( .IN1(\perturb/n80 ), .IN2(\perturb/n81 ), .Q(
        \perturb/n11 ) );
  OR2X1 \perturb/U78  ( .IN1(N266), .IN2(N115), .Q(\perturb/n85 ) );
  AO22X1 \perturb/U77  ( .IN1(N115), .IN2(N266), .IN3(N53), .IN4(\perturb/n85 ), .Q(\perturb/n25 ) );
  AND2X1 \perturb/U76  ( .IN1(\perturb/n83 ), .IN2(\perturb/n84 ), .Q(
        \perturb/n22 ) );
  OR2X1 \perturb/U75  ( .IN1(N47), .IN2(N227), .Q(\perturb/n82 ) );
  AO22X1 \perturb/U74  ( .IN1(N227), .IN2(N47), .IN3(N78), .IN4(\perturb/n82 ), 
        .Q(\perturb/n23 ) );
  OR3X1 \perturb/U73  ( .IN1(\perturb/n25 ), .IN2(\perturb/n22 ), .IN3(
        \perturb/n23 ), .Q(\perturb/n19 ) );
  NOR3X0 \perturb/U72  ( .IN1(\perturb/n12 ), .IN2(\perturb/n11 ), .IN3(
        \perturb/n19 ), .QN(\perturb/n54 ) );
  XNOR2X1 \perturb/U71  ( .IN1(\perturb/n80 ), .IN2(\perturb/n81 ), .Q(
        \perturb/n47 ) );
  XOR2X1 \perturb/U70  ( .IN1(\perturb/n54 ), .IN2(\perturb/n47 ), .Q(
        \perturb/n55 ) );
  INVX0 \perturb/U69  ( .INP(N113), .ZN(\perturb/n78 ) );
  OR2X1 \perturb/U68  ( .IN1(\perturb/n78 ), .IN2(N117), .Q(\perturb/n79 ) );
  AOI22X1 \perturb/U67  ( .IN1(N117), .IN2(\perturb/n78 ), .IN3(N135), .IN4(
        \perturb/n79 ), .QN(\perturb/n40 ) );
  XOR2X1 \perturb/U66  ( .IN1(N108), .IN2(N136), .Q(\perturb/n74 ) );
  XOR2X1 \perturb/U65  ( .IN1(N8), .IN2(\perturb/n74 ), .Q(\perturb/n75 ) );
  XNOR3X1 \perturb/U64  ( .IN1(N340), .IN2(N138), .IN3(\perturb/n75 ), .Q(
        \perturb/n71 ) );
  XNOR3X1 \perturb/U63  ( .IN1(N135), .IN2(N117), .IN3(N113), .Q(\perturb/n72 ) );
  NAND2X0 \perturb/U62  ( .IN1(\perturb/n71 ), .IN2(\perturb/n72 ), .QN(
        \perturb/n38 ) );
  OR2X1 \perturb/U61  ( .IN1(\perturb/n75 ), .IN2(N138), .Q(\perturb/n76 ) );
  INVX0 \perturb/U60  ( .INP(N340), .ZN(\perturb/n77 ) );
  AOI22X1 \perturb/U59  ( .IN1(N138), .IN2(\perturb/n75 ), .IN3(\perturb/n76 ), 
        .IN4(\perturb/n77 ), .QN(\perturb/n36 ) );
  INVX0 \perturb/U58  ( .INP(N136), .ZN(\perturb/n73 ) );
  OA22X1 \perturb/U57  ( .IN1(\perturb/n73 ), .IN2(N108), .IN3(\perturb/n74 ), 
        .IN4(N8), .Q(\perturb/n35 ) );
  AND2X1 \perturb/U56  ( .IN1(\perturb/n36 ), .IN2(\perturb/n35 ), .Q(
        \perturb/n37 ) );
  AND3X1 \perturb/U55  ( .IN1(\perturb/n40 ), .IN2(\perturb/n38 ), .IN3(
        \perturb/n37 ), .Q(\perturb/n49 ) );
  INVX0 \perturb/U54  ( .INP(N125), .ZN(\perturb/n58 ) );
  XOR3X1 \perturb/U53  ( .IN1(N352), .IN2(N126), .IN3(\perturb/n58 ), .Q(
        \perturb/n59 ) );
  XOR3X1 \perturb/U52  ( .IN1(N54), .IN2(N325), .IN3(N129), .Q(\perturb/n60 )
         );
  XOR2X1 \perturb/U51  ( .IN1(\perturb/n59 ), .IN2(\perturb/n60 ), .Q(
        \perturb/n64 ) );
  INVX0 \perturb/U50  ( .INP(N52), .ZN(\perturb/n66 ) );
  INVX0 \perturb/U49  ( .INP(N287), .ZN(\perturb/n65 ) );
  XNOR2X1 \perturb/U48  ( .IN1(N231), .IN2(\perturb/n65 ), .Q(\perturb/n67 )
         );
  XOR2X1 \perturb/U47  ( .IN1(\perturb/n66 ), .IN2(\perturb/n67 ), .Q(
        \perturb/n68 ) );
  XOR2X1 \perturb/U46  ( .IN1(N101), .IN2(N141), .Q(\perturb/n70 ) );
  XOR2X1 \perturb/U45  ( .IN1(N40), .IN2(\perturb/n70 ), .Q(\perturb/n69 ) );
  XOR2X1 \perturb/U44  ( .IN1(\perturb/n68 ), .IN2(\perturb/n69 ), .Q(
        \perturb/n63 ) );
  XOR2X1 \perturb/U43  ( .IN1(\perturb/n64 ), .IN2(\perturb/n63 ), .Q(
        \perturb/n52 ) );
  XOR2X1 \perturb/U42  ( .IN1(\perturb/n71 ), .IN2(\perturb/n72 ), .Q(
        \perturb/n53 ) );
  NAND2X0 \perturb/U41  ( .IN1(\perturb/n52 ), .IN2(\perturb/n53 ), .QN(
        \perturb/n51 ) );
  AO22X1 \perturb/U40  ( .IN1(N101), .IN2(N141), .IN3(N40), .IN4(\perturb/n70 ), .Q(\perturb/n10 ) );
  NAND2X0 \perturb/U39  ( .IN1(\perturb/n68 ), .IN2(\perturb/n69 ), .QN(
        \perturb/n16 ) );
  INVX0 \perturb/U38  ( .INP(\perturb/n16 ), .ZN(\perturb/n13 ) );
  OA22X1 \perturb/U37  ( .IN1(\perturb/n65 ), .IN2(N231), .IN3(\perturb/n66 ), 
        .IN4(\perturb/n67 ), .Q(\perturb/n15 ) );
  ...
  NAND2X0 \perturb/U34  ( .IN1(\perturb/n63 ), .IN2(\perturb/n64 ), .QN(
        \perturb/n45 ) );
  INVX0 \perturb/U33  ( .INP(N129), .ZN(\perturb/n61 ) );
  AND2X1 \perturb/U32  ( .IN1(N325), .IN2(\perturb/n61 ), .Q(\perturb/n62 ) );
  OA22X1 \perturb/U31  ( .IN1(\perturb/n61 ), .IN2(N325), .IN3(\perturb/n62 ), 
        .IN4(N54), .Q(\perturb/n8 ) );
  NAND2X0 \perturb/U30  ( .IN1(\perturb/n59 ), .IN2(\perturb/n60 ), .QN(
        \perturb/n5 ) );
  INVX0 \perturb/U29  ( .INP(N126), .ZN(\perturb/n56 ) );
  NAND2X0 \perturb/U28  ( .IN1(N126), .IN2(\perturb/n58 ), .QN(\perturb/n57 )
         );
  AOI22X1 \perturb/U27  ( .IN1(N125), .IN2(\perturb/n56 ), .IN3(N352), .IN4(
        \perturb/n57 ), .QN(\perturb/n6 ) );
  AND3X1 \perturb/U26  ( .IN1(\perturb/n8 ), .IN2(\perturb/n5 ), .IN3(
        \perturb/n6 ), .Q(\perturb/n44 ) );
  AND3X1 \perturb/U25  ( .IN1(\perturb/n43 ), .IN2(\perturb/n45 ), .IN3(
        \perturb/n44 ), .Q(\perturb/n50 ) );
  AND3X1 \perturb/U24  ( .IN1(\perturb/n49 ), .IN2(\perturb/n51 ), .IN3(
        \perturb/n50 ), .Q(\perturb/n46 ) );
  MUX21X1 \perturb/U23  ( .IN1(\perturb/n54 ), .IN2(\perturb/n55 ), .S(
        \perturb/n46 ), .Q(\perturb/n31 ) );
  XOR3X1 \perturb/U22  ( .IN1(\perturb/n52 ), .IN2(\perturb/n53 ), .IN3(
        \perturb/n47 ), .Q(\perturb/n32 ) );
  AND2X1 \perturb/U21  ( .IN1(\perturb/n51 ), .IN2(\perturb/n50 ), .Q(
        \perturb/n48 ) );
  OA222X1 \perturb/U20  ( .IN1(\perturb/n46 ), .IN2(\perturb/n47 ), .IN3(
        \perturb/n48 ), .IN4(\perturb/n49 ), .IN5(\perturb/n50 ), .IN6(
        \perturb/n51 ), .Q(\perturb/n33 ) );
  AND2X1 \perturb/U19  ( .IN1(\perturb/n38 ), .IN2(\perturb/n37 ), .Q(
        \perturb/n41 ) );
  ...
  INVX0 \perturb/U14  ( .INP(\perturb/n30 ), .ZN(\perturb/n17 ) );
  OR2X1 \perturb/U13  ( .IN1(\perturb/n12 ), .IN2(\perturb/n11 ), .Q(
        \perturb/n20 ) );
  OR2X1 \perturb/U12  ( .IN1(\perturb/n23 ), .IN2(\perturb/n22 ), .Q(
        \perturb/n24 ) );
  NAND2X0 \perturb/U11  ( .IN1(\perturb/n29 ), .IN2(\perturb/n30 ), .QN(
        \perturb/n26 ) );
  INVX0 \perturb/U10  ( .INP(\perturb/n28 ), .ZN(\perturb/n27 ) );
  ...
  XOR2X1 \restore/U117  ( .IN1(keyinput5), .IN2(N275), .Q(\restore/n113 ) );
  XOR2X1 \restore/U116  ( .IN1(keyinput7), .IN2(N112), .Q(\restore/n111 ) );
  XOR2X1 \restore/U115  ( .IN1(keyinput6), .IN2(N139), .Q(\restore/n112 ) );
  ...
  XOR2X1 \restore/U111  ( .IN1(keyinput10), .IN2(N305), .Q(\restore/n107 ) );
  XOR2X1 \restore/U110  ( .IN1(keyinput8), .IN2(N56), .Q(\restore/n108 ) );
  XOR2X1 \restore/U109  ( .IN1(keyinput9), .IN2(N80), .Q(\restore/n109 ) );
  ...
  XOR2X1 \restore/U102  ( .IN1(\restore/n105 ), .IN2(\restore/n106 ), .Q(
        \restore/n93 ) );
  XOR2X1 \restore/U101  ( .IN1(keyinput11), .IN2(N78), .Q(\restore/n96 ) );
  XOR2X1 \restore/U100  ( .IN1(keyinput12), .IN2(N47), .Q(\restore/n97 ) );
  XOR2X1 \restore/U99  ( .IN1(keyinput13), .IN2(N227), .Q(\restore/n95 ) );
  XOR3X1 \restore/U98  ( .IN1(\restore/n96 ), .IN2(\restore/n97 ), .IN3(
        \restore/n95 ), .Q(\restore/n99 ) );
  XOR2X1 \restore/U97  ( .IN1(keyinput16), .IN2(N115), .Q(\restore/n101 ) );
  XOR2X1 \restore/U96  ( .IN1(keyinput14), .IN2(N53), .Q(\restore/n102 ) );
  XOR2X1 \restore/U95  ( .IN1(keyinput15), .IN2(N266), .Q(\restore/n103 ) );
  ...
  XOR2X1 \restore/U82  ( .IN1(\restore/n53 ), .IN2(\restore/n43 ), .Q(
        \restore/n54 ) );
  XOR2X1 \restore/U81  ( .IN1(keyinput2), .IN2(N135), .Q(\restore/n90 ) );
  XOR2X1 \restore/U80  ( .IN1(keyinput4), .IN2(N113), .Q(\restore/n89 ) );
  XOR2X1 \restore/U79  ( .IN1(keyinput3), .IN2(N117), .Q(\restore/n91 ) );
  ...
  XOR2X1 \restore/U75  ( .IN1(keyinput1), .IN2(N340), .Q(\restore/n85 ) );
  XOR2X1 \restore/U74  ( .IN1(keyinput0), .IN2(N138), .Q(\restore/n87 ) );
  XOR2X1 \restore/U73  ( .IN1(keyinput31), .IN2(N8), .Q(\restore/n83 ) );
  XOR2X1 \restore/U72  ( .IN1(keyinput30), .IN2(N136), .Q(\restore/n81 ) );
  XOR2X1 \restore/U71  ( .IN1(keyinput29), .IN2(N108), .Q(\restore/n82 ) );
  ...
  XNOR2X1 \restore/U61  ( .IN1(keyinput20), .IN2(N54), .Q(\restore/n66 ) );
  INVX0 \restore/U60  ( .INP(\restore/n66 ), .ZN(\restore/n61 ) );
  XNOR2X1 \restore/U59  ( .IN1(keyinput22), .IN2(N325), .Q(\restore/n65 ) );
  XOR2X1 \restore/U58  ( .IN1(keyinput21), .IN2(N129), .Q(\restore/n63 ) );
  XNOR3X1 \restore/U57  ( .IN1(\restore/n61 ), .IN2(\restore/n65 ), .IN3(
        \restore/n63 ), .Q(\restore/n59 ) );
  XOR2X1 \restore/U56  ( .IN1(keyinput19), .IN2(N125), .Q(\restore/n56 ) );
  XOR2X1 \restore/U55  ( .IN1(keyinput18), .IN2(N126), .Q(\restore/n57 ) );
  XOR2X1 \restore/U54  ( .IN1(keyinput17), .IN2(N352), .Q(\restore/n55 ) );
  ...
  XOR2X1 \restore/U52  ( .IN1(\restore/n59 ), .IN2(\restore/n60 ), .Q(
        \restore/n67 ) );
  XOR2X1 \restore/U51  ( .IN1(keyinput25), .IN2(N52), .Q(\restore/n72 ) );
  XOR2X1 \restore/U50  ( .IN1(keyinput24), .IN2(N287), .Q(\restore/n69 ) );
  XOR2X1 \restore/U49  ( .IN1(keyinput23), .IN2(N231), .Q(\restore/n70 ) );
  XOR2X1 \restore/U48  ( .IN1(\restore/n69 ), .IN2(\restore/n70 ), .Q(
        \restore/n71 ) );
  XOR2X1 \restore/U47  ( .IN1(\restore/n72 ), .IN2(\restore/n71 ), .Q(
        \restore/n73 ) );
  XOR2X1 \restore/U46  ( .IN1(keyinput28), .IN2(N40), .Q(\restore/n77 ) );
  XOR2X1 \restore/U45  ( .IN1(keyinput27), .IN2(N141), .Q(\restore/n75 ) );
  XOR2X1 \restore/U44  ( .IN1(keyinput26), .IN2(N101), .Q(\restore/n76 ) );
