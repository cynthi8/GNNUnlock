...
module c5315_SFLL_HD_2_16_1_top ( N1, N4, N11, N14, N17, N20, N23, N24, N25, 
  ...
  NOR2X0 \perturb/U28  ( .IN1(\perturb/n31 ), .IN2(\perturb/n30 ), .QN(
        perturb_signal) );
  OR2X1 \perturb/U27  ( .IN1(\perturb/n29 ), .IN2(\perturb/n28 ), .Q(
        \perturb/n30 ) );
  OA22X1 \perturb/U26  ( .IN1(\perturb/n27 ), .IN2(\perturb/n26 ), .IN3(
        \perturb/n25 ), .IN4(\perturb/n24 ), .Q(\perturb/n28 ) );
  AO221X1 \perturb/U25  ( .IN1(\perturb/n24 ), .IN2(\perturb/n25 ), .IN3(
        \perturb/n26 ), .IN4(\perturb/n27 ), .IN5(\perturb/n23 ), .Q(
        \perturb/n29 ) );
  NOR4X0 \perturb/U24  ( .IN1(\perturb/n27 ), .IN2(\perturb/n26 ), .IN3(
        \perturb/n25 ), .IN4(\perturb/n24 ), .QN(\perturb/n23 ) );
  NAND2X0 \perturb/U23  ( .IN1(\perturb/n22 ), .IN2(\perturb/n21 ), .QN(
        \perturb/n27 ) );
  NAND2X0 \perturb/U22  ( .IN1(\perturb/n20 ), .IN2(\perturb/n19 ), .QN(
        \perturb/n26 ) );
  NAND2X0 \perturb/U21  ( .IN1(\perturb/n18 ), .IN2(\perturb/n17 ), .QN(
        \perturb/n25 ) );
  NAND3X0 \perturb/U20  ( .IN1(\perturb/n16 ), .IN2(\perturb/n15 ), .IN3(
        \perturb/n14 ), .QN(\perturb/n24 ) );
  NAND3X0 \perturb/U19  ( .IN1(\perturb/n13 ), .IN2(\perturb/n12 ), .IN3(
        \perturb/n11 ), .QN(\perturb/n31 ) );
  OA22X1 \perturb/U18  ( .IN1(\perturb/n22 ), .IN2(\perturb/n21 ), .IN3(
        \perturb/n18 ), .IN4(\perturb/n10 ), .Q(\perturb/n11 ) );
  FADDX1 \perturb/U17  ( .A(N316), .B(N308), .CI(\perturb/n9 ), .CO(
        \perturb/n18 ), .S(\perturb/n7 ) );
  FADDX1 \perturb/U16  ( .A(\perturb/n8 ), .B(\perturb/n7 ), .CI(\perturb/n6 ), 
        .CO(\perturb/n21 ), .S(\perturb/n20 ) );
  FADDX1 \perturb/U15  ( .A(N596), .B(N335), .CI(\perturb/n5 ), .CO(
        \perturb/n22 ), .S(\perturb/n19 ) );
  XOR3X1 \perturb/U14  ( .IN1(\perturb/n20 ), .IN2(\perturb/n19 ), .IN3(
        \perturb/n4 ), .Q(\perturb/n12 ) );
  FADDX1 \perturb/U13  ( .A(N331), .B(N503), .CI(\perturb/n3 ), .CO(
        \perturb/n14 ), .S(\perturb/n4 ) );
  MUX21X1 \perturb/U12  ( .IN1(\perturb/n10 ), .IN2(N257), .S(N341), .Q(
        \perturb/n5 ) );
  INVX0 \perturb/U11  ( .INP(N257), .ZN(\perturb/n10 ) );
  FADDX1 \perturb/U10  ( .A(N400), .B(N479), .CI(\perturb/n2 ), .CO(
        \perturb/n16 ), .S(\perturb/n6 ) );
  INVX0 \perturb/U9  ( .INP(N315), .ZN(\perturb/n9 ) );
  FADDX1 \perturb/U8  ( .A(N324), .B(N534), .CI(\perturb/n1 ), .CO(
        \perturb/n15 ), .S(\perturb/n8 ) );
  AO222X1 \perturb/U7  ( .IN1(\perturb/n16 ), .IN2(\perturb/n15 ), .IN3(
        \perturb/n16 ), .IN4(\perturb/n14 ), .IN5(\perturb/n15 ), .IN6(
        \perturb/n14 ), .Q(\perturb/n13 ) );
  INVX0 \perturb/U6  ( .INP(N619), .ZN(\perturb/n3 ) );
  INVX0 \perturb/U5  ( .INP(N323), .ZN(\perturb/n1 ) );
  INVX0 \perturb/U4  ( .INP(N597), .ZN(\perturb/n2 ) );
  NAND2X0 \perturb/U3  ( .IN1(N257), .IN2(N341), .QN(\perturb/n17 ) );
  ...
  XNOR2X1 \restore/U23  ( .IN1(keyinput3), .IN2(N335), .Q(\restore/n7 ) );
  MUX21X1 \restore/U22  ( .IN1(\restore/n20 ), .IN2(\restore/n33 ), .S(
        \restore/n34 ), .Q(\restore/n8 ) );
  XOR2X1 \restore/U21  ( .IN1(keyinput4), .IN2(N341), .Q(\restore/n34 ) );
  INVX0 \restore/U20  ( .INP(\restore/n20 ), .ZN(\restore/n33 ) );
  XNOR2X1 \restore/U19  ( .IN1(keyinput2), .IN2(N257), .Q(\restore/n20 ) );
  XNOR2X1 \restore/U18  ( .IN1(keyinput1), .IN2(N596), .Q(\restore/n9 ) );
  XNOR2X1 \restore/U17  ( .IN1(keyinput7), .IN2(N597), .Q(\restore/n14 ) );
  XNOR2X1 \restore/U16  ( .IN1(keyinput9), .IN2(N479), .Q(\restore/n15 ) );
  XNOR2X1 \restore/U15  ( .IN1(keyinput5), .IN2(N400), .Q(\restore/n16 ) );
  XNOR2X1 \restore/U14  ( .IN1(keyinput13), .IN2(N308), .Q(\restore/n17 ) );
  XNOR2X1 \restore/U13  ( .IN1(keyinput15), .IN2(N315), .Q(\restore/n18 ) );
  XNOR2X1 \restore/U12  ( .IN1(keyinput11), .IN2(N316), .Q(\restore/n19 ) );
  FADDX1 \restore/U11  ( .A(\restore/n3 ), .B(\restore/n2 ), .CI(\restore/n1 ), 
        .CO(\restore/n25 ), .S(\restore/n6 ) );
  XNOR2X1 \restore/U10  ( .IN1(keyinput6), .IN2(N503), .Q(\restore/n10 ) );
  XNOR2X1 \restore/U9  ( .IN1(keyinput0), .IN2(N331), .Q(\restore/n11 ) );
  XNOR2X1 \restore/U8  ( .IN1(keyinput8), .IN2(N619), .Q(\restore/n12 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput12), .IN2(N534), .Q(\restore/n1 ) );
  XNOR2X1 \restore/U6  ( .IN1(keyinput10), .IN2(N324), .Q(\restore/n2 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput14), .IN2(N323), .Q(\restore/n3 ) );
  NAND2X0 \restore/U4  ( .IN1(\restore/n36 ), .IN2(\restore/n35 ), .QN(
        \restore/n42 ) );
  NAND2X0 \restore/U3  ( .IN1(\restore/n23 ), .IN2(\restore/n22 ), .QN(
        \restore/n38 ) );
endmodule
