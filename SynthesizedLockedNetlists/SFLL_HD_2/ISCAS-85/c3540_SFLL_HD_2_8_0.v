...
module c3540_SFLL_HD_2_8_0_top ( N1, N13, N20, N33, N41, N45, N50, N58, N68, 
  ...
  XOR3X1 \main/U414  ( .IN1(N97), .IN2(N87), .IN3(\main/n416 ), .Q(\main/n139 ) );
  XOR2X1 \main/U413  ( .IN1(\main/n289 ), .IN2(\main/n139 ), .Q(N3987) );
  ...
  INVX0 \main/U405  ( .INP(N41), .ZN(\main/n118 ) );
  INVX0 \main/U404  ( .INP(N33), .ZN(\main/n121 ) );
  OA21X1 \main/U403  ( .IN1(\main/n118 ), .IN2(\main/n121 ), .IN3(\main/n300 ), 
        .Q(\main/n350 ) );
  ...
  NOR3X0 \main/U393  ( .IN1(\main/n276 ), .IN2(\main/n302 ), .IN3(\main/n121 ), 
        .QN(\main/n410 ) );
  ...
  AOI21X1 \main/U375  ( .IN1(\main/n403 ), .IN2(\main/n118 ), .IN3(\main/n350 ), .QN(\main/n389 ) );
  AND3X1 \main/U374  ( .IN1(N274), .IN2(\main/n118 ), .IN3(\main/n403 ), .Q(
        \main/n390 ) );
  ...
  MUX21X1 \main/U364  ( .IN1(\main/n301 ), .IN2(\main/n339 ), .S(\main/n311 ), 
        .Q(\main/n398 ) );
  NOR2X0 \main/U363  ( .IN1(\main/n398 ), .IN2(\main/n317 ), .QN(\main/n322 )
         );
  AOI21X1 \main/U362  ( .IN1(\main/n397 ), .IN2(\main/n317 ), .IN3(\main/n322 ), .QN(\main/n315 ) );
  ...
  MUX21X1 \main/U344  ( .IN1(N179), .IN2(N169), .S(\main/n310 ), .Q(
        \main/n385 ) );
  NAND2X0 \main/U343  ( .IN1(\main/n385 ), .IN2(\main/n321 ), .QN(\main/n335 )
         );
  OA21X1 \main/U342  ( .IN1(\main/n384 ), .IN2(\main/n321 ), .IN3(\main/n335 ), 
        .Q(\main/n320 ) );
  ...
  NAND3X0 \main/U327  ( .IN1(\main/n376 ), .IN2(\main/n377 ), .IN3(N58), .QN(
        \main/n375 ) );
  NAND4X0 \main/U326  ( .IN1(\main/n372 ), .IN2(\main/n373 ), .IN3(\main/n374 ), .IN4(\main/n375 ), .QN(\main/n90 ) );
  MUX21X1 \main/U325  ( .IN1(\main/n371 ), .IN2(\main/n329 ), .S(\main/n90 ), 
        .Q(\main/n88 ) );
  ...
  MUX21X1 \main/U319  ( .IN1(N169), .IN2(N179), .S(\main/n367 ), .Q(
        \main/n366 ) );
  NAND2X0 \main/U318  ( .IN1(\main/n366 ), .IN2(\main/n271 ), .QN(\main/n105 )
         );
  OA21X1 \main/U317  ( .IN1(\main/n365 ), .IN2(\main/n271 ), .IN3(\main/n105 ), 
        .Q(\main/n270 ) );
  ...
  NAND4X0 \main/U295  ( .IN1(\main/n88 ), .IN2(\main/n270 ), .IN3(\main/n328 ), 
        .IN4(\main/n246 ), .QN(\main/n336 ) );
  NOR2X0 \main/U294  ( .IN1(\main/n307 ), .IN2(\main/n336 ), .QN(N4028) );
  INVX0 \main/U293  ( .INP(\main/n336 ), .ZN(\main/n110 ) );
  INVX0 \main/U292  ( .INP(\main/n335 ), .ZN(\main/n318 ) );
  AOI21X1 \main/U291  ( .IN1(\main/n320 ), .IN2(\main/n322 ), .IN3(\main/n318 ), .QN(\main/n333 ) );
  ...
  AO22X1 \main/U281  ( .IN1(\main/n90 ), .IN2(\main/n323 ), .IN3(\main/n324 ), 
        .IN4(\main/n88 ), .Q(\main/n239 ) );
  AO21X1 \main/U280  ( .IN1(\main/n110 ), .IN2(\main/n314 ), .IN3(\main/n239 ), 
        .Q(N4145) );
  ...
  AND2X1 \main/U275  ( .IN1(\main/n322 ), .IN2(\main/n224 ), .Q(\main/n192 )
         );
  NAND2X0 \main/U274  ( .IN1(\main/n106 ), .IN2(\main/n321 ), .QN(\main/n319 )
         );
  XNOR2X1 \main/U273  ( .IN1(\main/n319 ), .IN2(\main/n320 ), .Q(\main/n171 )
         );
  NAND2X0 \main/U272  ( .IN1(\main/n192 ), .IN2(\main/n171 ), .QN(\main/n204 )
         );
  NAND2X0 \main/U271  ( .IN1(\main/n318 ), .IN2(\main/n224 ), .QN(\main/n203 )
         );
  ...
  NAND2X0 \main/U252  ( .IN1(\main/n290 ), .IN2(\main/n118 ), .QN(\main/n108 )
         );
  MUX21X1 \main/U251  ( .IN1(\main/n304 ), .IN2(\main/n305 ), .S(\main/n108 ), 
        .Q(\main/n303 ) );
  AO21X1 \main/U250  ( .IN1(\main/n158 ), .IN2(\main/n302 ), .IN3(\main/n303 ), 
        .Q(N4667) );
  NOR2X0 \main/U249  ( .IN1(N33), .IN2(N13), .QN(\main/n23 ) );
  INVX0 \main/U248  ( .INP(\main/n23 ), .ZN(\main/n116 ) );
  NOR2X0 \main/U247  ( .IN1(\main/n116 ), .IN2(N20), .QN(\main/n145 ) );
  ...
  INVX0 \main/U243  ( .INP(N311), .ZN(\main/n153 ) );
  ...
  OA21X1 \main/U237  ( .IN1(\main/n276 ), .IN2(N169), .IN3(\main/n300 ), .Q(
        \main/n266 ) );
  INVX0 \main/U236  ( .INP(\main/n266 ), .ZN(\main/n94 ) );
  NOR2X0 \main/U235  ( .IN1(\main/n94 ), .IN2(\main/n121 ), .QN(\main/n44 ) );
  OA21X1 \main/U234  ( .IN1(\main/n43 ), .IN2(\main/n27 ), .IN3(\main/n44 ), 
        .Q(\main/n299 ) );
  OA221X1 \main/U233  ( .IN1(\main/n38 ), .IN2(\main/n153 ), .IN3(\main/n35 ), 
  ...
  INVX0 \main/U227  ( .INP(N322), .ZN(\main/n150 ) );
  ...
  NAND3X0 \main/U224  ( .IN1(N200), .IN2(\main/n295 ), .IN3(\main/n293 ), .QN(
        \main/n33 ) );
  INVX0 \main/U223  ( .INP(N317), .ZN(\main/n152 ) );
  NAND3X0 \main/U222  ( .IN1(\main/n293 ), .IN2(N200), .IN3(\main/n294 ), .QN(
        \main/n32 ) );
  OA222X1 \main/U221  ( .IN1(\main/n150 ), .IN2(\main/n36 ), .IN3(\main/n168 ), 
  ...
  NOR2X0 \main/U219  ( .IN1(\main/n266 ), .IN2(\main/n145 ), .QN(\main/n174 )
         );
  AND2X1 \main/U218  ( .IN1(\main/n290 ), .IN2(\main/n121 ), .Q(\main/n176 )
         );
  AND2X1 \main/U217  ( .IN1(N33), .IN2(\main/n290 ), .Q(\main/n138 ) );
  NOR2X0 \main/U216  ( .IN1(\main/n138 ), .IN2(\main/n176 ), .QN(\main/n140 )
         );
  MUX21X1 \main/U215  ( .IN1(\main/n288 ), .IN2(\main/n289 ), .S(N45), .Q(
        \main/n287 ) );
  AO222X1 \main/U214  ( .IN1(\main/n176 ), .IN2(N1947), .IN3(\main/n140 ), 
        .IN4(\main/n31 ), .IN5(\main/n287 ), .IN6(\main/n138 ), .Q(\main/n282 ) );
  NOR2X0 \main/U213  ( .IN1(\main/n94 ), .IN2(N33), .QN(\main/n55 ) );
  ...
  AO221X1 \main/U207  ( .IN1(\main/n277 ), .IN2(\main/n145 ), .IN3(\main/n279 ), .IN4(\main/n280 ), .IN5(\main/n281 ), .Q(\main/n273 ) );
  AO21X1 \main/U206  ( .IN1(\main/n277 ), .IN2(\main/n278 ), .IN3(\main/n193 ), 
        .Q(\main/n274 ) );
  NAND3X0 \main/U205  ( .IN1(N13), .IN2(\main/n276 ), .IN3(N45), .QN(
        \main/n275 ) );
  AND2X1 \main/U204  ( .IN1(N1), .IN2(\main/n275 ), .Q(\main/n109 ) );
  NAND2X0 \main/U203  ( .IN1(\main/n109 ), .IN2(\main/n108 ), .QN(\main/n137 )
         );
  MUX21X1 \main/U202  ( .IN1(\main/n273 ), .IN2(\main/n274 ), .S(\main/n137 ), 
        .Q(\main/n272 ) );
  INVX0 \main/U201  ( .INP(\main/n272 ), .ZN(N4815) );
  NAND2X0 \main/U200  ( .IN1(\main/n106 ), .IN2(\main/n271 ), .QN(\main/n269 )
         );
  ...
  OA221X1 \main/U194  ( .IN1(\main/n26 ), .IN2(\main/n153 ), .IN3(\main/n29 ), 
  ...
  NAND2X0 \main/U182  ( .IN1(\main/n238 ), .IN2(\main/n244 ), .QN(\main/n107 )
         );
  OA21X1 \main/U181  ( .IN1(\main/n238 ), .IN2(\main/n244 ), .IN3(\main/n107 ), 
        .Q(\main/n257 ) );
  XNOR2X1 \main/U180  ( .IN1(\main/n111 ), .IN2(\main/n257 ), .Q(\main/n256 )
         );
  MUX21X1 \main/U179  ( .IN1(\main/n255 ), .IN2(\main/n256 ), .S(\main/n137 ), 
        .Q(\main/n8 ) );
  ...
  NAND2X0 \main/U174  ( .IN1(\main/n111 ), .IN2(\main/n244 ), .QN(\main/n103 )
         );
  NAND2X0 \main/U173  ( .IN1(\main/n106 ), .IN2(\main/n251 ), .QN(\main/n249 )
         );
  XOR2X1 \main/U172  ( .IN1(\main/n249 ), .IN2(\main/n250 ), .Q(\main/n243 )
         );
  INVX0 \main/U171  ( .INP(\main/n243 ), .ZN(\main/n22 ) );
  NOR2X0 \main/U170  ( .IN1(\main/n103 ), .IN2(\main/n22 ), .QN(\main/n100 )
         );
  NOR2X0 \main/U169  ( .IN1(\main/n248 ), .IN2(\main/n237 ), .QN(\main/n247 )
         );
  XOR2X1 \main/U168  ( .IN1(\main/n246 ), .IN2(\main/n247 ), .Q(\main/n236 )
         );
  NAND2X0 \main/U167  ( .IN1(\main/n100 ), .IN2(\main/n236 ), .QN(\main/n114 )
         );
  INVX0 \main/U166  ( .INP(\main/n245 ), .ZN(\main/n241 ) );
  NAND3X0 \main/U165  ( .IN1(\main/n243 ), .IN2(\main/n236 ), .IN3(\main/n244 ), .QN(\main/n242 ) );
  NAND4X0 \main/U164  ( .IN1(\main/n110 ), .IN2(N330), .IN3(\main/n241 ), 
        .IN4(\main/n242 ), .QN(\main/n240 ) );
  OA21X1 \main/U163  ( .IN1(\main/n110 ), .IN2(\main/n114 ), .IN3(\main/n240 ), 
        .Q(\main/n232 ) );
  AO21X1 \main/U162  ( .IN1(\main/n110 ), .IN2(\main/n238 ), .IN3(\main/n239 ), 
        .Q(\main/n112 ) );
  INVX0 \main/U161  ( .INP(\main/n237 ), .ZN(\main/n89 ) );
  INVX0 \main/U160  ( .INP(\main/n236 ), .ZN(\main/n70 ) );
  OA21X1 \main/U159  ( .IN1(\main/n22 ), .IN2(\main/n105 ), .IN3(\main/n235 ), 
        .Q(\main/n234 ) );
  OA22X1 \main/U158  ( .IN1(\main/n22 ), .IN2(\main/n107 ), .IN3(\main/n106 ), 
        .IN4(\main/n234 ), .Q(\main/n98 ) );
  OA22X1 \main/U157  ( .IN1(\main/n233 ), .IN2(\main/n89 ), .IN3(\main/n70 ), 
        .IN4(\main/n98 ), .Q(\main/n113 ) );
  XNOR3X1 \main/U156  ( .IN1(\main/n232 ), .IN2(\main/n112 ), .IN3(\main/n113 ), .Q(\main/n231 ) );
  ...
  NAND2X0 \main/U150  ( .IN1(\main/n145 ), .IN2(\main/n198 ), .QN(\main/n208 )
         );
  ...
  OA221X1 \main/U141  ( .IN1(\main/n26 ), .IN2(\main/n152 ), .IN3(\main/n37 ), 
  ...
  INVX0 \main/U139  ( .INP(\main/n174 ), .ZN(\main/n141 ) );
  AO221X1 \main/U138  ( .IN1(\main/n140 ), .IN2(N87), .IN3(\main/n212 ), .IN4(
  ...
  NAND2X0 \main/U136  ( .IN1(\main/n106 ), .IN2(\main/n207 ), .QN(\main/n205 )
         );
  XOR2X1 \main/U135  ( .IN1(\main/n205 ), .IN2(\main/n206 ), .Q(\main/n199 )
         );
  INVX0 \main/U134  ( .INP(\main/n199 ), .ZN(\main/n144 ) );
  OA222X1 \main/U133  ( .IN1(\main/n106 ), .IN2(\main/n202 ), .IN3(\main/n144 ), .IN4(\main/n203 ), .IN5(\main/n144 ), .IN6(\main/n204 ), .Q(\main/n201 ) );
  ...
  MUX21X1 \main/U129  ( .IN1(\main/n196 ), .IN2(\main/n197 ), .S(\main/n144 ), 
        .Q(\main/n195 ) );
  AO21X1 \main/U128  ( .IN1(\main/n194 ), .IN2(\main/n144 ), .IN3(\main/n195 ), 
        .Q(\main/n133 ) );
  INVX0 \main/U127  ( .INP(\main/n133 ), .ZN(\main/n190 ) );
  XNOR2X1 \main/U126  ( .IN1(\main/n171 ), .IN2(\main/n193 ), .Q(\main/n191 )
         );
  MUX21X1 \main/U125  ( .IN1(\main/n191 ), .IN2(\main/n171 ), .S(\main/n192 ), 
        .Q(\main/n157 ) );
  OA21X1 \main/U124  ( .IN1(\main/n190 ), .IN2(\main/n157 ), .IN3(\main/n109 ), 
        .Q(\main/n189 ) );
  AO22X1 \main/U123  ( .IN1(\main/n187 ), .IN2(\main/n188 ), .IN3(\main/n189 ), 
        .IN4(\main/n184 ), .Q(\main/n186 ) );
  MUX21X1 \main/U122  ( .IN1(\main/n185 ), .IN2(\main/n186 ), .S(\main/n137 ), 
        .Q(\main/n11 ) );
  INVX0 \main/U121  ( .INP(\main/n11 ), .ZN(N5045) );
  OA21X1 \main/U120  ( .IN1(\main/n108 ), .IN2(\main/n184 ), .IN3(\main/n109 ), 
        .Q(\main/n155 ) );
  INVX0 \main/U119  ( .INP(\main/n108 ), .ZN(\main/n61 ) );
  NAND2X0 \main/U118  ( .IN1(\main/n184 ), .IN2(\main/n61 ), .QN(\main/n183 )
         );
  MUX21X1 \main/U117  ( .IN1(\main/n155 ), .IN2(\main/n183 ), .S(\main/n157 ), 
        .Q(\main/n159 ) );
  INVX0 \main/U116  ( .INP(\main/n137 ), .ZN(\main/n17 ) );
  ...
  XNOR3X1 \main/U1  ( .IN1(\main/n1 ), .IN2(\main/n2 ), .IN3(\main/n3 ), .Q(
        N5360) );
  XOR2X1 \perturb/U17  ( .IN1(N137), .IN2(N222), .Q(\perturb/n13 ) );
  AOI22X1 \perturb/U16  ( .IN1(N137), .IN2(N222), .IN3(N213), .IN4(
        \perturb/n13 ), .QN(\perturb/n1 ) );
  XOR2X1 \perturb/U15  ( .IN1(N128), .IN2(N169), .Q(\perturb/n14 ) );
  AOI22X1 \perturb/U14  ( .IN1(N128), .IN2(N169), .IN3(N257), .IN4(
        \perturb/n14 ), .QN(\perturb/n2 ) );
  XNOR2X1 \perturb/U13  ( .IN1(N257), .IN2(\perturb/n14 ), .Q(\perturb/n3 ) );
  AND2X1 \perturb/U12  ( .IN1(\perturb/n1 ), .IN2(\perturb/n2 ), .Q(
        \perturb/n4 ) );
  XNOR2X1 \perturb/U11  ( .IN1(N213), .IN2(\perturb/n13 ), .Q(\perturb/n9 ) );
  XNOR2X1 \perturb/U10  ( .IN1(\perturb/n9 ), .IN2(\perturb/n3 ), .Q(
        \perturb/n12 ) );
  AND3X1 \perturb/U9  ( .IN1(N274), .IN2(N226), .IN3(\perturb/n12 ), .Q(
        \perturb/n6 ) );
  XOR2X1 \perturb/U8  ( .IN1(\perturb/n12 ), .IN2(N226), .Q(\perturb/n10 ) );
  NOR2X0 \perturb/U7  ( .IN1(N226), .IN2(\perturb/n12 ), .QN(\perturb/n11 ) );
  MUX21X1 \perturb/U6  ( .IN1(\perturb/n10 ), .IN2(\perturb/n11 ), .S(N274), 
        .Q(\perturb/n7 ) );
  ...
  OA221X1 \perturb/U3  ( .IN1(\perturb/n1 ), .IN2(\perturb/n2 ), .IN3(
        ...
        perturb_signal) );
  XOR2X1 \restore/U25  ( .IN1(keyinput6), .IN2(N169), .Q(\restore/n21 ) );
  XOR2X1 \restore/U24  ( .IN1(keyinput5), .IN2(N274), .Q(\restore/n22 ) );
  XOR2X1 \restore/U23  ( .IN1(keyinput7), .IN2(N257), .Q(\restore/n19 ) );
  ...
  XOR2X1 \restore/U20  ( .IN1(keyinput0), .IN2(N137), .Q(\restore/n17 ) );
  XOR2X1 \restore/U19  ( .IN1(\restore/n19 ), .IN2(\restore/n20 ), .Q(
        \restore/n18 ) );
  XOR2X1 \restore/U18  ( .IN1(\restore/n17 ), .IN2(\restore/n18 ), .Q(
        \restore/n16 ) );
  XOR2X1 \restore/U17  ( .IN1(keyinput1), .IN2(N222), .Q(\restore/n15 ) );
  AOI22X1 \restore/U16  ( .IN1(\restore/n17 ), .IN2(\restore/n18 ), .IN3(
        \restore/n16 ), .IN4(\restore/n15 ), .QN(\restore/n2 ) );
  XNOR2X1 \restore/U15  ( .IN1(keyinput4), .IN2(N128), .Q(\restore/n12 ) );
  XNOR2X1 \restore/U14  ( .IN1(keyinput3), .IN2(N213), .Q(\restore/n14 ) );
  XNOR2X1 \restore/U13  ( .IN1(keyinput2), .IN2(N226), .Q(\restore/n13 ) );
