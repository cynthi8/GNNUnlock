...
module c2670_SFLL_HD_2_8_0_top ( N145, N153, N162, N168, N172, N210, N190, 
  ...
  wire   N3803, N214_BUFF, N217_BUFF, N160_BUFF, N173_BUFF, N213_BUFF,
         ...
         \main/n5 , \main/n4 , \main/n3 , \main/n2 , \main/n1 , \perturb/n13 ,
  ...
  NAND2X0 \main/U241  ( .IN1(\main/n204 ), .IN2(N2022), .QN(\main/n193 ) );
  OA222X1 \main/U240  ( .IN1(\main/n192 ), .IN2(\main/n191 ), .IN3(\main/n192 ), .IN4(\main/n190 ), .IN5(\main/n189 ), .IN6(\main/n188 ), .Q(\main/n195 ) );
  OA221X1 \main/U239  ( .IN1(\main/n187 ), .IN2(\main/n186 ), .IN3(\main/n187 ), .IN4(\main/n185 ), .IN5(\main/n184 ), .Q(\main/n192 ) );
  NAND3X0 \main/U238  ( .IN1(N275), .IN2(\main/n191 ), .IN3(N2018), .QN(
        \main/n184 ) );
  INVX0 \main/U237  ( .INP(\main/n189 ), .ZN(\main/n191 ) );
  NOR3X0 \main/U236  ( .IN1(\main/n182 ), .IN2(\main/n181 ), .IN3(\main/n180 ), 
        .QN(\main/n186 ) );
  AO222X1 \main/U235  ( .IN1(\main/n179 ), .IN2(\main/n178 ), .IN3(\main/n179 ), .IN4(N2010), .IN5(\main/n178 ), .IN6(N2010), .Q(\main/n180 ) );
  AO222X1 \main/U234  ( .IN1(\main/n177 ), .IN2(\main/n176 ), .IN3(\main/n177 ), .IN4(\main/n175 ), .IN5(\main/n176 ), .IN6(\main/n175 ), .Q(\main/n178 ) );
  AO221X1 \main/U233  ( .IN1(\main/n174 ), .IN2(N287), .IN3(\main/n173 ), 
        .IN4(N256), .IN5(\main/n172 ), .Q(\main/n176 ) );
  MUX21X1 \main/U232  ( .IN1(N294), .IN2(N259), .S(\main/n173 ), .Q(
        \main/n177 ) );
  MUX21X1 \main/U231  ( .IN1(N297), .IN2(N263), .S(\main/n173 ), .Q(
        \main/n179 ) );
  AND3X1 \main/U230  ( .IN1(N8), .IN2(\main/n171 ), .IN3(N2014), .Q(
        \main/n181 ) );
  AND3X1 \main/U229  ( .IN1(\main/n170 ), .IN2(N8), .IN3(N2016), .Q(
        \main/n182 ) );
  AO222X1 \main/U228  ( .IN1(\main/n169 ), .IN2(\main/n168 ), .IN3(\main/n169 ), .IN4(\main/n167 ), .IN5(\main/n168 ), .IN6(\main/n167 ), .Q(\main/n187 ) );
  AO222X1 \main/U227  ( .IN1(\main/n166 ), .IN2(\main/n165 ), .IN3(\main/n166 ), .IN4(\main/n164 ), .IN5(\main/n165 ), .IN6(\main/n164 ), .Q(\main/n167 ) );
  INVX0 \main/U226  ( .INP(\main/n171 ), .ZN(\main/n165 ) );
  OA22X1 \main/U225  ( .IN1(N305), .IN2(\main/n163 ), .IN3(N269), .IN4(
        \main/n189 ), .Q(\main/n171 ) );
  NOR2X0 \main/U224  ( .IN1(N2012), .IN2(\main/n183 ), .QN(\main/n166 ) );
  MUX21X1 \main/U223  ( .IN1(N301), .IN2(N266), .S(\main/n173 ), .Q(
        \main/n183 ) );
  INVX0 \main/U222  ( .INP(\main/n170 ), .ZN(\main/n169 ) );
  OA22X1 \main/U221  ( .IN1(N309), .IN2(\main/n163 ), .IN3(N272), .IN4(
        \main/n189 ), .Q(\main/n170 ) );
  INVX0 \main/U220  ( .INP(\main/n173 ), .ZN(\main/n174 ) );
  NOR3X0 \main/U219  ( .IN1(N278), .IN2(N2020), .IN3(\main/n189 ), .QN(
        \main/n196 ) );
  ...
  AO21X1 \main/U90  ( .IN1(\main/n121 ), .IN2(N49), .IN3(\main/n37 ), .Q(N2018) );
  AO222X1 \main/U89  ( .IN1(N234), .IN2(\main/n36 ), .IN3(N234), .IN4(N74), 
        .IN5(\main/n36 ), .IN6(N87), .Q(\main/n37 ) );
  NAND4X0 \main/U88  ( .IN1(\main/n35 ), .IN2(\main/n34 ), .IN3(\main/n33 ), 
  ...
  NOR2X0 \main/U61  ( .IN1(N234), .IN2(\main/n36 ), .QN(\main/n121 ) );
  NOR2X0 \main/U60  ( .IN1(N227), .IN2(\main/n1 ), .QN(\main/n120 ) );
  NOR2X0 \main/U59  ( .IN1(\main/n36 ), .IN2(\main/n1 ), .QN(\main/n119 ) );
  INVX0 \main/U58  ( .INP(N234), .ZN(\main/n1 ) );
  INVX0 \main/U57  ( .INP(N227), .ZN(\main/n36 ) );
  ...
  FADDX1 \perturb/U9  ( .A(N309), .B(N116), .CI(\perturb/n6 ), .CO(
        \perturb/n1 ), .S(\perturb/n7 ) );
  FADDX1 \perturb/U8  ( .A(N54), .B(N43), .CI(N131), .CO(\perturb/n5 ), .S(
        \perturb/n10 ) );
  ...
  NOR2X0 \perturb/U5  ( .IN1(\perturb/n5 ), .IN2(\perturb/n3 ), .QN(
        \perturb/n11 ) );
  FADDX1 \perturb/U4  ( .A(N86), .B(N16), .CI(N114), .CO(\perturb/n2 ), .S(
        \perturb/n6 ) );
  ...
  XOR2X1 \restore/U14  ( .IN1(keyinput4), .IN2(N54), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U13  ( .IN1(keyinput1), .IN2(N86), .Q(\restore/n12 ) );
  XNOR2X1 \restore/U12  ( .IN1(keyinput3), .IN2(N114), .Q(\restore/n13 ) );
  XNOR2X1 \restore/U11  ( .IN1(keyinput5), .IN2(N116), .Q(\restore/n14 ) );
  ...
  NOR2X0 \restore/U9  ( .IN1(\restore/n9 ), .IN2(\restore/n4 ), .QN(
        \restore/n22 ) );
  XNOR2X1 \restore/U8  ( .IN1(keyinput2), .IN2(N16), .Q(\restore/n4 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput6), .IN2(N131), .Q(\restore/n1 ) );
  XNOR2X1 \restore/U6  ( .IN1(keyinput0), .IN2(N309), .Q(\restore/n2 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput7), .IN2(N43), .Q(\restore/n3 ) );
