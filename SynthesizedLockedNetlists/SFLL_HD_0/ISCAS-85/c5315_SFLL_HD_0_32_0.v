...
module c5315_SFLL_HD_0_32_0_top ( N1, N4, N11, N14, N17, N20, N23, N24, N25, 
  ...
  XNOR2X1 \main/U189  ( .IN1(\main/n160 ), .IN2(N132), .Q(\main/n251 ) );
  MUX41X1 \main/U188  ( .IN1(\main/n176 ), .IN3(\main/n251 ), .IN2(N123), 
        .IN4(\main/n212 ), .S0(N603), .S1(N599), .Q(\main/n254 ) );
  INVX0 \main/U187  ( .INP(\main/n254 ), .ZN(\main/n253 ) );
  AO21X1 \main/U186  ( .IN1(N631), .IN2(N135), .IN3(\main/n253 ), .Q(
        \main/n252 ) );
  XNOR3X1 \main/U185  ( .IN1(restore_signal), .IN2(perturb_signal), .IN3(
        \main/n252 ), .Q(N7626) );
  ...
  INVX0 \perturb/U14  ( .INP(N123), .ZN(\perturb/n11 ) );
  AND4X1 \perturb/U13  ( .IN1(N534), .IN2(N490), .IN3(N316), .IN4(
        \perturb/n11 ), .Q(\perturb/n7 ) );
  NOR4X0 \perturb/U12  ( .IN1(N307), .IN2(N2527), .IN3(N816), .IN4(N254), .QN(
        \perturb/n8 ) );
  NOR4X0 \perturb/U11  ( .IN1(N338), .IN2(N332), .IN3(N331), .IN4(N308), .QN(
        \perturb/n9 ) );
  NOR4X0 \perturb/U10  ( .IN1(N599), .IN2(N514), .IN3(N366), .IN4(N358), .QN(
        \perturb/n10 ) );
  NAND4X0 \perturb/U9  ( .IN1(\perturb/n7 ), .IN2(\perturb/n8 ), .IN3(
        \perturb/n9 ), .IN4(\perturb/n10 ), .QN(\perturb/n1 ) );
  NAND4X0 \perturb/U8  ( .IN1(N603), .IN2(N523), .IN3(N341), .IN4(N324), .QN(
        \perturb/n3 ) );
  NAND4X0 \perturb/U7  ( .IN1(N302), .IN2(N315), .IN3(N631), .IN4(N135), .QN(
        \perturb/n4 ) );
  NAND4X0 \perturb/U6  ( .IN1(N54), .IN2(N348), .IN3(N479), .IN4(N323), .QN(
        \perturb/n5 ) );
  NAND4X0 \perturb/U5  ( .IN1(N361), .IN2(N351), .IN3(N132), .IN4(N242), .QN(
        \perturb/n6 ) );
  ...
  NOR2X0 \perturb/U3  ( .IN1(\perturb/n1 ), .IN2(\perturb/n2 ), .QN(
        perturb_signal) );
  XNOR2X1 \restore/U44  ( .IN1(keyinput17), .IN2(N361), .Q(\restore/n39 ) );
  XNOR2X1 \restore/U43  ( .IN1(keyinput18), .IN2(N599), .Q(\restore/n40 ) );
  XNOR2X1 \restore/U42  ( .IN1(keyinput19), .IN2(N331), .Q(\restore/n41 ) );
  XNOR2X1 \restore/U41  ( .IN1(keyinput21), .IN2(N332), .Q(\restore/n42 ) );
  NAND4X0 \restore/U40  ( .IN1(\restore/n39 ), .IN2(\restore/n40 ), .IN3(
        \restore/n41 ), .IN4(\restore/n42 ), .QN(\restore/n23 ) );
  XNOR2X1 \restore/U39  ( .IN1(keyinput29), .IN2(N2527), .Q(\restore/n35 ) );
  XNOR2X1 \restore/U38  ( .IN1(keyinput3), .IN2(N123), .Q(\restore/n36 ) );
  XNOR2X1 \restore/U37  ( .IN1(keyinput2), .IN2(N348), .Q(\restore/n37 ) );
  XNOR2X1 \restore/U36  ( .IN1(keyinput4), .IN2(N54), .Q(\restore/n38 ) );
  NAND4X0 \restore/U35  ( .IN1(\restore/n35 ), .IN2(\restore/n36 ), .IN3(
        \restore/n37 ), .IN4(\restore/n38 ), .QN(\restore/n24 ) );
  XNOR2X1 \restore/U34  ( .IN1(keyinput25), .IN2(N351), .Q(\restore/n31 ) );
  XNOR2X1 \restore/U33  ( .IN1(keyinput28), .IN2(N132), .Q(\restore/n32 ) );
  XNOR2X1 \restore/U32  ( .IN1(keyinput27), .IN2(N254), .Q(\restore/n33 ) );
  XNOR2X1 \restore/U31  ( .IN1(keyinput26), .IN2(N242), .Q(\restore/n34 ) );
  NAND4X0 \restore/U30  ( .IN1(\restore/n31 ), .IN2(\restore/n32 ), .IN3(
        \restore/n33 ), .IN4(\restore/n34 ), .QN(\restore/n25 ) );
  XNOR2X1 \restore/U29  ( .IN1(keyinput20), .IN2(N341), .Q(\restore/n27 ) );
  XNOR2X1 \restore/U28  ( .IN1(keyinput22), .IN2(N324), .Q(\restore/n28 ) );
  XNOR2X1 \restore/U27  ( .IN1(keyinput24), .IN2(N534), .Q(\restore/n29 ) );
  XNOR2X1 \restore/U26  ( .IN1(keyinput23), .IN2(N490), .Q(\restore/n30 ) );
  ...
  XNOR2X1 \restore/U23  ( .IN1(keyinput9), .IN2(N308), .Q(\restore/n19 ) );
  XNOR2X1 \restore/U22  ( .IN1(keyinput8), .IN2(N358), .Q(\restore/n20 ) );
  XNOR2X1 \restore/U21  ( .IN1(keyinput13), .IN2(N135), .Q(\restore/n21 ) );
  XNOR2X1 \restore/U20  ( .IN1(keyinput12), .IN2(N316), .Q(\restore/n22 ) );
  NAND4X0 \restore/U19  ( .IN1(\restore/n19 ), .IN2(\restore/n20 ), .IN3(
        \restore/n21 ), .IN4(\restore/n22 ), .QN(\restore/n3 ) );
  XNOR2X1 \restore/U18  ( .IN1(keyinput5), .IN2(N514), .Q(\restore/n15 ) );
  XNOR2X1 \restore/U17  ( .IN1(keyinput6), .IN2(N338), .Q(\restore/n16 ) );
  XNOR2X1 \restore/U16  ( .IN1(keyinput7), .IN2(N302), .Q(\restore/n17 ) );
  XNOR2X1 \restore/U15  ( .IN1(keyinput10), .IN2(N315), .Q(\restore/n18 ) );
  NAND4X0 \restore/U14  ( .IN1(\restore/n15 ), .IN2(\restore/n16 ), .IN3(
        \restore/n17 ), .IN4(\restore/n18 ), .QN(\restore/n4 ) );
  XNOR2X1 \restore/U13  ( .IN1(keyinput1), .IN2(N816), .Q(\restore/n11 ) );
  XNOR2X1 \restore/U12  ( .IN1(keyinput0), .IN2(N479), .Q(\restore/n12 ) );
  XNOR2X1 \restore/U11  ( .IN1(keyinput31), .IN2(N323), .Q(\restore/n13 ) );
  XNOR2X1 \restore/U10  ( .IN1(keyinput30), .IN2(N307), .Q(\restore/n14 ) );
  NAND4X0 \restore/U9  ( .IN1(\restore/n11 ), .IN2(\restore/n12 ), .IN3(
        \restore/n13 ), .IN4(\restore/n14 ), .QN(\restore/n5 ) );
  XNOR2X1 \restore/U8  ( .IN1(keyinput11), .IN2(N631), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput16), .IN2(N523), .Q(\restore/n8 ) );
  XNOR2X1 \restore/U6  ( .IN1(keyinput15), .IN2(N366), .Q(\restore/n9 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput14), .IN2(N603), .Q(\restore/n10 ) );
