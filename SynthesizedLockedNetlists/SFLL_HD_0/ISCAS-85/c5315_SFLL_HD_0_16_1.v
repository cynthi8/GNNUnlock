...
module c5315_SFLL_HD_0_16_1_top ( N1, N4, N11, N14, N17, N20, N23, N24, N25, 
  ...
  AO222X1 \main/U225  ( .IN1(N128), .IN2(\main/n196 ), .IN3(\main/n281 ), 
        .IN4(\main/n34 ), .IN5(\main/n282 ), .IN6(\main/n32 ), .Q(\main/n258 )
         );
  ...
  AO221X1 \main/U223  ( .IN1(\main/n27 ), .IN2(\main/n13 ), .IN3(\main/n28 ), 
        .IN4(\main/n258 ), .IN5(\main/n280 ), .Q(N7516) );
  ...
  AO221X1 \main/U211  ( .IN1(\main/n22 ), .IN2(\main/n13 ), .IN3(\main/n23 ), 
        .IN4(\main/n258 ), .IN5(\main/n268 ), .Q(N7520) );
  ...
  AO221X1 \main/U199  ( .IN1(\main/n185 ), .IN2(\main/n13 ), .IN3(\main/n184 ), 
        .IN4(\main/n258 ), .IN5(\main/n262 ), .Q(N7603) );
  ...
  INVX0 \main/U192  ( .INP(N149), .ZN(\main/n255 ) );
  INVX0 \main/U191  ( .INP(\main/n258 ), .ZN(N7471) );
  AOI22X1 \main/U190  ( .IN1(\main/n13 ), .IN2(\main/n177 ), .IN3(\main/n179 ), 
        .IN4(N146), .QN(\main/n257 ) );
  OA221X1 \main/U189  ( .IN1(\main/n254 ), .IN2(\main/n255 ), .IN3(N7471), 
        .IN4(\main/n256 ), .IN5(\main/n257 ), .Q(\main/n253 ) );
  XNOR3X1 \main/U188  ( .IN1(restore_signal), .IN2(perturb_signal), .IN3(
        \main/n253 ), .Q(N7607) );
  ...
  OR4X1 \perturb/U7  ( .IN1(N400), .IN2(N389), .IN3(N598), .IN4(N514), .Q(
        \perturb/n1 ) );
  OR4X1 \perturb/U6  ( .IN1(N272), .IN2(N128), .IN3(N348), .IN4(N338), .Q(
        \perturb/n2 ) );
  NAND4X0 \perturb/U5  ( .IN1(N280), .IN2(N265), .IN3(N273), .IN4(N374), .QN(
        \perturb/n3 ) );
  NAND4X0 \perturb/U4  ( .IN1(N146), .IN2(N257), .IN3(N54), .IN4(N4), .QN(
        \perturb/n4 ) );
  NOR4X0 \perturb/U3  ( .IN1(\perturb/n1 ), .IN2(\perturb/n2 ), .IN3(
        \perturb/n3 ), .IN4(\perturb/n4 ), .QN(perturb_signal) );
  XNOR2X1 \restore/U22  ( .IN1(keyinput13), .IN2(N280), .Q(\restore/n17 ) );
  XNOR2X1 \restore/U21  ( .IN1(keyinput12), .IN2(N265), .Q(\restore/n18 ) );
  XNOR2X1 \restore/U20  ( .IN1(keyinput11), .IN2(N272), .Q(\restore/n19 ) );
  XNOR2X1 \restore/U19  ( .IN1(keyinput10), .IN2(N273), .Q(\restore/n20 ) );
  NAND4X0 \restore/U18  ( .IN1(\restore/n17 ), .IN2(\restore/n18 ), .IN3(
        \restore/n19 ), .IN4(\restore/n20 ), .QN(\restore/n1 ) );
  XNOR2X1 \restore/U17  ( .IN1(keyinput1), .IN2(N374), .Q(\restore/n13 ) );
  XNOR2X1 \restore/U16  ( .IN1(keyinput0), .IN2(N4), .Q(\restore/n14 ) );
  XNOR2X1 \restore/U15  ( .IN1(keyinput15), .IN2(N598), .Q(\restore/n15 ) );
  XNOR2X1 \restore/U14  ( .IN1(keyinput14), .IN2(N128), .Q(\restore/n16 ) );
  NAND4X0 \restore/U13  ( .IN1(\restore/n13 ), .IN2(\restore/n14 ), .IN3(
        \restore/n15 ), .IN4(\restore/n16 ), .QN(\restore/n2 ) );
  XNOR2X1 \restore/U12  ( .IN1(keyinput5), .IN2(N257), .Q(\restore/n9 ) );
  XNOR2X1 \restore/U11  ( .IN1(keyinput4), .IN2(N400), .Q(\restore/n10 ) );
  XNOR2X1 \restore/U10  ( .IN1(keyinput3), .IN2(N54), .Q(\restore/n11 ) );
  XNOR2X1 \restore/U9  ( .IN1(keyinput2), .IN2(N514), .Q(\restore/n12 ) );
  NAND4X0 \restore/U8  ( .IN1(\restore/n9 ), .IN2(\restore/n10 ), .IN3(
        \restore/n11 ), .IN4(\restore/n12 ), .QN(\restore/n3 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput8), .IN2(N348), .Q(\restore/n5 ) );
  XNOR2X1 \restore/U6  ( .IN1(keyinput7), .IN2(N389), .Q(\restore/n6 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput9), .IN2(N146), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U4  ( .IN1(keyinput6), .IN2(N338), .Q(\restore/n8 ) );
