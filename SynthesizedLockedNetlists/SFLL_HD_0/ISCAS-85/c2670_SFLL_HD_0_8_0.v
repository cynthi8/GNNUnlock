...
module c2670_SFLL_HD_0_8_0_top ( N145, N153, N162, N168, N172, N210, N190, 
  ...
  AND2X1 \main/U239  ( .IN1(N94), .IN2(N398), .Q(N1026) );
  NAND2X0 \main/U238  ( .IN1(N7), .IN2(N237), .QN(N1028) );
  INVX0 \main/U237  ( .INP(N1028), .ZN(\main/n188 ) );
  NAND2X0 \main/U236  ( .IN1(N231), .IN2(\main/n188 ), .QN(N1029) );
  NAND4X0 \main/U235  ( .IN1(N132), .IN2(N96), .IN3(N82), .IN4(N44), .QN(
        \main/n176 ) );
  NAND4X0 \main/U234  ( .IN1(N120), .IN2(N108), .IN3(N69), .IN4(N57), .QN(
        \main/n177 ) );
  NOR2X0 \main/U233  ( .IN1(\main/n176 ), .IN2(\main/n177 ), .QN(N1277) );
  NAND2X0 \main/U232  ( .IN1(N325), .IN2(\main/n188 ), .QN(N1269) );
  INVX0 \main/U231  ( .INP(N234), .ZN(\main/n187 ) );
  NOR2X0 \main/U230  ( .IN1(\main/n187 ), .IN2(N227), .QN(\main/n109 ) );
  INVX0 \main/U229  ( .INP(N227), .ZN(\main/n181 ) );
  NOR2X0 \main/U228  ( .IN1(\main/n181 ), .IN2(N234), .QN(\main/n110 ) );
  NOR2X0 \main/U227  ( .IN1(\main/n187 ), .IN2(\main/n181 ), .QN(\main/n112 )
         );
  NOR2X0 \main/U226  ( .IN1(N227), .IN2(N234), .QN(\main/n113 ) );
  AO22X1 \main/U225  ( .IN1(N78), .IN2(\main/n112 ), .IN3(N91), .IN4(
        \main/n113 ), .Q(\main/n186 ) );
  AO221X1 \main/U224  ( .IN1(N65), .IN2(\main/n109 ), .IN3(N53), .IN4(
        \main/n110 ), .IN5(\main/n186 ), .Q(N2010) );
  AO22X1 \main/U223  ( .IN1(N77), .IN2(\main/n112 ), .IN3(N90), .IN4(
        \main/n113 ), .Q(\main/n185 ) );
  AO221X1 \main/U222  ( .IN1(N64), .IN2(\main/n109 ), .IN3(N52), .IN4(
        \main/n110 ), .IN5(\main/n185 ), .Q(N2012) );
  AO22X1 \main/U221  ( .IN1(N76), .IN2(\main/n112 ), .IN3(N89), .IN4(
        \main/n113 ), .Q(\main/n184 ) );
  AO221X1 \main/U220  ( .IN1(N63), .IN2(\main/n109 ), .IN3(N51), .IN4(
        \main/n110 ), .IN5(\main/n184 ), .Q(N2014) );
  AO22X1 \main/U219  ( .IN1(N75), .IN2(\main/n112 ), .IN3(N88), .IN4(
        \main/n113 ), .Q(\main/n183 ) );
  AO221X1 \main/U218  ( .IN1(N62), .IN2(\main/n109 ), .IN3(N50), .IN4(
        \main/n110 ), .IN5(\main/n183 ), .Q(N2016) );
  AO21X1 \main/U217  ( .IN1(N49), .IN2(\main/n110 ), .IN3(\main/n109 ), .Q(
        \main/n182 ) );
  AO221X1 \main/U216  ( .IN1(N87), .IN2(\main/n181 ), .IN3(N74), .IN4(N234), 
        .IN5(\main/n182 ), .Q(N2018) );
  AO22X1 \main/U215  ( .IN1(N73), .IN2(\main/n112 ), .IN3(N86), .IN4(
        \main/n113 ), .Q(\main/n180 ) );
  AO221X1 \main/U214  ( .IN1(N61), .IN2(\main/n109 ), .IN3(N48), .IN4(
        \main/n110 ), .IN5(\main/n180 ), .Q(N2020) );
  AO22X1 \main/U213  ( .IN1(N72), .IN2(\main/n112 ), .IN3(N85), .IN4(
        \main/n113 ), .Q(\main/n179 ) );
  AO221X1 \main/U212  ( .IN1(N60), .IN2(\main/n109 ), .IN3(N47), .IN4(
        \main/n110 ), .IN5(\main/n179 ), .Q(N2022) );
  AO22X1 \main/U211  ( .IN1(N68), .IN2(\main/n112 ), .IN3(N81), .IN4(
        \main/n113 ), .Q(\main/n178 ) );
  AO221X1 \main/U210  ( .IN1(N56), .IN2(\main/n109 ), .IN3(N43), .IN4(
        \main/n110 ), .IN5(\main/n178 ), .Q(\main/n104 ) );
  INVX0 \main/U209  ( .INP(\main/n104 ), .ZN(\main/n86 ) );
  NAND2X0 \main/U208  ( .IN1(N241), .IN2(\main/n86 ), .QN(N1969) );
  AO22X1 \main/U207  ( .IN1(N325), .IN2(\main/n176 ), .IN3(N231), .IN4(
        \main/n177 ), .Q(\main/n5 ) );
  INVX0 \main/U206  ( .INP(\main/n5 ), .ZN(N1726) );
  NAND3X0 \main/U205  ( .IN1(N237), .IN2(N1726), .IN3(N224), .QN(\main/n174 )
         );
  INVX0 \main/U204  ( .INP(\main/n174 ), .ZN(\main/n175 ) );
  NAND2X0 \main/U203  ( .IN1(N36), .IN2(\main/n175 ), .QN(N1970) );
  AO21X1 \main/U202  ( .IN1(N3), .IN2(N1), .IN3(\main/n174 ), .Q(N1971) );
  AO22X1 \main/U201  ( .IN1(N79), .IN2(\main/n112 ), .IN3(N92), .IN4(
        \main/n113 ), .Q(\main/n173 ) );
  AO221X1 \main/U200  ( .IN1(N66), .IN2(\main/n109 ), .IN3(N54), .IN4(
        \main/n110 ), .IN5(\main/n173 ), .Q(\main/n106 ) );
  MUX21X1 \main/U199  ( .IN1(\main/n106 ), .IN2(N2012), .S(N246), .Q(N2387) );
  MUX21X1 \main/U198  ( .IN1(N2010), .IN2(N2014), .S(N246), .Q(N2389) );
  XOR3X1 \main/U197  ( .IN1(restore_signal), .IN2(perturb_signal), .IN3(N2389), 
        .Q(N2390) );
  OR2X1 \main/U196  ( .IN1(N230), .IN2(\main/n106 ), .Q(\main/n102 ) );
  INVX0 \main/U195  ( .INP(N241), .ZN(\main/n172 ) );
  AO21X1 \main/U194  ( .IN1(\main/n102 ), .IN2(\main/n172 ), .IN3(\main/n106 ), 
        .Q(N2496) );
  MUX21X1 \main/U193  ( .IN1(\main/n104 ), .IN2(\main/n102 ), .S(N246), .Q(
        N2643) );
  INVX0 \main/U192  ( .INP(N322), .ZN(\main/n171 ) );
  INVX0 \main/U191  ( .INP(N319), .ZN(\main/n170 ) );
  NOR2X0 \main/U190  ( .IN1(\main/n171 ), .IN2(\main/n170 ), .QN(\main/n25 )
         );
  NOR2X0 \main/U189  ( .IN1(\main/n171 ), .IN2(N319), .QN(\main/n26 ) );
  NOR2X0 \main/U188  ( .IN1(\main/n170 ), .IN2(N322), .QN(\main/n28 ) );
  NOR2X0 \main/U187  ( .IN1(N319), .IN2(N322), .QN(\main/n29 ) );
  AO22X1 \main/U186  ( .IN1(N99), .IN2(\main/n28 ), .IN3(N135), .IN4(
        \main/n29 ), .Q(\main/n169 ) );
  AO221X1 \main/U185  ( .IN1(N111), .IN2(\main/n25 ), .IN3(N123), .IN4(
        \main/n26 ), .IN5(\main/n169 ), .Q(\main/n33 ) );
  XOR2X1 \main/U184  ( .IN1(\main/n33 ), .IN2(N313), .Q(\main/n167 ) );
  ...
  INVX0 \main/U175  ( .INP(N269), .ZN(\main/n68 ) );
  XNOR2X1 \main/U174  ( .IN1(\main/n68 ), .IN2(N21), .Q(\main/n161 ) );
  ...
  INVX0 \main/U166  ( .INP(N2018), .ZN(\main/n56 ) );
  XNOR2X1 \main/U165  ( .IN1(\main/n56 ), .IN2(N275), .Q(\main/n154 ) );
  ...
  INVX0 \main/U161  ( .INP(\main/n106 ), .ZN(\main/n82 ) );
  XNOR2X1 \main/U160  ( .IN1(\main/n82 ), .IN2(N259), .Q(\main/n149 ) );
  INVX0 \main/U159  ( .INP(N2010), .ZN(\main/n75 ) );
  XNOR2X1 \main/U158  ( .IN1(\main/n75 ), .IN2(N263), .Q(\main/n150 ) );
  XNOR2X1 \main/U157  ( .IN1(\main/n86 ), .IN2(N256), .Q(\main/n151 ) );
  ...
  AO22X1 \main/U141  ( .IN1(N102), .IN2(\main/n28 ), .IN3(N138), .IN4(
        \main/n29 ), .Q(\main/n133 ) );
  AO221X1 \main/U140  ( .IN1(N114), .IN2(\main/n25 ), .IN3(N126), .IN4(
        \main/n26 ), .IN5(\main/n133 ), .Q(\main/n24 ) );
  INVX0 \main/U139  ( .INP(\main/n24 ), .ZN(N1818) );
  XNOR2X1 \main/U138  ( .IN1(N1818), .IN2(N301), .Q(\main/n128 ) );
  AO22X1 \main/U137  ( .IN1(N104), .IN2(\main/n28 ), .IN3(N140), .IN4(
        \main/n29 ), .Q(\main/n132 ) );
  AO221X1 \main/U136  ( .IN1(N116), .IN2(\main/n25 ), .IN3(N128), .IN4(
        \main/n26 ), .IN5(\main/n132 ), .Q(\main/n23 ) );
  XOR2X1 \main/U135  ( .IN1(\main/n23 ), .IN2(N294), .Q(\main/n129 ) );
  AO22X1 \main/U134  ( .IN1(N105), .IN2(\main/n28 ), .IN3(N141), .IN4(
        \main/n29 ), .Q(\main/n131 ) );
  AO221X1 \main/U133  ( .IN1(N117), .IN2(\main/n25 ), .IN3(N129), .IN4(
        \main/n26 ), .IN5(\main/n131 ), .Q(\main/n20 ) );
  XOR2X1 \main/U132  ( .IN1(\main/n20 ), .IN2(N287), .Q(\main/n130 ) );
  NAND4X0 \main/U131  ( .IN1(\main/n128 ), .IN2(\main/n129 ), .IN3(\main/n130 ), .IN4(\main/n33 ), .QN(\main/n118 ) );
  AO22X1 \main/U130  ( .IN1(N95), .IN2(\main/n28 ), .IN3(N131), .IN4(
        \main/n29 ), .Q(\main/n127 ) );
  AO221X1 \main/U129  ( .IN1(N107), .IN2(\main/n25 ), .IN3(N119), .IN4(
        \main/n26 ), .IN5(\main/n127 ), .Q(\main/n32 ) );
  XOR2X1 \main/U128  ( .IN1(\main/n32 ), .IN2(N284), .Q(\main/n120 ) );
  AO22X1 \main/U127  ( .IN1(N103), .IN2(\main/n28 ), .IN3(N139), .IN4(
        \main/n29 ), .Q(\main/n126 ) );
  AO221X1 \main/U126  ( .IN1(N115), .IN2(\main/n25 ), .IN3(N127), .IN4(
        \main/n26 ), .IN5(\main/n126 ), .Q(\main/n30 ) );
  XOR2X1 \main/U125  ( .IN1(\main/n30 ), .IN2(N297), .Q(\main/n121 ) );
  AO22X1 \main/U124  ( .IN1(N100), .IN2(\main/n28 ), .IN3(N136), .IN4(
        \main/n29 ), .Q(\main/n125 ) );
  AOI221X1 \main/U123  ( .IN1(N112), .IN2(\main/n25 ), .IN3(N124), .IN4(
        \main/n26 ), .IN5(\main/n125 ), .QN(N1817) );
  XNOR2X1 \main/U122  ( .IN1(N1817), .IN2(N309), .Q(\main/n122 ) );
  AO22X1 \main/U121  ( .IN1(N101), .IN2(\main/n28 ), .IN3(N137), .IN4(
        \main/n29 ), .Q(\main/n124 ) );
  AOI221X1 \main/U120  ( .IN1(N113), .IN2(\main/n25 ), .IN3(N125), .IN4(
        \main/n26 ), .IN5(\main/n124 ), .QN(N1816) );
  ...
  AO221X1 \main/U112  ( .IN1(N67), .IN2(\main/n109 ), .IN3(N55), .IN4(
        \main/n110 ), .IN5(\main/n111 ), .Q(\main/n100 ) );
  XNOR3X1 \main/U111  ( .IN1(\main/n106 ), .IN2(\main/n86 ), .IN3(\main/n102 ), 
        .Q(\main/n108 ) );
  NOR2X0 \main/U110  ( .IN1(N241), .IN2(\main/n108 ), .QN(\main/n107 ) );
  XOR2X1 \main/U109  ( .IN1(\main/n100 ), .IN2(\main/n107 ), .Q(N3546) );
  XNOR2X1 \main/U108  ( .IN1(\main/n106 ), .IN2(\main/n100 ), .Q(\main/n105 )
         );
  XOR3X1 \main/U107  ( .IN1(\main/n75 ), .IN2(\main/n104 ), .IN3(\main/n105 ), 
        .Q(\main/n10 ) );
  XNOR2X1 \main/U106  ( .IN1(N1819), .IN2(\main/n56 ), .Q(\main/n103 ) );
  XOR3X1 \main/U105  ( .IN1(N2022), .IN2(N2020), .IN3(\main/n103 ), .Q(
        \main/n9 ) );
  XNOR3X1 \main/U104  ( .IN1(\main/n102 ), .IN2(\main/n10 ), .IN3(\main/n9 ), 
        .Q(\main/n101 ) );
  ...
  OR4X1 \perturb/U5  ( .IN1(N63), .IN2(N53), .IN3(N91), .IN4(N76), .Q(
        \perturb/n1 ) );
  NAND2X0 \perturb/U4  ( .IN1(N78), .IN2(N65), .QN(\perturb/n2 ) );
  NOR4X0 \perturb/U3  ( .IN1(\perturb/n1 ), .IN2(\perturb/n2 ), .IN3(N51), 
        .IN4(N234), .QN(perturb_signal) );
  XNOR2X1 \restore/U12  ( .IN1(keyinput0), .IN2(N63), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U11  ( .IN1(keyinput6), .IN2(N78), .Q(\restore/n8 ) );
  XNOR2X1 \restore/U10  ( .IN1(keyinput5), .IN2(N53), .Q(\restore/n9 ) );
  XNOR2X1 \restore/U9  ( .IN1(keyinput7), .IN2(N91), .Q(\restore/n10 ) );
  NAND4X0 \restore/U8  ( .IN1(\restore/n7 ), .IN2(\restore/n8 ), .IN3(
        \restore/n9 ), .IN4(\restore/n10 ), .QN(\restore/n1 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput4), .IN2(N234), .Q(\restore/n3 ) );
  XNOR2X1 \restore/U6  ( .IN1(keyinput3), .IN2(N51), .Q(\restore/n4 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput2), .IN2(N76), .Q(\restore/n5 ) );
  XNOR2X1 \restore/U4  ( .IN1(keyinput1), .IN2(N65), .Q(\restore/n6 ) );
