...
module c2670_SFLL_HD_0_8_0_top ( N145, N153, N162, N168, N172, N210, N190, 
  ...
  MUX21X1 \main/U158  ( .IN1(\main/n100 ), .IN2(\main/n95 ), .S(N246), .Q(
        N3803) );
  MUX21X1 \main/U157  ( .IN1(\main/n94 ), .IN2(\main/n93 ), .S(\main/n92 ), 
        .Q(\main/n95 ) );
  NAND3X0 \main/U156  ( .IN1(N1726), .IN2(\main/n91 ), .IN3(\main/n149 ), .QN(
        N3882) );
  XNOR3X1 \main/U155  ( .IN1(\main/n89 ), .IN2(N340), .IN3(N343), .Q(
        \main/n90 ) );
  XNOR3X1 \main/U154  ( .IN1(N334), .IN2(N337), .IN3(\main/n88 ), .Q(
        \main/n89 ) );
  XNOR3X1 \main/U153  ( .IN1(N349), .IN2(N346), .IN3(\main/n87 ), .Q(
        \main/n88 ) );
  MUX21X1 \main/U152  ( .IN1(N259), .IN2(\main/n154 ), .S(\main/n86 ), .Q(
        \main/n87 ) );
  XOR3X1 \main/U151  ( .IN1(N256), .IN2(N331), .IN3(N328), .Q(\main/n86 ) );
  INVX0 \main/U150  ( .INP(N259), .ZN(\main/n154 ) );
  NOR4X0 \main/U149  ( .IN1(N3671), .IN2(N3809), .IN3(N2971), .IN4(N2970), 
        .QN(\main/n91 ) );
  NOR2X0 \main/U148  ( .IN1(\main/n85 ), .IN2(N37), .QN(N3809) );
  XOR3X1 \main/U147  ( .IN1(\main/n92 ), .IN2(N1820), .IN3(N1821), .Q(
        \main/n85 ) );
  XNOR3X1 \main/U146  ( .IN1(N2020), .IN2(N2018), .IN3(\main/n84 ), .Q(
        \main/n92 ) );
  XOR3X1 \main/U145  ( .IN1(\main/n156 ), .IN2(\main/n153 ), .IN3(\main/n83 ), 
        .Q(\main/n84 ) );
  XOR3X1 \main/U144  ( .IN1(N2016), .IN2(\main/n82 ), .IN3(N2022), .Q(
        \main/n83 ) );
  MUX21X1 \main/U143  ( .IN1(N2010), .IN2(\main/n150 ), .S(\main/n100 ), .Q(
        \main/n82 ) );
  NAND4X0 \main/U142  ( .IN1(\main/n81 ), .IN2(\main/n80 ), .IN3(\main/n79 ), 
        .IN4(\main/n78 ), .QN(\main/n100 ) );
  INVX0 \main/U141  ( .INP(N2010), .ZN(\main/n150 ) );
  NOR2X0 \main/U140  ( .IN1(\main/n73 ), .IN2(N37), .QN(N3671) );
  XOR3X1 \main/U139  ( .IN1(\main/n72 ), .IN2(\main/n146 ), .IN3(\main/n189 ), 
        .Q(\main/n73 ) );
  NOR2X0 \main/U138  ( .IN1(\main/n71 ), .IN2(\main/n70 ), .QN(\main/n189 ) );
  AO22X1 \main/U137  ( .IN1(\main/n69 ), .IN2(N140), .IN3(\main/n68 ), .IN4(
        N128), .Q(\main/n70 ) );
  AO22X1 \main/U136  ( .IN1(\main/n67 ), .IN2(N104), .IN3(\main/n66 ), .IN4(
        N116), .Q(\main/n71 ) );
  INVX0 \main/U135  ( .INP(\main/n197 ), .ZN(\main/n146 ) );
  NAND4X0 \main/U134  ( .IN1(\main/n65 ), .IN2(\main/n64 ), .IN3(\main/n63 ), 
        .IN4(\main/n62 ), .QN(\main/n197 ) );
  XNOR3X1 \main/U133  ( .IN1(\main/n191 ), .IN2(N1817), .IN3(\main/n61 ), .Q(
        \main/n72 ) );
  XNOR3X1 \main/U132  ( .IN1(N1818), .IN2(N1816), .IN3(\main/n60 ), .Q(
        \main/n61 ) );
  XNOR3X1 \main/U131  ( .IN1(\main/n103 ), .IN2(\main/n59 ), .IN3(\main/n134 ), 
        .Q(\main/n60 ) );
  ...
  AO22X1 \main/U127  ( .IN1(\main/n67 ), .IN2(N106), .IN3(\main/n66 ), .IN4(
        N118), .Q(\main/n54 ) );
  NOR2X0 \main/U126  ( .IN1(\main/n52 ), .IN2(\main/n51 ), .QN(\main/n103 ) );
  AO22X1 \main/U125  ( .IN1(\main/n69 ), .IN2(N141), .IN3(\main/n68 ), .IN4(
        N129), .Q(\main/n51 ) );
  AO22X1 \main/U124  ( .IN1(\main/n67 ), .IN2(N105), .IN3(\main/n66 ), .IN4(
        N117), .Q(\main/n52 ) );
  NOR2X0 \main/U123  ( .IN1(\main/n50 ), .IN2(\main/n49 ), .QN(\main/n191 ) );
  ...
  MUX21X1 \main/U118  ( .IN1(\main/n152 ), .IN2(\main/n94 ), .S(N246), .Q(
        N2643) );
  INVX0 \main/U117  ( .INP(\main/n93 ), .ZN(\main/n94 ) );
  NOR2X0 \main/U116  ( .IN1(N230), .IN2(\main/n156 ), .QN(\main/n93 ) );
  NAND4X0 \main/U115  ( .IN1(\main/n48 ), .IN2(\main/n47 ), .IN3(\main/n46 ), 
        .IN4(\main/n45 ), .QN(\main/n156 ) );
  AND2X1 \main/U114  ( .IN1(N398), .IN2(N94), .Q(N1026) );
  NAND3X0 \main/U113  ( .IN1(N237), .IN2(N15), .IN3(N2), .QN(N799) );
  AOI22X1 \main/U112  ( .IN1(N231), .IN2(\main/n147 ), .IN3(N325), .IN4(
        \main/n148 ), .QN(N1726) );
  NAND4X0 \main/U111  ( .IN1(N44), .IN2(N82), .IN3(N96), .IN4(N132), .QN(
        \main/n148 ) );
  NAND4X0 \main/U110  ( .IN1(N57), .IN2(N69), .IN3(N108), .IN4(N120), .QN(
        \main/n147 ) );
  XOR3X1 \main/U109  ( .IN1(\main/n172 ), .IN2(N266), .IN3(\main/n44 ), .Q(
        N2971) );
  XOR3X1 \main/U108  ( .IN1(\main/n151 ), .IN2(N284), .IN3(\main/n43 ), .Q(
        \main/n44 ) );
  XNOR3X1 \main/U107  ( .IN1(N278), .IN2(\main/n42 ), .IN3(\main/n41 ), .Q(
        \main/n43 ) );
  XOR3X1 \main/U106  ( .IN1(N272), .IN2(N269), .IN3(N275), .Q(\main/n41 ) );
  MUX21X1 \main/U105  ( .IN1(N287), .IN2(\main/n180 ), .S(N352), .Q(\main/n42 ) );
  INVX0 \main/U104  ( .INP(N287), .ZN(\main/n180 ) );
  INVX0 \main/U103  ( .INP(N263), .ZN(\main/n151 ) );
  INVX0 \main/U102  ( .INP(N281), .ZN(\main/n172 ) );
  XOR3X1 \main/U101  ( .IN1(\main/n190 ), .IN2(N297), .IN3(\main/n40 ), .Q(
        N2970) );
  XOR3X1 \main/U100  ( .IN1(\main/n193 ), .IN2(N301), .IN3(\main/n39 ), .Q(
        \main/n40 ) );
  XOR3X1 \main/U99  ( .IN1(\main/n38 ), .IN2(N316), .IN3(\main/n145 ), .Q(
        \main/n39 ) );
  INVX0 \main/U98  ( .INP(N313), .ZN(\main/n145 ) );
  MUX21X1 \main/U97  ( .IN1(N305), .IN2(\main/n200 ), .S(N355), .Q(\main/n38 )
         );
  INVX0 \main/U96  ( .INP(N305), .ZN(\main/n200 ) );
  INVX0 \main/U95  ( .INP(N309), .ZN(\main/n193 ) );
  INVX0 \main/U94  ( .INP(N294), .ZN(\main/n190 ) );
  XOR3X1 \main/U93  ( .IN1(N2389), .IN2(perturb_signal), .IN3(restore_signal), 
        .Q(N2390) );
  MUX21X1 \main/U92  ( .IN1(N2010), .IN2(N2014), .S(N246), .Q(N2389) );
  ...
  NAND2X0 \main/U49  ( .IN1(\main/n74 ), .IN2(N91), .QN(\main/n37 ) );
  ...
  NAND2X0 \main/U33  ( .IN1(\main/n74 ), .IN2(N88), .QN(\main/n13 ) );
  ...
  NAND2X0 \main/U29  ( .IN1(\main/n74 ), .IN2(N85), .QN(\main/n5 ) );
  NAND2X0 \main/U28  ( .IN1(\main/n76 ), .IN2(N63), .QN(\main/n7 ) );
  NAND2X0 \main/U27  ( .IN1(\main/n75 ), .IN2(N76), .QN(\main/n8 ) );
  NAND2X0 \main/U26  ( .IN1(\main/n74 ), .IN2(N89), .QN(\main/n9 ) );
  NAND2X0 \main/U25  ( .IN1(\main/n76 ), .IN2(N65), .QN(\main/n35 ) );
  NAND2X0 \main/U24  ( .IN1(\main/n75 ), .IN2(N78), .QN(\main/n36 ) );
  NAND2X0 \main/U23  ( .IN1(\main/n77 ), .IN2(N53), .QN(\main/n34 ) );
  NAND2X0 \main/U22  ( .IN1(\main/n76 ), .IN2(N61), .QN(\main/n15 ) );
  NAND2X0 \main/U21  ( .IN1(\main/n75 ), .IN2(N73), .QN(\main/n16 ) );
  NAND2X0 \main/U20  ( .IN1(\main/n74 ), .IN2(N86), .QN(\main/n17 ) );
  NAND2X0 \main/U19  ( .IN1(\main/n76 ), .IN2(N62), .QN(\main/n11 ) );
  NAND2X0 \main/U18  ( .IN1(\main/n75 ), .IN2(N80), .QN(\main/n80 ) );
  NAND2X0 \main/U17  ( .IN1(\main/n74 ), .IN2(N93), .QN(\main/n81 ) );
  ...
  NAND2X0 \main/U10  ( .IN1(\main/n74 ), .IN2(N81), .QN(\main/n30 ) );
  ...
  NOR3X0 \perturb/U5  ( .IN1(N234), .IN2(N76), .IN3(\perturb/n2 ), .QN(
        perturb_signal) );
  NAND3X0 \perturb/U4  ( .IN1(N78), .IN2(N65), .IN3(\perturb/n1 ), .QN(
        \perturb/n2 ) );
  NOR4X0 \perturb/U3  ( .IN1(N91), .IN2(N63), .IN3(N51), .IN4(N53), .QN(
        \perturb/n1 ) );
  ...
  XNOR2X1 \restore/U10  ( .IN1(keyinput7), .IN2(N91), .Q(\restore/n5 ) );
  XNOR2X1 \restore/U9  ( .IN1(keyinput0), .IN2(N63), .Q(\restore/n6 ) );
  XNOR2X1 \restore/U8  ( .IN1(keyinput2), .IN2(N76), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput4), .IN2(N234), .Q(\restore/n8 ) );
  NAND4X0 \restore/U6  ( .IN1(\restore/n4 ), .IN2(\restore/n3 ), .IN3(
        \restore/n2 ), .IN4(\restore/n1 ), .QN(\restore/n10 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput1), .IN2(N65), .Q(\restore/n1 ) );
  XNOR2X1 \restore/U4  ( .IN1(keyinput3), .IN2(N51), .Q(\restore/n2 ) );
  XNOR2X1 \restore/U3  ( .IN1(keyinput5), .IN2(N53), .Q(\restore/n3 ) );
  XNOR2X1 \restore/U2  ( .IN1(keyinput6), .IN2(N78), .Q(\restore/n4 ) );
endmodule
