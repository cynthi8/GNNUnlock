...
module c3540_SFLL_HD_0_8_0_top ( N1, N13, N20, N33, N41, N45, N50, N58, N68, 
  ...
  XOR3X1 \main/U1  ( .IN1(\main/n1 ), .IN2(\main/n2 ), .IN3(\main/n3 ), .Q(
        N5360) );
  NAND4X0 \perturb/U6  ( .IN1(N87), .IN2(N311), .IN3(N116), .IN4(N41), .QN(
        \perturb/n1 ) );
  INVX0 \perturb/U5  ( .INP(N190), .ZN(\perturb/n3 ) );
  NAND2X0 \perturb/U4  ( .IN1(N200), .IN2(\perturb/n3 ), .QN(\perturb/n2 ) );
  NOR4X0 \perturb/U3  ( .IN1(\perturb/n1 ), .IN2(\perturb/n2 ), .IN3(N326), 
        .IN4(N274), .QN(perturb_signal) );
  XNOR2X1 \restore/U12  ( .IN1(keyinput0), .IN2(N200), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U11  ( .IN1(keyinput6), .IN2(N190), .Q(\restore/n8 ) );
  XNOR2X1 \restore/U10  ( .IN1(keyinput5), .IN2(N116), .Q(\restore/n9 ) );
  XNOR2X1 \restore/U9  ( .IN1(keyinput7), .IN2(N311), .Q(\restore/n10 ) );
  NAND4X0 \restore/U8  ( .IN1(\restore/n7 ), .IN2(\restore/n8 ), .IN3(
        \restore/n9 ), .IN4(\restore/n10 ), .QN(\restore/n1 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput4), .IN2(N87), .Q(\restore/n3 ) );
  XNOR2X1 \restore/U6  ( .IN1(keyinput3), .IN2(N41), .Q(\restore/n4 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput2), .IN2(N326), .Q(\restore/n5 ) );
  XNOR2X1 \restore/U4  ( .IN1(keyinput1), .IN2(N274), .Q(\restore/n6 ) );
