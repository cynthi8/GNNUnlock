...
module c5315_SFLL_HD_0_8_2_top ( N1, N4, N11, N14, N17, N20, N23, N24, N25, 
  ...
  AO22X1 \main/U142  ( .IN1(\main/n27 ), .IN2(N46), .IN3(\main/n26 ), .IN4(N49), .Q(\main/n196 ) );
  AOI221X1 \main/U141  ( .IN1(\main/n6 ), .IN2(\main/n24 ), .IN3(\main/n15 ), 
        .IN4(\main/n23 ), .IN5(\main/n196 ), .QN(\main/n195 ) );
  XNOR3X1 \main/U140  ( .IN1(restore_signal), .IN2(perturb_signal), .IN3(
        \main/n195 ), .Q(N7740) );
  ...
  OR4X1 \perturb/U5  ( .IN1(N331), .IN2(N281), .IN3(N490), .IN4(N479), .Q(
        \perturb/n1 ) );
  NAND4X0 \perturb/U4  ( .IN1(N597), .IN2(N595), .IN3(N358), .IN4(N316), .QN(
        \perturb/n2 ) );
  NOR2X0 \perturb/U3  ( .IN1(\perturb/n1 ), .IN2(\perturb/n2 ), .QN(
        perturb_signal) );
  XNOR2X1 \restore/U12  ( .IN1(keyinput0), .IN2(N331), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U11  ( .IN1(keyinput6), .IN2(N358), .Q(\restore/n8 ) );
  XNOR2X1 \restore/U10  ( .IN1(keyinput5), .IN2(N479), .Q(\restore/n9 ) );
  XNOR2X1 \restore/U9  ( .IN1(keyinput7), .IN2(N597), .Q(\restore/n10 ) );
  NAND4X0 \restore/U8  ( .IN1(\restore/n7 ), .IN2(\restore/n8 ), .IN3(
        \restore/n9 ), .IN4(\restore/n10 ), .QN(\restore/n1 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput4), .IN2(N316), .Q(\restore/n3 ) );
  XNOR2X1 \restore/U6  ( .IN1(keyinput3), .IN2(N490), .Q(\restore/n4 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput2), .IN2(N595), .Q(\restore/n5 ) );
