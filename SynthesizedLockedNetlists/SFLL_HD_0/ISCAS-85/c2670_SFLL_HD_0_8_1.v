...
module c2670_SFLL_HD_0_8_1_top ( N145, N153, N162, N168, N172, N210, N190, 
  ...
  XOR3X1 \main/U160  ( .IN1(\main/n103 ), .IN2(perturb_signal), .IN3(
        restore_signal), .Q(N3671) );
  AO21X1 \main/U159  ( .IN1(N230), .IN2(\main/n102 ), .IN3(\main/n156 ), .Q(
        N2496) );
  INVX0 \main/U158  ( .INP(N241), .ZN(\main/n102 ) );
  MUX21X1 \main/U157  ( .IN1(\main/n101 ), .IN2(\main/n100 ), .S(\main/n99 ), 
        .Q(N3546) );
  NOR2X0 \main/U156  ( .IN1(N241), .IN2(\main/n98 ), .QN(\main/n99 ) );
  MUX21X1 \main/U155  ( .IN1(\main/n155 ), .IN2(\main/n154 ), .S(\main/n97 ), 
        .Q(\main/n98 ) );
  MUX21X1 \main/U154  ( .IN1(\main/n156 ), .IN2(N2012), .S(N246), .Q(N2387) );
  MUX21X1 \main/U153  ( .IN1(\main/n101 ), .IN2(\main/n96 ), .S(N246), .Q(
        N3803) );
  MUX21X1 \main/U152  ( .IN1(\main/n95 ), .IN2(\main/n94 ), .S(\main/n93 ), 
        .Q(\main/n96 ) );
  NAND3X0 \main/U151  ( .IN1(N1726), .IN2(\main/n92 ), .IN3(\main/n151 ), .QN(
        N3882) );
  XNOR3X1 \main/U150  ( .IN1(\main/n90 ), .IN2(N340), .IN3(N343), .Q(
        \main/n91 ) );
  XNOR3X1 \main/U149  ( .IN1(N334), .IN2(N337), .IN3(\main/n89 ), .Q(
        \main/n90 ) );
  XNOR3X1 \main/U148  ( .IN1(N349), .IN2(N346), .IN3(\main/n88 ), .Q(
        \main/n89 ) );
  MUX21X1 \main/U147  ( .IN1(N259), .IN2(\main/n87 ), .S(\main/n86 ), .Q(
        \main/n88 ) );
  XOR3X1 \main/U146  ( .IN1(N256), .IN2(N331), .IN3(N328), .Q(\main/n86 ) );
  INVX0 \main/U145  ( .INP(N259), .ZN(\main/n87 ) );
  NOR4X0 \main/U144  ( .IN1(N3809), .IN2(\main/n103 ), .IN3(N2971), .IN4(N2970), .QN(\main/n92 ) );
  NOR2X0 \main/U143  ( .IN1(\main/n85 ), .IN2(N37), .QN(\main/n103 ) );
  XOR3X1 \main/U142  ( .IN1(N1817), .IN2(\main/n200 ), .IN3(\main/n84 ), .Q(
        \main/n85 ) );
  XNOR3X1 \main/U141  ( .IN1(N1818), .IN2(\main/n83 ), .IN3(\main/n197 ), .Q(
        \main/n84 ) );
  NAND4X0 \main/U140  ( .IN1(\main/n82 ), .IN2(\main/n81 ), .IN3(\main/n80 ), 
        .IN4(\main/n79 ), .QN(\main/n197 ) );
  XNOR3X1 \main/U139  ( .IN1(N1816), .IN2(\main/n192 ), .IN3(\main/n74 ), .Q(
        \main/n83 ) );
  XOR3X1 \main/U138  ( .IN1(\main/n73 ), .IN2(\main/n105 ), .IN3(\main/n136 ), 
        .Q(\main/n74 ) );
  NAND4X0 \main/U137  ( .IN1(\main/n72 ), .IN2(\main/n71 ), .IN3(\main/n70 ), 
        .IN4(\main/n69 ), .QN(\main/n136 ) );
  NOR2X0 \main/U136  ( .IN1(\main/n68 ), .IN2(\main/n67 ), .QN(\main/n105 ) );
  AO22X1 \main/U135  ( .IN1(\main/n75 ), .IN2(N141), .IN3(\main/n76 ), .IN4(
        N129), .Q(\main/n67 ) );
  AO22X1 \main/U134  ( .IN1(\main/n77 ), .IN2(N105), .IN3(\main/n78 ), .IN4(
        N117), .Q(\main/n68 ) );
  NOR2X0 \main/U133  ( .IN1(\main/n66 ), .IN2(\main/n65 ), .QN(\main/n73 ) );
  AO22X1 \main/U132  ( .IN1(\main/n75 ), .IN2(N142), .IN3(\main/n76 ), .IN4(
        N130), .Q(\main/n65 ) );
  AO22X1 \main/U131  ( .IN1(\main/n77 ), .IN2(N106), .IN3(\main/n78 ), .IN4(
        N118), .Q(\main/n66 ) );
  NOR2X0 \main/U130  ( .IN1(\main/n64 ), .IN2(\main/n63 ), .QN(\main/n192 ) );
  AO22X1 \main/U129  ( .IN1(\main/n75 ), .IN2(N139), .IN3(\main/n76 ), .IN4(
        N127), .Q(\main/n63 ) );
  AO22X1 \main/U128  ( .IN1(\main/n77 ), .IN2(N103), .IN3(\main/n78 ), .IN4(
        N115), .Q(\main/n64 ) );
  NOR2X0 \main/U127  ( .IN1(\main/n62 ), .IN2(\main/n61 ), .QN(\main/n200 ) );
  AO22X1 \main/U126  ( .IN1(\main/n75 ), .IN2(N140), .IN3(\main/n76 ), .IN4(
        N128), .Q(\main/n61 ) );
  AO22X1 \main/U125  ( .IN1(\main/n77 ), .IN2(N104), .IN3(\main/n78 ), .IN4(
        N116), .Q(\main/n62 ) );
  XNOR3X1 \main/U124  ( .IN1(N305), .IN2(N301), .IN3(\main/n60 ), .Q(N2970) );
  XNOR3X1 \main/U123  ( .IN1(N309), .IN2(N297), .IN3(\main/n59 ), .Q(
        \main/n60 ) );
  XNOR3X1 \main/U122  ( .IN1(\main/n58 ), .IN2(N316), .IN3(N313), .Q(
        \main/n59 ) );
  MUX21X1 \main/U121  ( .IN1(N294), .IN2(\main/n201 ), .S(N355), .Q(\main/n58 ) );
  INVX0 \main/U120  ( .INP(N294), .ZN(\main/n201 ) );
  XNOR3X1 \main/U119  ( .IN1(N281), .IN2(N266), .IN3(\main/n57 ), .Q(N2971) );
  XNOR3X1 \main/U118  ( .IN1(N263), .IN2(N284), .IN3(\main/n56 ), .Q(
        \main/n57 ) );
  XNOR3X1 \main/U117  ( .IN1(N278), .IN2(\main/n55 ), .IN3(\main/n54 ), .Q(
        \main/n56 ) );
  XOR3X1 \main/U116  ( .IN1(N272), .IN2(N269), .IN3(N275), .Q(\main/n54 ) );
  MUX21X1 \main/U115  ( .IN1(N287), .IN2(\main/n181 ), .S(N352), .Q(\main/n55 ) );
  INVX0 \main/U114  ( .INP(N287), .ZN(\main/n181 ) );
  NOR2X0 \main/U113  ( .IN1(\main/n53 ), .IN2(N37), .QN(N3809) );
  XNOR3X1 \main/U112  ( .IN1(\main/n93 ), .IN2(N2014), .IN3(N1821), .Q(
        \main/n53 ) );
  XNOR3X1 \main/U111  ( .IN1(N2020), .IN2(N2018), .IN3(\main/n52 ), .Q(
        \main/n93 ) );
  XNOR3X1 \main/U110  ( .IN1(\main/n157 ), .IN2(\main/n155 ), .IN3(\main/n51 ), 
        .Q(\main/n52 ) );
  XNOR3X1 \main/U109  ( .IN1(N1819), .IN2(\main/n50 ), .IN3(N2022), .Q(
        \main/n51 ) );
  MUX21X1 \main/U108  ( .IN1(\main/n152 ), .IN2(N2010), .S(\main/n100 ), .Q(
        \main/n50 ) );
  INVX0 \main/U107  ( .INP(\main/n101 ), .ZN(\main/n100 ) );
  NAND4X0 \main/U106  ( .IN1(\main/n49 ), .IN2(\main/n48 ), .IN3(\main/n47 ), 
        .IN4(\main/n46 ), .QN(\main/n101 ) );
  INVX0 \main/U105  ( .INP(N2010), .ZN(\main/n152 ) );
  INVX0 \main/U104  ( .INP(\main/n156 ), .ZN(\main/n157 ) );
  INVX0 \main/U103  ( .INP(N2014), .ZN(N1820) );
  INVX0 \main/U102  ( .INP(N2016), .ZN(N1819) );
  MUX21X1 \main/U101  ( .IN1(\main/n154 ), .IN2(\main/n95 ), .S(N246), .Q(
        N2643) );
  INVX0 \main/U100  ( .INP(\main/n94 ), .ZN(\main/n95 ) );
  NOR2X0 \main/U99  ( .IN1(N230), .IN2(\main/n156 ), .QN(\main/n94 ) );
  NAND4X0 \main/U98  ( .IN1(\main/n41 ), .IN2(\main/n40 ), .IN3(\main/n39 ), 
        .IN4(\main/n38 ), .QN(\main/n156 ) );
  MUX21X1 \main/U97  ( .IN1(N2010), .IN2(N2014), .S(N246), .Q(N2389) );
  ...
  AOI22X1 \main/U93  ( .IN1(N231), .IN2(\main/n149 ), .IN3(N325), .IN4(
        \main/n150 ), .QN(N1726) );
  ...
  AO22X1 \main/U83  ( .IN1(\main/n75 ), .IN2(N136), .IN3(\main/n76 ), .IN4(
        N124), .Q(\main/n25 ) );
  AO22X1 \main/U82  ( .IN1(\main/n77 ), .IN2(N100), .IN3(\main/n78 ), .IN4(
        N112), .Q(\main/n26 ) );
  NOR2X0 \main/U81  ( .IN1(\main/n24 ), .IN2(\main/n23 ), .QN(N1818) );
  AO22X1 \main/U80  ( .IN1(\main/n75 ), .IN2(N138), .IN3(\main/n76 ), .IN4(
        N126), .Q(\main/n23 ) );
  AO22X1 \main/U79  ( .IN1(\main/n77 ), .IN2(N102), .IN3(\main/n78 ), .IN4(
        N114), .Q(\main/n24 ) );
  NOR2X0 \main/U78  ( .IN1(\main/n22 ), .IN2(\main/n21 ), .QN(N1816) );
  AO22X1 \main/U77  ( .IN1(\main/n75 ), .IN2(N137), .IN3(\main/n76 ), .IN4(
        N125), .Q(\main/n21 ) );
  NOR2X0 \main/U76  ( .IN1(N319), .IN2(\main/n20 ), .QN(\main/n76 ) );
  NOR2X0 \main/U75  ( .IN1(N319), .IN2(N322), .QN(\main/n75 ) );
  AO22X1 \main/U74  ( .IN1(\main/n77 ), .IN2(N101), .IN3(\main/n78 ), .IN4(
        N113), .Q(\main/n22 ) );
  AND2X1 \main/U73  ( .IN1(N319), .IN2(N322), .Q(\main/n78 ) );
  AND2X1 \main/U72  ( .IN1(\main/n20 ), .IN2(N319), .Q(\main/n77 ) );
  ...
  NAND2X0 \main/U52  ( .IN1(N14), .IN2(\main/n91 ), .QN(\main/n151 ) );
  NAND2X0 \main/U51  ( .IN1(\main/n45 ), .IN2(N51), .QN(\main/n6 ) );
  NAND2X0 \main/U50  ( .IN1(N11), .IN2(\main/n212 ), .QN(\main/n213 ) );
  NAND2X0 \main/U49  ( .IN1(\main/n45 ), .IN2(N53), .QN(\main/n34 ) );
  NAND2X0 \main/U48  ( .IN1(\main/n45 ), .IN2(N48), .QN(\main/n14 ) );
  NAND2X0 \main/U47  ( .IN1(\main/n43 ), .IN2(N79), .QN(\main/n40 ) );
  ...
  NAND2X0 \main/U43  ( .IN1(\main/n78 ), .IN2(N111), .QN(\main/n79 ) );
  NAND2X0 \main/U42  ( .IN1(N284), .IN2(\main/n136 ), .QN(\main/n205 ) );
  NAND2X0 \main/U41  ( .IN1(\main/n157 ), .IN2(N230), .QN(\main/n97 ) );
  ...
  NAND2X0 \main/U34  ( .IN1(\main/n42 ), .IN2(N88), .QN(\main/n13 ) );
  NAND2X0 \main/U33  ( .IN1(\main/n43 ), .IN2(N75), .QN(\main/n12 ) );
  NAND2X0 \main/U32  ( .IN1(\main/n45 ), .IN2(N50), .QN(\main/n10 ) );
  NAND2X0 \main/U31  ( .IN1(\main/n44 ), .IN2(N60), .QN(\main/n3 ) );
  NAND2X0 \main/U30  ( .IN1(\main/n42 ), .IN2(N85), .QN(\main/n5 ) );
  NAND2X0 \main/U29  ( .IN1(\main/n43 ), .IN2(N72), .QN(\main/n4 ) );
  NAND2X0 \main/U28  ( .IN1(\main/n44 ), .IN2(N63), .QN(\main/n7 ) );
  NAND2X0 \main/U27  ( .IN1(\main/n42 ), .IN2(N89), .QN(\main/n9 ) );
  NAND2X0 \main/U26  ( .IN1(\main/n43 ), .IN2(N76), .QN(\main/n8 ) );
  NAND2X0 \main/U25  ( .IN1(\main/n44 ), .IN2(N65), .QN(\main/n35 ) );
  NAND2X0 \main/U24  ( .IN1(\main/n42 ), .IN2(N91), .QN(\main/n37 ) );
  NAND2X0 \main/U23  ( .IN1(\main/n43 ), .IN2(N78), .QN(\main/n36 ) );
  NAND2X0 \main/U22  ( .IN1(\main/n44 ), .IN2(N61), .QN(\main/n15 ) );
  NAND2X0 \main/U21  ( .IN1(\main/n42 ), .IN2(N86), .QN(\main/n17 ) );
  NAND2X0 \main/U20  ( .IN1(\main/n43 ), .IN2(N73), .QN(\main/n16 ) );
  NAND2X0 \main/U19  ( .IN1(\main/n44 ), .IN2(N62), .QN(\main/n11 ) );
  NAND2X0 \main/U18  ( .IN1(\main/n42 ), .IN2(N93), .QN(\main/n49 ) );
  NAND2X0 \main/U17  ( .IN1(\main/n43 ), .IN2(N80), .QN(\main/n48 ) );
  NAND2X0 \main/U16  ( .IN1(\main/n45 ), .IN2(N55), .QN(\main/n46 ) );
  NAND2X0 \main/U15  ( .IN1(\main/n44 ), .IN2(N66), .QN(\main/n39 ) );
  NAND2X0 \main/U14  ( .IN1(\main/n42 ), .IN2(N92), .QN(\main/n41 ) );
  NAND2X0 \main/U13  ( .IN1(\main/n45 ), .IN2(N54), .QN(\main/n38 ) );
  NAND2X0 \main/U12  ( .IN1(\main/n44 ), .IN2(N56), .QN(\main/n28 ) );
  NAND2X0 \main/U11  ( .IN1(\main/n42 ), .IN2(N81), .QN(\main/n30 ) );
  NAND2X0 \main/U10  ( .IN1(\main/n43 ), .IN2(N68), .QN(\main/n29 ) );
  NAND2X0 \main/U9  ( .IN1(N278), .IN2(N2020), .QN(\main/n167 ) );
  NAND2X0 \main/U8  ( .IN1(\main/n75 ), .IN2(N135), .QN(\main/n82 ) );
  NAND2X0 \main/U7  ( .IN1(\main/n77 ), .IN2(N99), .QN(\main/n80 ) );
  NAND2X0 \main/U6  ( .IN1(\main/n44 ), .IN2(N67), .QN(\main/n47 ) );
  NAND2X0 \main/U5  ( .IN1(\main/n76 ), .IN2(N123), .QN(\main/n81 ) );
  NAND2X0 \main/U4  ( .IN1(\main/n75 ), .IN2(N131), .QN(\main/n72 ) );
  NAND2X0 \main/U3  ( .IN1(\main/n77 ), .IN2(N95), .QN(\main/n70 ) );
  NAND2X0 \main/U2  ( .IN1(\main/n78 ), .IN2(N107), .QN(\main/n69 ) );
  NAND2X0 \main/U1  ( .IN1(\main/n76 ), .IN2(N119), .QN(\main/n71 ) );
  NOR3X0 \perturb/U5  ( .IN1(N141), .IN2(N100), .IN3(\perturb/n2 ), .QN(
        perturb_signal) );
  NAND3X0 \perturb/U4  ( .IN1(N105), .IN2(N119), .IN3(\perturb/n1 ), .QN(
        \perturb/n2 ) );
  NOR4X0 \perturb/U3  ( .IN1(N117), .IN2(N112), .IN3(N127), .IN4(N101), .QN(
        \perturb/n1 ) );
  ...
  XNOR2X1 \restore/U10  ( .IN1(keyinput7), .IN2(N117), .Q(\restore/n5 ) );
  XNOR2X1 \restore/U9  ( .IN1(keyinput0), .IN2(N127), .Q(\restore/n6 ) );
  XNOR2X1 \restore/U8  ( .IN1(keyinput2), .IN2(N100), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput4), .IN2(N141), .Q(\restore/n8 ) );
  NAND4X0 \restore/U6  ( .IN1(\restore/n4 ), .IN2(\restore/n3 ), .IN3(
        \restore/n2 ), .IN4(\restore/n1 ), .QN(\restore/n10 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput1), .IN2(N119), .Q(\restore/n1 ) );
  XNOR2X1 \restore/U4  ( .IN1(keyinput3), .IN2(N105), .Q(\restore/n2 ) );
  XNOR2X1 \restore/U3  ( .IN1(keyinput5), .IN2(N101), .Q(\restore/n3 ) );
  XNOR2X1 \restore/U2  ( .IN1(keyinput6), .IN2(N112), .Q(\restore/n4 ) );
endmodule
