...
module c2670_SFLL_HD_0_16_1_top ( N145, N153, N162, N168, N172, N210, N190, 
  ...
  NAND2X0 \main/U43  ( .IN1(\main/n80 ), .IN2(N123), .QN(\main/n76 ) );
  NAND2X0 \main/U42  ( .IN1(\main/n78 ), .IN2(N111), .QN(\main/n74 ) );
  ...
  NAND2X0 \main/U32  ( .IN1(\main/n43 ), .IN2(N75), .QN(\main/n12 ) );
  ...
  NAND2X0 \main/U28  ( .IN1(\main/n43 ), .IN2(N72), .QN(\main/n4 ) );
  NAND2X0 \main/U27  ( .IN1(\main/n44 ), .IN2(N63), .QN(\main/n7 ) );
  NAND2X0 \main/U26  ( .IN1(\main/n42 ), .IN2(N89), .QN(\main/n9 ) );
  NAND2X0 \main/U25  ( .IN1(\main/n43 ), .IN2(N76), .QN(\main/n8 ) );
  NAND2X0 \main/U24  ( .IN1(\main/n44 ), .IN2(N65), .QN(\main/n35 ) );
  NAND2X0 \main/U23  ( .IN1(\main/n42 ), .IN2(N91), .QN(\main/n37 ) );
  ...
  NAND2X0 \main/U19  ( .IN1(\main/n43 ), .IN2(N73), .QN(\main/n16 ) );
  NAND2X0 \main/U18  ( .IN1(\main/n44 ), .IN2(N62), .QN(\main/n11 ) );
  NAND2X0 \main/U17  ( .IN1(\main/n42 ), .IN2(N93), .QN(\main/n49 ) );
  NAND2X0 \main/U16  ( .IN1(\main/n43 ), .IN2(N80), .QN(\main/n48 ) );
  NAND2X0 \main/U15  ( .IN1(\main/n45 ), .IN2(N55), .QN(\main/n46 ) );
  NAND2X0 \main/U14  ( .IN1(\main/n44 ), .IN2(N66), .QN(\main/n39 ) );
  NAND2X0 \main/U13  ( .IN1(\main/n42 ), .IN2(N92), .QN(\main/n41 ) );
  NAND2X0 \main/U12  ( .IN1(\main/n45 ), .IN2(N54), .QN(\main/n38 ) );
  ...
  NOR4X0 \perturb/U8  ( .IN1(N73), .IN2(\perturb/n5 ), .IN3(\perturb/n4 ), 
        .IN4(\perturb/n3 ), .QN(perturb_signal) );
  NOR4X0 \perturb/U7  ( .IN1(N77), .IN2(N76), .IN3(N37), .IN4(N90), .QN(
        \perturb/n1 ) );
  NOR4X0 \perturb/U6  ( .IN1(N75), .IN2(N74), .IN3(N63), .IN4(N234), .QN(
        \perturb/n2 ) );
  NAND4X0 \perturb/U5  ( .IN1(N51), .IN2(N72), .IN3(N64), .IN4(N54), .QN(
        \perturb/n4 ) );
  NAND3X0 \perturb/U4  ( .IN1(N55), .IN2(N62), .IN3(N67), .QN(\perturb/n5 ) );
  ...
  XNOR2X1 \restore/U20  ( .IN1(keyinput5), .IN2(N77), .Q(\restore/n13 ) );
  XNOR2X1 \restore/U19  ( .IN1(keyinput7), .IN2(N76), .Q(\restore/n14 ) );
  XNOR2X1 \restore/U18  ( .IN1(keyinput9), .IN2(N37), .Q(\restore/n15 ) );
  XNOR2X1 \restore/U17  ( .IN1(keyinput6), .IN2(N74), .Q(\restore/n16 ) );
  NAND4X0 \restore/U16  ( .IN1(\restore/n12 ), .IN2(\restore/n11 ), .IN3(
        \restore/n10 ), .IN4(\restore/n9 ), .QN(\restore/n18 ) );
  XNOR2X1 \restore/U15  ( .IN1(keyinput8), .IN2(N75), .Q(\restore/n9 ) );
  XNOR2X1 \restore/U14  ( .IN1(keyinput0), .IN2(N63), .Q(\restore/n10 ) );
  XNOR2X1 \restore/U13  ( .IN1(keyinput3), .IN2(N73), .Q(\restore/n11 ) );
  XNOR2X1 \restore/U12  ( .IN1(keyinput1), .IN2(N90), .Q(\restore/n12 ) );
  NAND4X0 \restore/U11  ( .IN1(\restore/n8 ), .IN2(\restore/n7 ), .IN3(
        \restore/n6 ), .IN4(\restore/n5 ), .QN(\restore/n19 ) );
  XNOR2X1 \restore/U10  ( .IN1(keyinput2), .IN2(N62), .Q(\restore/n5 ) );
  XNOR2X1 \restore/U9  ( .IN1(keyinput4), .IN2(N55), .Q(\restore/n6 ) );
  XNOR2X1 \restore/U8  ( .IN1(keyinput14), .IN2(N72), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput12), .IN2(N67), .Q(\restore/n8 ) );
  NAND4X0 \restore/U6  ( .IN1(\restore/n4 ), .IN2(\restore/n3 ), .IN3(
        \restore/n2 ), .IN4(\restore/n1 ), .QN(\restore/n20 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput10), .IN2(N51), .Q(\restore/n1 ) );
  XNOR2X1 \restore/U4  ( .IN1(keyinput13), .IN2(N64), .Q(\restore/n2 ) );
  XNOR2X1 \restore/U3  ( .IN1(keyinput11), .IN2(N234), .Q(\restore/n3 ) );
  XNOR2X1 \restore/U2  ( .IN1(keyinput15), .IN2(N54), .Q(\restore/n4 ) );
endmodule
