...
module c5315_SFLL_HD_0_8_1_top ( N1, N4, N11, N14, N17, N20, N23, N24, N25, 
  ...
  AO222X1 \main/U147  ( .IN1(N113), .IN2(\main/n201 ), .IN3(\main/n203 ), 
        .IN4(\main/n34 ), .IN5(\main/n204 ), .IN6(\main/n32 ), .Q(\main/n188 )
         );
  ...
  AO221X1 \main/U144  ( .IN1(\main/n28 ), .IN2(\main/n188 ), .IN3(\main/n27 ), 
  ...
  AO221X1 \main/U138  ( .IN1(\main/n23 ), .IN2(\main/n188 ), .IN3(\main/n22 ), 
        .IN4(\main/n17 ), .IN5(\main/n197 ), .Q(N7742) );
  AO22X1 \main/U137  ( .IN1(\main/n192 ), .IN2(N173), .IN3(\main/n193 ), .IN4(
        N203), .Q(\main/n196 ) );
  AO221X1 \main/U136  ( .IN1(\main/n189 ), .IN2(\main/n188 ), .IN3(\main/n190 ), .IN4(\main/n17 ), .IN5(\main/n196 ), .Q(N7754) );
  ...
  INVX0 \main/U129  ( .INP(N203), .ZN(\main/n185 ) );
  INVX0 \main/U128  ( .INP(\main/n188 ), .ZN(N7707) );
  AOI22X1 \main/U127  ( .IN1(\main/n17 ), .IN2(\main/n177 ), .IN3(\main/n179 ), 
        .IN4(N173), .QN(\main/n187 ) );
  OA221X1 \main/U126  ( .IN1(\main/n184 ), .IN2(\main/n185 ), .IN3(N7707), 
        .IN4(\main/n186 ), .IN5(\main/n187 ), .Q(\main/n183 ) );
  XNOR3X1 \main/U125  ( .IN1(restore_signal), .IN2(perturb_signal), .IN3(
        \main/n183 ), .Q(N7758) );
  ...
  OR4X1 \perturb/U5  ( .IN1(N265), .IN2(N173), .IN3(N351), .IN4(N316), .Q(
        \perturb/n1 ) );
  NAND4X0 \perturb/U4  ( .IN1(N435), .IN2(N338), .IN3(N272), .IN4(N113), .QN(
        \perturb/n2 ) );
  NOR2X0 \perturb/U3  ( .IN1(\perturb/n1 ), .IN2(\perturb/n2 ), .QN(
        perturb_signal) );
  XNOR2X1 \restore/U12  ( .IN1(keyinput0), .IN2(N173), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U11  ( .IN1(keyinput6), .IN2(N338), .Q(\restore/n8 ) );
  XNOR2X1 \restore/U10  ( .IN1(keyinput5), .IN2(N351), .Q(\restore/n9 ) );
  XNOR2X1 \restore/U9  ( .IN1(keyinput7), .IN2(N113), .Q(\restore/n10 ) );
  NAND4X0 \restore/U8  ( .IN1(\restore/n7 ), .IN2(\restore/n8 ), .IN3(
        \restore/n9 ), .IN4(\restore/n10 ), .QN(\restore/n1 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput4), .IN2(N265), .Q(\restore/n3 ) );
  XNOR2X1 \restore/U6  ( .IN1(keyinput3), .IN2(N272), .Q(\restore/n4 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput2), .IN2(N316), .Q(\restore/n5 ) );
  XNOR2X1 \restore/U4  ( .IN1(keyinput1), .IN2(N435), .Q(\restore/n6 ) );
