...
module c2670_SFLL_HD_0_8_2_top ( N145, N153, N162, N168, N172, N210, N190, 
  ...
  XOR2X1 \main/U115  ( .IN1(N305), .IN2(N301), .Q(\main/n113 ) );
  XOR2X1 \main/U114  ( .IN1(N297), .IN2(N294), .Q(\main/n114 ) );
  XNOR2X1 \main/U113  ( .IN1(N316), .IN2(N355), .Q(\main/n116 ) );
  XOR3X1 \main/U112  ( .IN1(N313), .IN2(N309), .IN3(\main/n116 ), .Q(
        \main/n115 ) );
  XOR3X1 \main/U111  ( .IN1(\main/n113 ), .IN2(\main/n114 ), .IN3(\main/n115 ), 
        .Q(\main/n6 ) );
  XOR3X1 \main/U110  ( .IN1(restore_signal), .IN2(perturb_signal), .IN3(
        \main/n6 ), .Q(N2970) );
  NOR2X0 \main/U109  ( .IN1(\main/n99 ), .IN2(\main/n102 ), .QN(\main/n112 )
         );
  XNOR2X1 \main/U108  ( .IN1(\main/n111 ), .IN2(\main/n112 ), .Q(\main/n109 )
         );
  NAND2X0 \main/U107  ( .IN1(\main/n109 ), .IN2(\main/n110 ), .QN(\main/n103 )
         );
  AO22X1 \main/U106  ( .IN1(N80), .IN2(\main/n107 ), .IN3(N93), .IN4(
        \main/n108 ), .Q(\main/n106 ) );
  AO221X1 \main/U105  ( .IN1(N67), .IN2(\main/n104 ), .IN3(N55), .IN4(
        \main/n105 ), .IN5(\main/n106 ), .Q(\main/n97 ) );
  XNOR2X1 \main/U104  ( .IN1(\main/n103 ), .IN2(\main/n97 ), .Q(N3546) );
  XNOR2X1 \main/U103  ( .IN1(\main/n102 ), .IN2(\main/n97 ), .Q(\main/n101 )
         );
  XNOR3X1 \main/U102  ( .IN1(N2010), .IN2(\main/n87 ), .IN3(\main/n101 ), .Q(
        \main/n11 ) );
  XNOR2X1 \main/U101  ( .IN1(N1819), .IN2(\main/n57 ), .Q(\main/n100 ) );
  XOR3X1 \main/U100  ( .IN1(N2022), .IN2(N2020), .IN3(\main/n100 ), .Q(
        \main/n10 ) );
  XNOR3X1 \main/U99  ( .IN1(\main/n99 ), .IN2(\main/n11 ), .IN3(\main/n10 ), 
        .Q(\main/n98 ) );
  MUX21X1 \main/U98  ( .IN1(\main/n97 ), .IN2(\main/n98 ), .S(N246), .Q(N3803)
         );
  XOR2X1 \main/U97  ( .IN1(N352), .IN2(N287), .Q(\main/n96 ) );
  XOR3X1 \main/U96  ( .IN1(N284), .IN2(N278), .IN3(\main/n96 ), .Q(\main/n94 )
         );
  INVX0 \main/U95  ( .INP(N275), .ZN(\main/n58 ) );
  XNOR3X1 \main/U94  ( .IN1(\main/n58 ), .IN2(N272), .IN3(N263), .Q(\main/n95 ) );
  XNOR3X1 \main/U93  ( .IN1(\main/n94 ), .IN2(\main/n95 ), .IN3(N266), .Q(
        \main/n93 ) );
  XNOR3X1 \main/U92  ( .IN1(N281), .IN2(\main/n69 ), .IN3(\main/n93 ), .Q(
        N2971) );
  ...
  NOR3X0 \main/U18  ( .IN1(\main/n5 ), .IN2(\main/n6 ), .IN3(N2971), .QN(
        \main/n4 ) );
  ...
  NAND4X0 \perturb/U5  ( .IN1(N355), .IN2(N316), .IN3(N309), .IN4(N297), .QN(
        \perturb/n1 ) );
  NAND2X0 \perturb/U4  ( .IN1(N313), .IN2(N294), .QN(\perturb/n2 ) );
  NOR4X0 \perturb/U3  ( .IN1(\perturb/n1 ), .IN2(\perturb/n2 ), .IN3(N305), 
        .IN4(N301), .QN(perturb_signal) );
  XNOR2X1 \restore/U12  ( .IN1(keyinput0), .IN2(N301), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U11  ( .IN1(keyinput6), .IN2(N355), .Q(\restore/n8 ) );
  XNOR2X1 \restore/U10  ( .IN1(keyinput5), .IN2(N316), .Q(\restore/n9 ) );
  XNOR2X1 \restore/U9  ( .IN1(keyinput7), .IN2(N313), .Q(\restore/n10 ) );
  NAND4X0 \restore/U8  ( .IN1(\restore/n7 ), .IN2(\restore/n8 ), .IN3(
        \restore/n9 ), .IN4(\restore/n10 ), .QN(\restore/n1 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput4), .IN2(N294), .Q(\restore/n3 ) );
  XNOR2X1 \restore/U6  ( .IN1(keyinput3), .IN2(N305), .Q(\restore/n4 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput2), .IN2(N297), .Q(\restore/n5 ) );
  XNOR2X1 \restore/U4  ( .IN1(keyinput1), .IN2(N309), .Q(\restore/n6 ) );
