...
module c2670_SFLL_HD_0_16_2_top ( N145, N153, N162, N168, N172, N210, N190, 
  ...
  NAND4X0 \perturb/U7  ( .IN1(N297), .IN2(N43), .IN3(N256), .IN4(N127), .QN(
        \perturb/n2 ) );
  NAND4X0 \perturb/U6  ( .IN1(N246), .IN2(N52), .IN3(N75), .IN4(N126), .QN(
        \perturb/n3 ) );
  NOR3X0 \perturb/U5  ( .IN1(N56), .IN2(N47), .IN3(N103), .QN(\perturb/n1 ) );
  OR4X1 \perturb/U4  ( .IN1(N33), .IN2(N21), .IN3(N269), .IN4(N272), .Q(
        \perturb/n5 ) );
  NAND2X0 \perturb/U3  ( .IN1(N95), .IN2(\perturb/n1 ), .QN(\perturb/n4 ) );
  ...
  XNOR2X1 \restore/U20  ( .IN1(keyinput5), .IN2(N52), .Q(\restore/n13 ) );
  XNOR2X1 \restore/U19  ( .IN1(keyinput7), .IN2(N103), .Q(\restore/n14 ) );
  XNOR2X1 \restore/U18  ( .IN1(keyinput9), .IN2(N47), .Q(\restore/n15 ) );
  XNOR2X1 \restore/U17  ( .IN1(keyinput6), .IN2(N297), .Q(\restore/n16 ) );
  NAND4X0 \restore/U16  ( .IN1(\restore/n12 ), .IN2(\restore/n11 ), .IN3(
        \restore/n10 ), .IN4(\restore/n9 ), .QN(\restore/n18 ) );
  XNOR2X1 \restore/U15  ( .IN1(keyinput8), .IN2(N21), .Q(\restore/n9 ) );
  XNOR2X1 \restore/U14  ( .IN1(keyinput0), .IN2(N269), .Q(\restore/n10 ) );
  XNOR2X1 \restore/U13  ( .IN1(keyinput3), .IN2(N95), .Q(\restore/n11 ) );
  XNOR2X1 \restore/U12  ( .IN1(keyinput1), .IN2(N246), .Q(\restore/n12 ) );
  ...
  XNOR2X1 \restore/U9  ( .IN1(keyinput4), .IN2(N75), .Q(\restore/n6 ) );
  XNOR2X1 \restore/U8  ( .IN1(keyinput14), .IN2(N272), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput12), .IN2(N43), .Q(\restore/n8 ) );
  NAND4X0 \restore/U6  ( .IN1(\restore/n4 ), .IN2(\restore/n3 ), .IN3(
        \restore/n2 ), .IN4(\restore/n1 ), .QN(\restore/n20 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput10), .IN2(N126), .Q(\restore/n1 ) );
  XNOR2X1 \restore/U4  ( .IN1(keyinput13), .IN2(N127), .Q(\restore/n2 ) );
  XNOR2X1 \restore/U3  ( .IN1(keyinput11), .IN2(N256), .Q(\restore/n3 ) );
  XNOR2X1 \restore/U2  ( .IN1(keyinput15), .IN2(N56), .Q(\restore/n4 ) );
endmodule
