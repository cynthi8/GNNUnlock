...
module c3540_SFLL_HD_0_8_2_top ( N1, N13, N20, N33, N41, N45, N50, N58, N68, 
  ...
  wire   perturb_signal, restore_signal, \main/n474 , \main/n473 , \main/n472 ,
         ...
         \main/n4 , \main/n3 , \main/n2 , \main/n1 , \perturb/n3 ,
  ...
  NAND2X0 \main/U57  ( .IN1(\main/n264 ), .IN2(\main/n430 ), .QN(\main/n63 )
         );
  NAND2X0 \main/U56  ( .IN1(N97), .IN2(\main/n125 ), .QN(\main/n39 ) );
  NAND2X0 \main/U55  ( .IN1(\main/n134 ), .IN2(\main/n136 ), .QN(\main/n124 )
         );
  NAND2X0 \main/U54  ( .IN1(\main/n365 ), .IN2(\main/n368 ), .QN(\main/n195 )
         );
  NAND2X0 \main/U53  ( .IN1(\main/n458 ), .IN2(N33), .QN(\main/n326 ) );
  NAND2X0 \main/U52  ( .IN1(\main/n74 ), .IN2(N20), .QN(\main/n348 ) );
  NAND2X0 \main/U51  ( .IN1(N283), .IN2(\main/n400 ), .QN(\main/n401 ) );
  NAND2X0 \main/U50  ( .IN1(\main/n133 ), .IN2(\main/n95 ), .QN(\main/n1 ) );
  NAND2X0 \main/U49  ( .IN1(N58), .IN2(\main/n342 ), .QN(\main/n178 ) );
  NAND2X0 \main/U48  ( .IN1(N97), .IN2(\main/n400 ), .QN(\main/n182 ) );
  NAND2X0 \main/U47  ( .IN1(N200), .IN2(\main/n76 ), .QN(\main/n72 ) );
  NAND2X0 \main/U46  ( .IN1(\main/n429 ), .IN2(N20), .QN(\main/n96 ) );
  NAND2X0 \main/U45  ( .IN1(\main/n47 ), .IN2(\main/n75 ), .QN(\main/n48 ) );
  NAND2X0 \main/U44  ( .IN1(\main/n173 ), .IN2(\main/n172 ), .QN(N5121) );
  NAND2X0 \main/U43  ( .IN1(\main/n58 ), .IN2(\main/n255 ), .QN(N4589) );
  NAND2X0 \main/U42  ( .IN1(\main/n434 ), .IN2(\main/n296 ), .QN(\main/n217 )
         );
  NAND2X0 \main/U41  ( .IN1(\main/n219 ), .IN2(\main/n218 ), .QN(N5120) );
  NAND2X0 \main/U40  ( .IN1(\main/n389 ), .IN2(\main/n285 ), .QN(\main/n263 )
         );
  NAND2X0 \main/U39  ( .IN1(N87), .IN2(\main/n263 ), .QN(N1947) );
  NAND2X0 \main/U38  ( .IN1(\main/n295 ), .IN2(\main/n294 ), .QN(N5047) );
  NAND2X0 \main/U37  ( .IN1(\main/n322 ), .IN2(\main/n321 ), .QN(N5102) );
  NAND2X0 \main/U36  ( .IN1(\main/n195 ), .IN2(\main/n196 ), .QN(\main/n121 )
         );
  NAND2X0 \main/U35  ( .IN1(\main/n436 ), .IN2(\main/n435 ), .QN(\main/n437 )
         );
  NAND2X0 \main/U34  ( .IN1(\main/n183 ), .IN2(\main/n182 ), .QN(\main/n184 )
         );
  NAND2X0 \main/U33  ( .IN1(\main/n233 ), .IN2(\main/n232 ), .QN(\main/n244 )
         );
  NAND2X0 \main/U32  ( .IN1(N20), .IN2(N1), .QN(\main/n466 ) );
  NAND2X0 \main/U31  ( .IN1(\main/n254 ), .IN2(\main/n18 ), .QN(\main/n19 ) );
  NAND2X0 \main/U30  ( .IN1(N58), .IN2(\main/n394 ), .QN(\main/n349 ) );
  NAND2X0 \main/U29  ( .IN1(N77), .IN2(\main/n343 ), .QN(\main/n345 ) );
  NAND2X0 \main/U28  ( .IN1(\main/n342 ), .IN2(N107), .QN(\main/n346 ) );
  NAND2X0 \main/U27  ( .IN1(N330), .IN2(\main/n356 ), .QN(\main/n355 ) );
  NAND2X0 \main/U26  ( .IN1(\main/n382 ), .IN2(N159), .QN(\main/n278 ) );
  NAND2X0 \main/U25  ( .IN1(N1), .IN2(N13), .QN(\main/n450 ) );
  NAND2X0 \main/U24  ( .IN1(\main/n83 ), .IN2(N33), .QN(\main/n311 ) );
  NAND2X0 \main/U23  ( .IN1(N200), .IN2(N190), .QN(\main/n67 ) );
  NAND2X0 \main/U22  ( .IN1(\main/n208 ), .IN2(N330), .QN(\main/n366 ) );
  ...
  NAND2X0 \main/U11  ( .IN1(N77), .IN2(\main/n314 ), .QN(\main/n279 ) );
  NAND2X0 \main/U10  ( .IN1(\main/n21 ), .IN2(N97), .QN(\main/n24 ) );
  NAND2X0 \main/U9  ( .IN1(\main/n104 ), .IN2(\main/n107 ), .QN(\main/n106 )
         );
  NAND2X0 \main/U8  ( .IN1(\main/n149 ), .IN2(\main/n202 ), .QN(\main/n152 )
         );
  NAND2X0 \main/U7  ( .IN1(\main/n116 ), .IN2(\main/n118 ), .QN(\main/n120 )
         );
  NAND2X0 \main/U6  ( .IN1(N20), .IN2(N179), .QN(\main/n71 ) );
  ...
  NOR2X0 \perturb/U6  ( .IN1(\perturb/n3 ), .IN2(\perturb/n2 ), .QN(
        perturb_signal) );
  NAND2X0 \perturb/U5  ( .IN1(N343), .IN2(\perturb/n1 ), .QN(\perturb/n2 ) );
  NOR3X0 \perturb/U4  ( .IN1(N270), .IN2(N238), .IN3(N1), .QN(\perturb/n1 ) );
  NAND4X0 \perturb/U3  ( .IN1(N33), .IN2(N244), .IN3(N97), .IN4(N13), .QN(
        \perturb/n3 ) );
  ...
  XNOR2X1 \restore/U10  ( .IN1(keyinput7), .IN2(N270), .Q(\restore/n5 ) );
  XNOR2X1 \restore/U9  ( .IN1(keyinput0), .IN2(N33), .Q(\restore/n6 ) );
  XNOR2X1 \restore/U8  ( .IN1(keyinput2), .IN2(N97), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput4), .IN2(N13), .Q(\restore/n8 ) );
  NAND4X0 \restore/U6  ( .IN1(\restore/n4 ), .IN2(\restore/n3 ), .IN3(
        \restore/n2 ), .IN4(\restore/n1 ), .QN(\restore/n10 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput1), .IN2(N343), .Q(\restore/n1 ) );
  XNOR2X1 \restore/U4  ( .IN1(keyinput3), .IN2(N244), .Q(\restore/n2 ) );
  XNOR2X1 \restore/U3  ( .IN1(keyinput5), .IN2(N238), .Q(\restore/n3 ) );
  XNOR2X1 \restore/U2  ( .IN1(keyinput6), .IN2(N1), .Q(\restore/n4 ) );
endmodule
