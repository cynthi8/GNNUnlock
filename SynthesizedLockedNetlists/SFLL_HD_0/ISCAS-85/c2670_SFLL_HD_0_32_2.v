...
module c2670_SFLL_HD_0_32_2_top ( N145, N153, N162, N168, N172, N210, N190, 
  ...
  INVX0 \main/U210  ( .INP(\main/n114 ), .ZN(\main/n70 ) );
  NAND2X0 \main/U209  ( .IN1(N241), .IN2(\main/n70 ), .QN(N1969) );
  ...
  AO221X1 \main/U201  ( .IN1(N66), .IN2(\main/n107 ), .IN3(N54), .IN4(
        \main/n108 ), .IN5(\main/n175 ), .Q(\main/n92 ) );
  MUX21X1 \main/U200  ( .IN1(\main/n92 ), .IN2(N2012), .S(N246), .Q(N2387) );
  MUX21X1 \main/U199  ( .IN1(N2010), .IN2(N2014), .S(N246), .Q(N2389) );
  NOR2X0 \main/U198  ( .IN1(N230), .IN2(\main/n92 ), .QN(\main/n89 ) );
  INVX0 \main/U197  ( .INP(\main/n89 ), .ZN(\main/n174 ) );
  INVX0 \main/U196  ( .INP(N241), .ZN(\main/n113 ) );
  AO21X1 \main/U195  ( .IN1(\main/n174 ), .IN2(\main/n113 ), .IN3(\main/n92 ), 
        .Q(N2496) );
  ...
  NOR2X0 \main/U191  ( .IN1(\main/n173 ), .IN2(\main/n172 ), .QN(\main/n98 )
         );
  NOR2X0 \main/U190  ( .IN1(\main/n173 ), .IN2(N319), .QN(\main/n99 ) );
  NOR2X0 \main/U189  ( .IN1(\main/n172 ), .IN2(N322), .QN(\main/n101 ) );
  NOR2X0 \main/U188  ( .IN1(N319), .IN2(N322), .QN(\main/n102 ) );
  AO22X1 \main/U187  ( .IN1(N99), .IN2(\main/n101 ), .IN3(N135), .IN4(
        \main/n102 ), .Q(\main/n171 ) );
  AO221X1 \main/U186  ( .IN1(N111), .IN2(\main/n98 ), .IN3(N123), .IN4(
        \main/n99 ), .IN5(\main/n171 ), .Q(\main/n105 ) );
  XOR2X1 \main/U185  ( .IN1(\main/n105 ), .IN2(N313), .Q(\main/n169 ) );
  ...
  INVX0 \main/U176  ( .INP(N269), .ZN(\main/n52 ) );
  XNOR2X1 \main/U175  ( .IN1(\main/n52 ), .IN2(N21), .Q(\main/n163 ) );
  ...
  INVX0 \main/U167  ( .INP(N2018), .ZN(\main/n40 ) );
  XNOR2X1 \main/U166  ( .IN1(\main/n40 ), .IN2(N275), .Q(\main/n156 ) );
  ...
  INVX0 \main/U162  ( .INP(\main/n92 ), .ZN(\main/n66 ) );
  XNOR2X1 \main/U161  ( .IN1(\main/n66 ), .IN2(N259), .Q(\main/n151 ) );
  INVX0 \main/U160  ( .INP(N2010), .ZN(\main/n59 ) );
  XNOR2X1 \main/U159  ( .IN1(\main/n59 ), .IN2(N263), .Q(\main/n152 ) );
  XNOR2X1 \main/U158  ( .IN1(\main/n70 ), .IN2(N256), .Q(\main/n153 ) );
  ...
  AO22X1 \main/U142  ( .IN1(N102), .IN2(\main/n101 ), .IN3(N138), .IN4(
        \main/n102 ), .Q(\main/n135 ) );
  AO221X1 \main/U141  ( .IN1(N114), .IN2(\main/n98 ), .IN3(N126), .IN4(
        \main/n99 ), .IN5(\main/n135 ), .Q(\main/n72 ) );
  INVX0 \main/U140  ( .INP(\main/n72 ), .ZN(N1818) );
  XNOR2X1 \main/U139  ( .IN1(N1818), .IN2(N301), .Q(\main/n130 ) );
  AO22X1 \main/U138  ( .IN1(N104), .IN2(\main/n101 ), .IN3(N140), .IN4(
        \main/n102 ), .Q(\main/n134 ) );
  AO221X1 \main/U137  ( .IN1(N116), .IN2(\main/n98 ), .IN3(N128), .IN4(
        \main/n99 ), .IN5(\main/n134 ), .Q(\main/n75 ) );
  XOR2X1 \main/U136  ( .IN1(\main/n75 ), .IN2(N294), .Q(\main/n131 ) );
  AO22X1 \main/U135  ( .IN1(N105), .IN2(\main/n101 ), .IN3(N141), .IN4(
        \main/n102 ), .Q(\main/n133 ) );
  AO221X1 \main/U134  ( .IN1(N117), .IN2(\main/n98 ), .IN3(N129), .IN4(
        \main/n99 ), .IN5(\main/n133 ), .Q(\main/n74 ) );
  XOR2X1 \main/U133  ( .IN1(\main/n74 ), .IN2(N287), .Q(\main/n132 ) );
  NAND4X0 \main/U132  ( .IN1(\main/n130 ), .IN2(\main/n131 ), .IN3(\main/n132 ), .IN4(\main/n105 ), .QN(\main/n120 ) );
  AO22X1 \main/U131  ( .IN1(N95), .IN2(\main/n101 ), .IN3(N131), .IN4(
        \main/n102 ), .Q(\main/n129 ) );
  AO221X1 \main/U130  ( .IN1(N107), .IN2(\main/n98 ), .IN3(N119), .IN4(
        \main/n99 ), .IN5(\main/n129 ), .Q(\main/n24 ) );
  XOR2X1 \main/U129  ( .IN1(\main/n24 ), .IN2(N284), .Q(\main/n122 ) );
  AO22X1 \main/U128  ( .IN1(N103), .IN2(\main/n101 ), .IN3(N139), .IN4(
        \main/n102 ), .Q(\main/n128 ) );
  AO221X1 \main/U127  ( .IN1(N115), .IN2(\main/n98 ), .IN3(N127), .IN4(
        \main/n99 ), .IN5(\main/n128 ), .Q(\main/n103 ) );
  XOR2X1 \main/U126  ( .IN1(\main/n103 ), .IN2(N297), .Q(\main/n123 ) );
  AO22X1 \main/U125  ( .IN1(N100), .IN2(\main/n101 ), .IN3(N136), .IN4(
        \main/n102 ), .Q(\main/n127 ) );
  AOI221X1 \main/U124  ( .IN1(N112), .IN2(\main/n98 ), .IN3(N124), .IN4(
        \main/n99 ), .IN5(\main/n127 ), .QN(N1817) );
  XNOR2X1 \main/U123  ( .IN1(N1817), .IN2(N309), .Q(\main/n124 ) );
  AO22X1 \main/U122  ( .IN1(N101), .IN2(\main/n101 ), .IN3(N137), .IN4(
        \main/n102 ), .Q(\main/n126 ) );
  AOI221X1 \main/U121  ( .IN1(N113), .IN2(\main/n98 ), .IN3(N125), .IN4(
        \main/n99 ), .IN5(\main/n126 ), .QN(N1816) );
  ...
  NOR2X0 \main/U114  ( .IN1(\main/n89 ), .IN2(\main/n92 ), .QN(\main/n115 ) );
  ...
  AO221X1 \main/U110  ( .IN1(N67), .IN2(\main/n107 ), .IN3(N55), .IN4(
        \main/n108 ), .IN5(\main/n109 ), .Q(\main/n87 ) );
  XNOR2X1 \main/U109  ( .IN1(\main/n106 ), .IN2(\main/n87 ), .Q(N3546) );
  XNOR2X1 \main/U108  ( .IN1(\main/n24 ), .IN2(\main/n105 ), .Q(\main/n104 )
         );
  XNOR3X1 \main/U107  ( .IN1(\main/n103 ), .IN2(N1816), .IN3(\main/n104 ), .Q(
        \main/n94 ) );
  AO22X1 \main/U106  ( .IN1(N106), .IN2(\main/n101 ), .IN3(N142), .IN4(
        \main/n102 ), .Q(\main/n100 ) );
  AO221X1 \main/U105  ( .IN1(N118), .IN2(\main/n98 ), .IN3(N130), .IN4(
        \main/n99 ), .IN5(\main/n100 ), .Q(\main/n96 ) );
  XNOR2X1 \main/U104  ( .IN1(\main/n75 ), .IN2(\main/n72 ), .Q(\main/n97 ) );
  XOR3X1 \main/U103  ( .IN1(\main/n74 ), .IN2(\main/n96 ), .IN3(\main/n97 ), 
        .Q(\main/n95 ) );
  XNOR3X1 \main/U102  ( .IN1(\main/n94 ), .IN2(\main/n95 ), .IN3(N1817), .Q(
        \main/n93 ) );
  INVX0 \main/U101  ( .INP(N37), .ZN(\main/n7 ) );
  NAND2X0 \main/U100  ( .IN1(\main/n93 ), .IN2(\main/n7 ), .QN(\main/n3 ) );
  XNOR3X1 \main/U99  ( .IN1(restore_signal), .IN2(perturb_signal), .IN3(
        \main/n3 ), .Q(N3671) );
  XNOR2X1 \main/U98  ( .IN1(\main/n92 ), .IN2(\main/n87 ), .Q(\main/n91 ) );
  XNOR3X1 \main/U97  ( .IN1(N2010), .IN2(\main/n70 ), .IN3(\main/n91 ), .Q(
        \main/n10 ) );
  ...
  NOR4X0 \perturb/U14  ( .IN1(N135), .IN2(N131), .IN3(N126), .IN4(N125), .QN(
        \perturb/n1 ) );
  NOR4X0 \perturb/U13  ( .IN1(N99), .IN2(N95), .IN3(N322), .IN4(N139), .QN(
        \perturb/n2 ) );
  NAND4X0 \perturb/U12  ( .IN1(N103), .IN2(N129), .IN3(N106), .IN4(N142), .QN(
        \perturb/n9 ) );
  INVX0 \perturb/U11  ( .INP(N107), .ZN(\perturb/n11 ) );
  NAND2X0 \perturb/U10  ( .IN1(N136), .IN2(\perturb/n11 ), .QN(\perturb/n10 )
         );
  NOR4X0 \perturb/U9  ( .IN1(\perturb/n9 ), .IN2(\perturb/n10 ), .IN3(N117), 
        .IN4(N112), .QN(\perturb/n3 ) );
  NAND4X0 \perturb/U8  ( .IN1(N141), .IN2(N114), .IN3(N115), .IN4(N128), .QN(
        \perturb/n5 ) );
  NAND4X0 \perturb/U7  ( .IN1(N37), .IN2(N101), .IN3(N113), .IN4(N118), .QN(
        \perturb/n6 ) );
  NAND4X0 \perturb/U6  ( .IN1(N116), .IN2(N111), .IN3(N102), .IN4(N140), .QN(
        \perturb/n7 ) );
  NAND4X0 \perturb/U5  ( .IN1(N137), .IN2(N127), .IN3(N105), .IN4(N319), .QN(
        \perturb/n8 ) );
  ...
  XNOR2X1 \restore/U44  ( .IN1(keyinput17), .IN2(N118), .Q(\restore/n39 ) );
  XNOR2X1 \restore/U43  ( .IN1(keyinput18), .IN2(N99), .Q(\restore/n40 ) );
  XNOR2X1 \restore/U42  ( .IN1(keyinput19), .IN2(N113), .Q(\restore/n41 ) );
  XNOR2X1 \restore/U41  ( .IN1(keyinput21), .IN2(N106), .Q(\restore/n42 ) );
  NAND4X0 \restore/U40  ( .IN1(\restore/n39 ), .IN2(\restore/n40 ), .IN3(
        \restore/n41 ), .IN4(\restore/n42 ), .QN(\restore/n23 ) );
  XNOR2X1 \restore/U39  ( .IN1(keyinput29), .IN2(N125), .Q(\restore/n35 ) );
  XNOR2X1 \restore/U38  ( .IN1(keyinput3), .IN2(N114), .Q(\restore/n36 ) );
  XNOR2X1 \restore/U37  ( .IN1(keyinput2), .IN2(N322), .Q(\restore/n37 ) );
  XNOR2X1 \restore/U36  ( .IN1(keyinput4), .IN2(N139), .Q(\restore/n38 ) );
  NAND4X0 \restore/U35  ( .IN1(\restore/n35 ), .IN2(\restore/n36 ), .IN3(
        \restore/n37 ), .IN4(\restore/n38 ), .QN(\restore/n24 ) );
  XNOR2X1 \restore/U34  ( .IN1(keyinput25), .IN2(N111), .Q(\restore/n31 ) );
  XNOR2X1 \restore/U33  ( .IN1(keyinput28), .IN2(N140), .Q(\restore/n32 ) );
  XNOR2X1 \restore/U32  ( .IN1(keyinput27), .IN2(N101), .Q(\restore/n33 ) );
  XNOR2X1 \restore/U31  ( .IN1(keyinput26), .IN2(N37), .Q(\restore/n34 ) );
  NAND4X0 \restore/U30  ( .IN1(\restore/n31 ), .IN2(\restore/n32 ), .IN3(
        \restore/n33 ), .IN4(\restore/n34 ), .QN(\restore/n25 ) );
  XNOR2X1 \restore/U29  ( .IN1(keyinput20), .IN2(N142), .Q(\restore/n27 ) );
  XNOR2X1 \restore/U28  ( .IN1(keyinput22), .IN2(N136), .Q(\restore/n28 ) );
  XNOR2X1 \restore/U27  ( .IN1(keyinput24), .IN2(N102), .Q(\restore/n29 ) );
  XNOR2X1 \restore/U26  ( .IN1(keyinput23), .IN2(N95), .Q(\restore/n30 ) );
  ...
  XNOR2X1 \restore/U23  ( .IN1(keyinput9), .IN2(N105), .Q(\restore/n19 ) );
  XNOR2X1 \restore/U22  ( .IN1(keyinput8), .IN2(N126), .Q(\restore/n20 ) );
  XNOR2X1 \restore/U21  ( .IN1(keyinput13), .IN2(N115), .Q(\restore/n21 ) );
  XNOR2X1 \restore/U20  ( .IN1(keyinput12), .IN2(N128), .Q(\restore/n22 ) );
  NAND4X0 \restore/U19  ( .IN1(\restore/n19 ), .IN2(\restore/n20 ), .IN3(
        \restore/n21 ), .IN4(\restore/n22 ), .QN(\restore/n3 ) );
  XNOR2X1 \restore/U18  ( .IN1(keyinput5), .IN2(N135), .Q(\restore/n15 ) );
  XNOR2X1 \restore/U17  ( .IN1(keyinput6), .IN2(N137), .Q(\restore/n16 ) );
  XNOR2X1 \restore/U16  ( .IN1(keyinput7), .IN2(N127), .Q(\restore/n17 ) );
  XNOR2X1 \restore/U15  ( .IN1(keyinput10), .IN2(N131), .Q(\restore/n18 ) );
  NAND4X0 \restore/U14  ( .IN1(\restore/n15 ), .IN2(\restore/n16 ), .IN3(
        \restore/n17 ), .IN4(\restore/n18 ), .QN(\restore/n4 ) );
  XNOR2X1 \restore/U13  ( .IN1(keyinput1), .IN2(N107), .Q(\restore/n11 ) );
  XNOR2X1 \restore/U12  ( .IN1(keyinput0), .IN2(N141), .Q(\restore/n12 ) );
  XNOR2X1 \restore/U11  ( .IN1(keyinput31), .IN2(N129), .Q(\restore/n13 ) );
  XNOR2X1 \restore/U10  ( .IN1(keyinput30), .IN2(N117), .Q(\restore/n14 ) );
  NAND4X0 \restore/U9  ( .IN1(\restore/n11 ), .IN2(\restore/n12 ), .IN3(
        \restore/n13 ), .IN4(\restore/n14 ), .QN(\restore/n5 ) );
  XNOR2X1 \restore/U8  ( .IN1(keyinput11), .IN2(N103), .Q(\restore/n7 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput16), .IN2(N112), .Q(\restore/n8 ) );
  XNOR2X1 \restore/U6  ( .IN1(keyinput15), .IN2(N116), .Q(\restore/n9 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput14), .IN2(N319), .Q(\restore/n10 ) );
