...
module b14_C_SFLL_HD_0_32_1_top ( ADDR_REG_8__SCAN_IN, DATAO_REG_25__SCAN_IN, 
  ...
  NAND4X0 \perturb/U13  ( .IN1(IR_REG_3__SCAN_IN), .IN2(
        ADDR_REG_1__SCAN_IN_BUFF), .IN3(IR_REG_26__SCAN_IN), .IN4(
        IR_REG_11__SCAN_IN), .QN(\perturb/n7 ) );
  NAND4X0 \perturb/U12  ( .IN1(IR_REG_8__SCAN_IN), .IN2(IR_REG_31__SCAN_IN), 
        .IN3(IR_REG_16__SCAN_IN), .IN4(IR_REG_2__SCAN_IN), .QN(\perturb/n8 )
         );
  NAND4X0 \perturb/U11  ( .IN1(IR_REG_23__SCAN_IN), .IN2(IR_REG_1__SCAN_IN), 
        .IN3(IR_REG_12__SCAN_IN), .IN4(IR_REG_15__SCAN_IN), .QN(\perturb/n9 )
         );
  NAND4X0 \perturb/U10  ( .IN1(IR_REG_6__SCAN_IN), .IN2(IR_REG_18__SCAN_IN), 
        .IN3(IR_REG_7__SCAN_IN), .IN4(IR_REG_13__SCAN_IN), .QN(\perturb/n10 )
         );
  OR4X1 \perturb/U9  ( .IN1(\perturb/n7 ), .IN2(\perturb/n8 ), .IN3(
        \perturb/n9 ), .IN4(\perturb/n10 ), .Q(\perturb/n1 ) );
  NOR2X0 \perturb/U8  ( .IN1(IR_REG_10__SCAN_IN), .IN2(IR_REG_0__SCAN_IN), 
        .QN(\perturb/n5 ) );
  NOR4X0 \perturb/U7  ( .IN1(IR_REG_24__SCAN_IN), .IN2(IR_REG_19__SCAN_IN), 
        .IN3(IR_REG_17__SCAN_IN), .IN4(IR_REG_14__SCAN_IN), .QN(\perturb/n6 )
         );
  NAND4X0 \perturb/U6  ( .IN1(REG2_REG_0__SCAN_IN), .IN2(STATE_REG_SCAN_IN), 
        .IN3(\perturb/n5 ), .IN4(\perturb/n6 ), .QN(\perturb/n2 ) );
  OR4X1 \perturb/U5  ( .IN1(REG1_REG_0__SCAN_IN), .IN2(IR_REG_9__SCAN_IN), 
        .IN3(REG2_REG_1__SCAN_IN), .IN4(REG1_REG_1__SCAN_IN), .Q(\perturb/n3 )
         );
  OR4X1 \perturb/U4  ( .IN1(IR_REG_27__SCAN_IN), .IN2(IR_REG_25__SCAN_IN), 
        .IN3(IR_REG_5__SCAN_IN), .IN4(IR_REG_4__SCAN_IN), .Q(\perturb/n4 ) );
  NOR4X0 \perturb/U3  ( .IN1(\perturb/n1 ), .IN2(\perturb/n2 ), .IN3(
        \perturb/n3 ), .IN4(\perturb/n4 ), .QN(perturb_signal) );
  XNOR2X1 \restore/U44  ( .IN1(keyinput17), .IN2(IR_REG_19__SCAN_IN), .Q(
        \restore/n39 ) );
  XNOR2X1 \restore/U43  ( .IN1(keyinput18), .IN2(IR_REG_15__SCAN_IN), .Q(
        \restore/n40 ) );
  XNOR2X1 \restore/U42  ( .IN1(keyinput19), .IN2(IR_REG_11__SCAN_IN), .Q(
        \restore/n41 ) );
  XNOR2X1 \restore/U41  ( .IN1(keyinput21), .IN2(IR_REG_10__SCAN_IN), .Q(
        \restore/n42 ) );
  NAND4X0 \restore/U40  ( .IN1(\restore/n39 ), .IN2(\restore/n40 ), .IN3(
        \restore/n41 ), .IN4(\restore/n42 ), .QN(\restore/n23 ) );
  XNOR2X1 \restore/U39  ( .IN1(keyinput29), .IN2(IR_REG_17__SCAN_IN), .Q(
        \restore/n35 ) );
  XNOR2X1 \restore/U38  ( .IN1(keyinput3), .IN2(IR_REG_4__SCAN_IN), .Q(
        \restore/n36 ) );
  XNOR2X1 \restore/U37  ( .IN1(keyinput2), .IN2(REG1_REG_0__SCAN_IN), .Q(
        \restore/n37 ) );
  XNOR2X1 \restore/U36  ( .IN1(keyinput4), .IN2(IR_REG_13__SCAN_IN), .Q(
        \restore/n38 ) );
  NAND4X0 \restore/U35  ( .IN1(\restore/n35 ), .IN2(\restore/n36 ), .IN3(
        \restore/n37 ), .IN4(\restore/n38 ), .QN(\restore/n24 ) );
  XNOR2X1 \restore/U34  ( .IN1(keyinput25), .IN2(IR_REG_18__SCAN_IN), .Q(
        \restore/n31 ) );
  XNOR2X1 \restore/U33  ( .IN1(keyinput28), .IN2(IR_REG_6__SCAN_IN), .Q(
        \restore/n32 ) );
  XNOR2X1 \restore/U32  ( .IN1(keyinput27), .IN2(IR_REG_8__SCAN_IN), .Q(
        \restore/n33 ) );
  XNOR2X1 \restore/U31  ( .IN1(keyinput26), .IN2(IR_REG_31__SCAN_IN), .Q(
        \restore/n34 ) );
  NAND4X0 \restore/U30  ( .IN1(\restore/n31 ), .IN2(\restore/n32 ), .IN3(
        \restore/n33 ), .IN4(\restore/n34 ), .QN(\restore/n25 ) );
  XNOR2X1 \restore/U29  ( .IN1(keyinput20), .IN2(IR_REG_26__SCAN_IN), .Q(
        \restore/n27 ) );
  XNOR2X1 \restore/U28  ( .IN1(keyinput22), .IN2(ADDR_REG_1__SCAN_IN_BUFF), 
        .Q(\restore/n28 ) );
  XNOR2X1 \restore/U27  ( .IN1(keyinput24), .IN2(REG1_REG_1__SCAN_IN), .Q(
        \restore/n29 ) );
  XNOR2X1 \restore/U26  ( .IN1(keyinput23), .IN2(IR_REG_0__SCAN_IN), .Q(
        \restore/n30 ) );
  ...
  XNOR2X1 \restore/U23  ( .IN1(keyinput9), .IN2(IR_REG_9__SCAN_IN), .Q(
        \restore/n19 ) );
  XNOR2X1 \restore/U22  ( .IN1(keyinput8), .IN2(STATE_REG_SCAN_IN), .Q(
        \restore/n20 ) );
  XNOR2X1 \restore/U21  ( .IN1(keyinput13), .IN2(IR_REG_1__SCAN_IN), .Q(
        \restore/n21 ) );
  XNOR2X1 \restore/U20  ( .IN1(keyinput12), .IN2(IR_REG_27__SCAN_IN), .Q(
        \restore/n22 ) );
  NAND4X0 \restore/U19  ( .IN1(\restore/n19 ), .IN2(\restore/n20 ), .IN3(
        \restore/n21 ), .IN4(\restore/n22 ), .QN(\restore/n3 ) );
  XNOR2X1 \restore/U18  ( .IN1(keyinput5), .IN2(REG2_REG_0__SCAN_IN), .Q(
        \restore/n15 ) );
  XNOR2X1 \restore/U17  ( .IN1(keyinput6), .IN2(IR_REG_25__SCAN_IN), .Q(
        \restore/n16 ) );
  XNOR2X1 \restore/U16  ( .IN1(keyinput7), .IN2(IR_REG_14__SCAN_IN), .Q(
        \restore/n17 ) );
  XNOR2X1 \restore/U15  ( .IN1(keyinput10), .IN2(IR_REG_24__SCAN_IN), .Q(
        \restore/n18 ) );
  NAND4X0 \restore/U14  ( .IN1(\restore/n15 ), .IN2(\restore/n16 ), .IN3(
        \restore/n17 ), .IN4(\restore/n18 ), .QN(\restore/n4 ) );
  XNOR2X1 \restore/U13  ( .IN1(keyinput1), .IN2(IR_REG_16__SCAN_IN), .Q(
        \restore/n11 ) );
  XNOR2X1 \restore/U12  ( .IN1(keyinput0), .IN2(IR_REG_7__SCAN_IN), .Q(
        \restore/n12 ) );
  XNOR2X1 \restore/U11  ( .IN1(keyinput31), .IN2(IR_REG_2__SCAN_IN), .Q(
        \restore/n13 ) );
  XNOR2X1 \restore/U10  ( .IN1(keyinput30), .IN2(IR_REG_3__SCAN_IN), .Q(
        \restore/n14 ) );
  NAND4X0 \restore/U9  ( .IN1(\restore/n11 ), .IN2(\restore/n12 ), .IN3(
        \restore/n13 ), .IN4(\restore/n14 ), .QN(\restore/n5 ) );
  XNOR2X1 \restore/U8  ( .IN1(keyinput11), .IN2(REG2_REG_1__SCAN_IN), .Q(
        \restore/n7 ) );
  XNOR2X1 \restore/U7  ( .IN1(keyinput16), .IN2(IR_REG_23__SCAN_IN), .Q(
        \restore/n8 ) );
  XNOR2X1 \restore/U6  ( .IN1(keyinput15), .IN2(IR_REG_5__SCAN_IN), .Q(
        \restore/n9 ) );
  XNOR2X1 \restore/U5  ( .IN1(keyinput14), .IN2(IR_REG_12__SCAN_IN), .Q(
        \restore/n10 ) );
